  ...
  implements TableEntity
{
  ...
  public static HashMap<String, EntityProperty> writeEntityWithReflection(Object paramObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localHashMap.put(getValueeffectiveName, ((PropertyPair)((Map.Entry)localObject).getValue()).generateEntityProperty(paramObject));
    }
    return localHashMap;
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.table.TableServiceEntity
