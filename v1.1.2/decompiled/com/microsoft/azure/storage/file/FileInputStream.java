    ...
    try
    {
      ...
      if (paramInt2 > 0)
      {
        ...
        if (validateFileMd5)
        {
          ...
          {
            String str = Base64.encode(md5Digest.digest());
            if (!str.equals(retrievedContentMD5Value))
            {
              paramArrayOfByte = new com/microsoft/azure/storage/StorageException;
              paramArrayOfByte.<init>("InvalidMd5", String.format("File data corrupted (integrity check failed), Expected value is %s, retrieved %s", new Object[] { retrievedContentMD5Value, str }), 306, null, null);
              lastError = Utility.initIOException(paramArrayOfByte);
              streamFaulted = true;
              throw lastError;
            }
          }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.file.FileInputStream
