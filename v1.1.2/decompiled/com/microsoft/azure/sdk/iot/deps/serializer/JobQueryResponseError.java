  ...
  public JobQueryResponseError fromJson(String paramString)
  {
    if ((paramString != null) && (!paramString.isEmpty()))
    {
      ...
      try
      {
        ...
        localObject = (JobQueryResponseError)t.a(JobQueryResponseError.class).cast(paramString);
        paramString = code;
        if ((paramString != null) && (!paramString.isEmpty()))
        {
          if (description != null) {
            return (JobQueryResponseError)localObject;
          }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.deps.serializer.JobQueryResponseError
