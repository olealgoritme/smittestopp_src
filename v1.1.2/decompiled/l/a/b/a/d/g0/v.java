...
public class v
  implements l.a.b.a.d.v, c.a<Void>, t, d0
{
  ...
  public ByteBuffer i;
  public boolean j;
  public l.a.b.a.b.a k;
  public u l;
  public boolean m;
  public boolean n;
  public boolean o;
  public l.a.b.a.d.v.a p;
  public l.a.b.a.d.v.b q;
  public String r;
  public boolean s;
  public l.a.b.a.b.f[] t;
  public l.a.b.a.b.f u;
  public b v;
  public boolean w;
  public l.a.b.a.d.w x;
  ...
  public v(a0 parama0, int paramInt)
  {
    ...
    e = false;
    f = false;
    p = l.a.b.a.d.v.a.PN_SASL_NONE;
    q = l.a.b.a.d.v.b.PN_SASL_IDLE;
    w = true;
    d = parama0;
    g = paramInt;
    e.c.a.a.b.l.c.a(b, (x)localObject);
  ...
  {
    a();
    u = l.a.b.a.b.f.a("PLAIN");
    paramString1 = paramString1.getBytes(StandardCharsets.UTF_8);
    paramString2 = paramString2.getBytes(StandardCharsets.UTF_8);
    byte[] arrayOfByte = new byte[paramString1.length + paramString2.length + 2];
    System.arraycopy(paramString1, 0, arrayOfByte, 1, paramString1.length);
    System.arraycopy(paramString2, 0, arrayOfByte, paramString1.length + 2, paramString2.length);
    k = new l.a.b.a.b.a(arrayOfByte);
  }
  ...
  public void a(String... paramVarArgs)
  {
    ...
    {
      t = new l.a.b.a.b.f[paramVarArgs.length];
      for (int i1 = 0; i1 < paramVarArgs.length; i1++) {
        t[i1] = l.a.b.a.b.f.a(paramVarArgs[i1]);
      }
    }
    if (v == b.CLIENT) {
      u = l.a.b.a.b.f.a(paramVarArgs[0]);
    }
  }
  ...
  {
    return new a(new d(paramb0, paramf0, null), new o(paramf0, paramb0));
  }
  
  public class a
    extends w
  {
    public a(l0 paraml01, l0 paraml02)
    {
      super(paraml02);
    }
  ...
  public static enum b
  {
    static
    {
      b localb = new b("SERVER", 1);
      SERVER = localb;
      $VALUES = new b[] { CLIENT, localb };
    }
    ...
    public final void c()
    {
      ...
      if (a())
      {
        ...
        while ((((ByteBuffer)localObject2).hasRemaining()) && (localObject1 != u.a.ERROR) && (!((v)a).b()))
        {
          ...
          case 0: 
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[0])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[0]), localObject1 });
          ...
          case 1: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[1])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[1]), localObject7 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 2: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[2])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[2]), localObject8 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 3: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[3])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[3]), localObject9 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 4: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[4])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[4]), localObject10 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 5: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[5])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[5]), localObject11 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 6: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[6])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[6]), localObject12 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 7: 
            ...
            if (((ByteBuffer)localObject2).hasRemaining())
            {
              ...
              if (b1 != b.b[7])
              {
                localObject3 = new l.a.b.a.d.d0("AMQP SASL header mismatch value %x, expecting %x. In state: %s", new Object[] { Byte.valueOf(b1), Byte.valueOf(b.b[7]), localObject13 });
                localObject1 = u.a.ERROR;
              }
              else
              {
          ...
          case 12: 
            if (n < 8)
            {
              localObject3 = new l.a.b.a.d.d0("specified frame size %d smaller than minimum SASL frame header size 8", new Object[] { Integer.valueOf(n) });
              localObject1 = u.a.ERROR;
              i = n;
            }
            else if (n > f)
            {
              localObject3 = new l.a.b.a.d.d0("specified frame size %d larger than maximum SASL frame size %d", new Object[] { Integer.valueOf(n), Integer.valueOf(f) });
              localObject1 = u.a.ERROR;
              i = n;
            }
            else
          ...
          case 14: 
            ...
            if (i1 < 8)
            {
              localObject3 = new l.a.b.a.d.d0("specified frame data offset %d smaller than minimum frame header size %d", new Object[] { Integer.valueOf(i1), Integer.valueOf(8) });
              localObject1 = u.a.ERROR;
            ...
            {
              localObject3 = new l.a.b.a.d.d0("specified frame data offset %d larger than the frame size %d", new Object[] { Integer.valueOf(i1), Integer.valueOf(i2) });
              localObject1 = u.a.ERROR;
              localObject2 = localObject17;
              i = i2;
              localObject6 = localObject18;
            ...
            else
            {
              ...
              if (i != 1)
              {
                localObject3 = new l.a.b.a.d.d0("unknown frame type: %d", new Object[] { Integer.valueOf(i) });
                localObject1 = u.a.ERROR;
                localObject2 = localObject17;
                i = i2;
                localObject6 = localObject18;
              ...
              else
              {
                ...
                try
                {
                  ...
                  Object localObject4 = new l.a.b.a.d.d0("Unexpected frame type encountered. Found a %s which does not implement %s", new Object[] { localObject4, l.a.b.a.b.l.c.class });
                  localObject6 = localObject1;
                }
                catch (q localq2) {}
                localObject17 = u.a.ERROR;
                localObject5 = new l.a.b.a.d.d0(localq3);
                localObject6 = localObject1;
                i = i2;
                localObject1 = localObject17;
              }
        ...
        if (localObject1 == u.a.ERROR)
        {
          ...
          throw new l.a.b.a.d.d0("Unable to parse, probably because of a previous error");
        }
      }
      if (!a())
      {
        ...
        else if (localObject1 == v.b.CLIENT)
        {
          if ((q == l.a.b.a.d.v.b.PN_SASL_IDLE) && (u != null))
          {
            ...
            if (localObject3 != null)
            {
              ...
              q = l.a.b.a.d.v.b.PN_SASL_STEP;
              localObject1 = p;
              if (localObject1 != l.a.b.a.d.v.a.PN_SASL_NONE)
              {
                if (localObject1 == l.a.b.a.d.v.a.PN_SASL_OK) {
