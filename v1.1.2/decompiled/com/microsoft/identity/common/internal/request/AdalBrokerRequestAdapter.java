  ...
  implements IBrokerRequestAdapter
{
  ...
  public static AzureActiveDirectoryAuthority getRequestAuthorityWithExtraQP(String paramString, List<Pair<String, String>> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      paramString = TAG;
      paramList = a.a("Set the mSlice to ");
      paramList.append(localAzureActiveDirectorySlice.toString());
      Logger.verbosePII(paramString, paramList.toString());
  ...
  public BrokerAcquireTokenOperationParameters brokerInteractiveParametersFromActivity(Activity paramActivity)
  {
    ...
    localObject1 = getExtraQueryParamAsList(localIntent.getStringExtra("account.extra.query.param"));
    Object localObject2 = getRequestAuthorityWithExtraQP(localIntent.getStringExtra("account.authority"), (List)localObject1);
    if (((AzureActiveDirectoryAuthority)localObject2).getAudience().getTenantId().equalsIgnoreCase("common")) {
      ((AzureActiveDirectoryAuthority)localObject2).getAudience().setTenantId("organizations");
    }
    localBrokerAcquireTokenOperationParameters.setAuthority((Authority)localObject2);
    localBrokerAcquireTokenOperationParameters.setExtraQueryStringParameters((List)localObject1);
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.request.AdalBrokerRequestAdapter
