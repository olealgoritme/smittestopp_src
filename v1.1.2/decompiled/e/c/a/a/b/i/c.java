...
public class c<O extends a.d>
{
  ...
  {
    s.b(paramContext, "Null context is not permitted.");
    s.b(parama, "Api must not be null.");
    s.b(parama1, "Settings must not be null; use Settings.DEFAULT_SETTINGS instead.");
