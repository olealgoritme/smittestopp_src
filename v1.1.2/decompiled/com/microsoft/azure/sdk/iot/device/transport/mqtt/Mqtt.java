  ...
  implements g
{
  ...
  public static final l.f.b log = l.f.c.a(Mqtt.class);
  public ConcurrentLinkedQueue<l.a.a.b.e.b<String, byte[]>> allReceivedMessages;
  ...
  public void connect()
  {
    ...
    //   11: invokevirtual 265	com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection:getMqttAsyncClient	()Ll/c/a/a/a/f;
    //   14: invokevirtual 270	l/c/a/a/a/f:b	()Z
    //   17: ifne +56 -> 73
    //   20: getstatic 101	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:log	Ll/f/b;
    //   23: ldc_w 272
    //   26: invokeinterface 277 2 0
    //   31: aload_0
    ...
    //   35: invokevirtual 265	com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection:getMqttAsyncClient	()Ll/c/a/a/a/f;
    //   38: aload_0
    ...
    //   42: invokevirtual 281	com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection:getConnectionOptions	()Ll/c/a/a/a/i;
    //   45: aconst_null
    //   46: aconst_null
    //   47: invokevirtual 284	l/c/a/a/a/f:a	(Ll/c/a/a/a/i;Ljava/lang/Object;Ll/c/a/a/a/a;)Ll/c/a/a/a/e;
    //   50: checkcast 286	l/c/a/a/a/q
    //   53: getfield 289	l/c/a/a/a/q:a	Ll/c/a/a/a/s/p;
    //   56: ldc2_w 290
    //   59: invokevirtual 296	l/c/a/a/a/s/p:a	(J)V
    //   62: getstatic 101	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:log	Ll/f/b;
    //   65: ldc_w 298
    //   68: invokeinterface 277 2 0
    //   73: aload_1
    //   74: monitorexit
    //   75: return
    //   76: astore_2
    //   77: goto +28 -> 105
    //   80: astore_2
    //   81: getstatic 101	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:log	Ll/f/b;
    //   84: ldc_w 300
    //   87: aload_2
    //   88: invokeinterface 303 3 0
    //   93: aload_0
    //   94: invokevirtual 306	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:disconnect	()V
    //   97: aload_2
    //   98: ldc_w 308
    //   101: invokestatic 314	com/microsoft/azure/sdk/iot/device/transport/mqtt/exceptions/PahoExceptionTranslator:convertToMqttException	(Ll/c/a/a/a/k;Ljava/lang/String;)Lcom/microsoft/azure/sdk/iot/device/exceptions/ProtocolException;
    //   104: athrow
    //   105: aload_1
    //   106: monitorexit
    //   107: aload_2
  ...
  public void deliveryComplete(l.c.a.a.a.c paramc)
  {
  ...
  public void disconnect()
  {
    try
    {
      ...
      {
        log.e("Sending MQTT DISCONNECT packet");
        e locale = mqttConnection.disconnect();
        if (locale != null) {
          a.a(60000L);
        }
        log.e("Sent MQTT DISCONNECT packet was acknowledged");
      }
  ...
  {
    log.b("Mqtt message arrived on topic {} with mqtt message id {}", paramString, Integer.valueOf(f));
    mqttConnection.getAllReceivedMessages().add(new l.a.a.b.e.a(paramString, b));
  ...
  public l.a.a.b.e.b<String, byte[]> peekMessage()
  {
    return (l.a.a.b.e.b)allReceivedMessages.peek();
  }
  ...
  public void publish(String paramString, Message paramMessage)
  {
        ...
        if (!userSpecifiedSASTokenExpiredOnRetry)
        {
          if (mqttConnection.getMqttAsyncClient().b())
          {
            if ((paramMessage != null) && (paramString != null) && (paramString.length() != 0) && (paramMessage.getBytes() != null))
            {
              ...
              synchronized (publishLock)
              {
                log.b("Publishing message ({}) to MQTT topic {}", paramMessage, paramString);
                ...
                log.a("Message published to MQTT topic {}. Mqtt message id {} added to list of messages to wait for acknowledgement ({})", new Object[] { paramString, Integer.valueOf(a.n), paramMessage });
                return;
              }
            }
    ...
    {
      log.b("Message could not be published to MQTT topic {} ({})", new Object[] { paramString, paramMessage, localk });
  ...
  public IotHubTransportMessage receive()
  {
    synchronized (incomingLock)
    {
      if (mqttConnection != null)
      {
        ...
        {
          localObject3 = (String)((l.a.a.b.e.b)localObject2).getKey();
          if (localObject3 != null)
          {
            localObject2 = (byte[])((l.a.a.b.e.b)localObject2).getValue();
            if (localObject2 != null)
            {
  ...
  public void subscribe(String paramString)
  {
    ...
    //   22: invokevirtual 265	com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection:getMqttAsyncClient	()Ll/c/a/a/a/f;
    //   25: invokevirtual 270	l/c/a/a/a/f:b	()Z
    //   28: ifeq +54 -> 82
    //   31: getstatic 101	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:log	Ll/f/b;
    //   34: ldc_w 563
    //   37: aload_1
    ...
    //   47: invokevirtual 265	com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection:getMqttAsyncClient	()Ll/c/a/a/a/f;
    //   50: aload_1
    //   51: iconst_1
    //   52: invokevirtual 568	l/c/a/a/a/f:a	(Ljava/lang/String;I)Ll/c/a/a/a/e;
    //   55: checkcast 286	l/c/a/a/a/q
    //   58: getfield 289	l/c/a/a/a/q:a	Ll/c/a/a/a/s/p;
    //   61: ldc2_w 569
    //   64: invokevirtual 296	l/c/a/a/a/s/p:a	(J)V
    //   67: getstatic 101	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:log	Ll/f/b;
    //   70: ldc_w 572
    //   73: aload_1
    ...
    //   80: monitorexit
    //   81: return
    //   82: new 317	com/microsoft/azure/sdk/iot/device/exceptions/TransportException
    //   85: astore_3
    //   86: aload_3
    //   87: ldc_w 574
    ...
    //   98: aload_3
    //   99: athrow
    //   100: new 317	com/microsoft/azure/sdk/iot/device/exceptions/TransportException
    //   103: astore_3
    //   104: aload_3
    //   105: ldc_w 576
    ...
    //   133: aload_3
    //   134: athrow
    //   135: getstatic 101	com/microsoft/azure/sdk/iot/device/transport/mqtt/Mqtt:log	Ll/f/b;
    //   138: ldc_w 580
    //   141: aload_1
    //   142: aload 4
    ...
    //   177: invokestatic 314	com/microsoft/azure/sdk/iot/device/transport/mqtt/exceptions/PahoExceptionTranslator:convertToMqttException	(Ll/c/a/a/a/k;Ljava/lang/String;)Lcom/microsoft/azure/sdk/iot/device/exceptions/ProtocolException;
    //   180: athrow
    //   181: aload_2
    //   182: monitorexit
    //   183: aload_1
    ...
    //   135	181	113	finally
    //   181	183	113	finally
    //   11	79	117	l/c/a/a/a/k
    //   82	100	117	l/c/a/a/a/k
    //   100	113	117	l/c/a/a/a/k
    //   122	135	117	l/c/a/a/a/k
  }
}

/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.transport.mqtt.Mqtt
