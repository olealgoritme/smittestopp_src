  ...
  implements CommandCallback<ILocalAuthenticationResult, BaseException>
{
  ...
  {
    MsalException localMsalException = MsalExceptionAdapter.msalExceptionFromBaseException(paramBaseException);
    paramBaseException = val$authenticationCallback;
    if (paramBaseException != null)
    {
      paramBaseException.onError(localMsalException);
      return;
    }
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.PublicClientApplication.9
