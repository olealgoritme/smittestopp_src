  ...
  extends BaseController
{
  ...
  {
    (Intent)invokeBrokerOperation(paramAcquireTokenOperationParameters, new BrokerOperationInfo()
    {
      ...
      public Intent perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, AcquireTokenOperationParameters paramAnonymousAcquireTokenOperationParameters)
      {
        return paramAnonymousBrokerBaseStrategy.getBrokerAuthorizationIntent(paramAnonymousAcquireTokenOperationParameters);
      }
      
      public void putValueInSuccessEvent(ApiEndEvent paramAnonymousApiEndEvent, Intent paramAnonymousIntent) {}
    });
  }
  ...
  private <T extends OperationParameters, U> U invokeBrokerOperation(T paramT, BrokerOperationInfo<T, U> paramBrokerOperationInfo)
  {
  ...
  public static boolean isPermissionGranted(Context paramContext, String paramString)
  {
    ...
    paramContext = a.a(new StringBuilder(), TAG, ":isPermissionGranted");
  ...
  {
    (AcquireTokenResult)invokeBrokerOperation(paramAcquireTokenSilentOperationParameters, new BrokerOperationInfo()
    {
      public String getMethodName()
      {
      ...
      public AcquireTokenResult perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, AcquireTokenSilentOperationParameters paramAnonymousAcquireTokenSilentOperationParameters)
      {
        return paramAnonymousBrokerBaseStrategy.acquireTokenSilent(paramAnonymousAcquireTokenSilentOperationParameters);
      }
      
      public void putValueInSuccessEvent(ApiEndEvent paramAnonymousApiEndEvent, AcquireTokenResult paramAnonymousAcquireTokenResult)
      {
        paramAnonymousApiEndEvent.putResult(paramAnonymousAcquireTokenResult);
      }
    });
  }
  ...
  {
    (List)invokeBrokerOperation(paramOperationParameters, new BrokerOperationInfo()
    {
      public String getMethodName()
      {
      ...
      public List<ICacheRecord> perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, OperationParameters paramAnonymousOperationParameters)
      {
        return paramAnonymousBrokerBaseStrategy.getBrokerAccounts(paramAnonymousOperationParameters);
      }
      
      public void putValueInSuccessEvent(ApiEndEvent paramAnonymousApiEndEvent, List<ICacheRecord> paramAnonymousList)
      {
        paramAnonymousApiEndEvent.put("Microsoft.MSAL.accounts_number", Integer.toString(paramAnonymousList.size()));
      }
    });
  }
  ...
  public List<ICacheRecord> getCurrentAccount(OperationParameters paramOperationParameters)
  {
    ...
    (List)invokeBrokerOperation(paramOperationParameters, new BrokerOperationInfo()
    {
      ...
      public List<ICacheRecord> perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, OperationParameters paramAnonymousOperationParameters)
      {
        return paramAnonymousBrokerBaseStrategy.getCurrentAccountInSharedDevice(paramAnonymousOperationParameters);
      }
  ...
  {
    ((Boolean)invokeBrokerOperation(paramOperationParameters, new BrokerOperationInfo()
    {
      public String getMethodName()
      {
      ...
      public Boolean perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, OperationParameters paramAnonymousOperationParameters)
      {
        return Boolean.valueOf(paramAnonymousBrokerBaseStrategy.getDeviceMode(paramAnonymousOperationParameters));
      }
      
      public void putValueInSuccessEvent(ApiEndEvent paramAnonymousApiEndEvent, Boolean paramAnonymousBoolean)
      {
        paramAnonymousApiEndEvent.put("Microsoft.MSAL.is_device_shared", Boolean.toString(paramAnonymousBoolean.booleanValue()));
      }
    })).booleanValue();
  }
  ...
  public boolean removeAccount(OperationParameters paramOperationParameters)
  {
    ((Boolean)invokeBrokerOperation(paramOperationParameters, new BrokerOperationInfo()
    {
      ...
      public Boolean perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, OperationParameters paramAnonymousOperationParameters)
      {
        paramAnonymousBrokerBaseStrategy.removeBrokerAccount(paramAnonymousOperationParameters);
  ...
  public boolean removeCurrentAccount(OperationParameters paramOperationParameters)
  {
    ...
    ((Boolean)invokeBrokerOperation(paramOperationParameters, new BrokerOperationInfo()
    {
      ...
      public Boolean perform(BrokerBaseStrategy paramAnonymousBrokerBaseStrategy, OperationParameters paramAnonymousOperationParameters)
      {
        paramAnonymousBrokerBaseStrategy.signOutFromSharedDevice(paramAnonymousOperationParameters);
        return Boolean.valueOf(true);
      }
  ...
  public static abstract interface BrokerOperationInfo<T extends OperationParameters, U>
  {
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.internal.controllers.BrokerMsalController
