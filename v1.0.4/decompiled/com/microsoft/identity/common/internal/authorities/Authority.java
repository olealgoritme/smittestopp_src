...
public abstract class Authority
{
  ...
  public static Authority getAuthorityFromAuthorityUrl(String paramString)
  {
    try
    {
      ...
      localObject = Uri.parse(((URL)localObject).toString());
      ...
      if (authorityIsKnownFromConfiguration(paramString))
      {
        if ("B2C".equalsIgnoreCase(getEquivalentConfiguredAuthoritymAuthorityTypeString)) {
          ...
          paramString = createAadAuthority((Uri)localObject, localList);
        }
      }
      else
      {
        int i = 0;
        String str = ((String)localList.get(0)).toLowerCase();
        int j = str.hashCode();
        if (j != 114750)
        {
  ...
  public static Authority.KnownAuthorityResult getKnownAuthorityResult(Authority paramAuthority)
  {
    ...
    return new Authority.KnownAuthorityResult(bool2, localClientException2);
  }
  ...
  public static boolean isKnownAuthority(Authority paramAuthority)
  {
    ...
    {
      localObject = knownAuthorities.iterator();
      ...
      do
      {
        ...
        localAuthority = (Authority)((Iterator)localObject).next();
    ...
    paramAuthority = a.a(new StringBuilder(), TAG, ":isKnownAuthority");
    Object localObject = new StringBuilder();
    ((StringBuilder)localObject).append("Authority is known to developer? [");
    ((StringBuilder)localObject).append(bool2);
    ((StringBuilder)localObject).append("]");
    Logger.verbose(paramAuthority, ((StringBuilder)localObject).toString());
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.authorities.Authority
