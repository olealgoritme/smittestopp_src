  ...
  implements d.i.d.a.b
{
  ...
  public j(h paramh, int paramInt1, int paramInt2, int paramInt3, int paramInt4, CharSequence paramCharSequence, int paramInt5)
  {
    n = paramh;
    a = paramInt2;
    b = paramInt1;
  ...
  public final Drawable a(Drawable paramDrawable)
  {
    ...
    if (paramDrawable != null)
    {
      ...
      if (w) {
        ...
        {
          localDrawable = s.c(paramDrawable).mutate();
          if (u) {
  ...
  public MenuItem setChecked(boolean paramBoolean)
  {
    if ((x & 0x4) != 0)
    {
      ...
      if (localh != null)
      {
        ...
        {
          j localj = (j)f.get(i3);
          if ((b == i1) && (localj.e()) && (localj.isCheckable()))
          {
            if (localj == this) {
              paramBoolean = true;
            } else {
  ...
  public MenuItem setTitle(CharSequence paramCharSequence)
  {
    ...
    t localt = o;
    if (localt != null) {
      localt.setHeaderTitle(paramCharSequence);
    }
    return this;
  }
