  ...
  implements IBrokerResultAdapter
{
  ...
  private BaseException getBaseExceptionFromErrorCodes(BrokerResult paramBrokerResult)
  {
    ...
    if ((!"interaction_required".equalsIgnoreCase((String)localObject1)) && (!"invalid_grant".equalsIgnoreCase((String)localObject1)) && (!"Broker refresh token is invalid".equalsIgnoreCase((String)localObject1)) && (!"no_tokens_found".equalsIgnoreCase((String)localObject1)))
    {
      ...
      else if ("User cancelled".equalsIgnoreCase((String)localObject1))
      {
        ...
        ((StringBuilder)localObject2).append("Received a User cancelled exception from Broker : ");
      ...
      else if ("illegal_argument_exception".equalsIgnoreCase((String)localObject1))
      {
        localObject2 = TAG;
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append("Received a Argument exception from Broker : ");
        ((StringBuilder)localObject3).append((String)localObject1);
        Logger.warn((String)localObject2, ((StringBuilder)localObject3).toString());
      ...
      else
      {
        localObject2 = TAG;
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append("Received a Service exception from Broker : ");
        ((StringBuilder)localObject3).append((String)localObject1);
        Logger.warn((String)localObject2, ((StringBuilder)localObject3).toString());
  ...
  private ServiceException getServiceException(BrokerResult paramBrokerResult)
  {
    ...
    localObject1 = new ServiceException((String)localObject1, (String)localObject2, null);
    ((ServiceException)localObject1).setOauthSubErrorCode(paramBrokerResult.getSubErrorCode());
    try
    {
      if (paramBrokerResult.getHttpResponseBody() != null) {
        localObject2 = HashMapExtensions.jsonStringAsMap(paramBrokerResult.getHttpResponseBody());
      } else {
        localObject2 = null;
      }
      ((ServiceException)localObject1).setHttpResponseBody((HashMap)localObject2);
      localObject2 = localObject3;
      if (paramBrokerResult.getHttpResponseHeaders() != null) {
        localObject2 = HeaderSerializationUtil.fromJson(paramBrokerResult.getHttpResponseHeaders());
      }
      ((ServiceException)localObject1).setHttpResponseHeaders((HashMap)localObject2);
    }
    catch (JSONException paramBrokerResult)
    {
      Logger.warn(TAG, "Unable to parse json");
    }
    return (ServiceException)localObject1;
  }
  ...
  public void verifyHelloFromResultBundle(Bundle paramBundle)
  {
    if (paramBundle != null)
    {
      ...
      {
        paramBundle = paramBundle.getString("common.broker.protocol.version.name");
        String str = a.a(new StringBuilder(), TAG, ":verifyHelloFromResultBundle");
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.result.MsalBrokerResultAdapter
