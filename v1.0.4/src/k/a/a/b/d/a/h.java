...
public class h
  extends b
{
  public final EnumSet<h.a> b;
  
  public h(h.a... paramVarArgs)
  {
    if (paramVarArgs.length > 0) {
      b = EnumSet.copyOf(Arrays.asList(paramVarArgs));
    } else {
      b = EnumSet.copyOf(Arrays.asList(new h.a[] { h.a.semiColonRequired }));
    }
  }
  ...
  public int a(CharSequence paramCharSequence, int paramInt, Writer paramWriter)
  {
    ...
    if ((paramCharSequence.charAt(paramInt) == '&') && (paramInt < i - 2) && (paramCharSequence.charAt(paramInt + 1) == '#'))
    {
      ...
      if (i == 0)
      {
        h.a locala = h.a.semiColonRequired;
...
/* Location:
 * Qualified Name:     base.k.a.a.b.d.a.h
