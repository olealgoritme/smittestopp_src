...
public final class HashMapExtensions
{
  ...
  public static HashMap<String, String> getJsonResponse(HttpResponse paramHttpResponse)
  {
    ...
    {
      JSONObject localJSONObject = new JSONObject(paramHttpResponse.getBody());
      paramHttpResponse = localJSONObject.keys();
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.adal.internal.util.HashMapExtensions
