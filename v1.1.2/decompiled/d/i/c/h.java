  ...
  extends i
{
  public Typeface a(Context paramContext, Resources paramResources, int paramInt1, String paramString, int paramInt2)
  {
    try
    {
      ...
      paramResources = paramContext.build();
      if ((paramInt2 & 0x1) != 0) {
        paramInt1 = 700;
      } else {
        paramInt1 = 400;
      ...
      paramContext = new FontStyle(paramInt1, paramInt2);
      return new Typeface.CustomFallbackBuilder(paramResources).setStyle(paramContext).build();
    }
