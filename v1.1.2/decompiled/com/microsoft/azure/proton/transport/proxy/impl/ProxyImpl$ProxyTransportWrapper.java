  ...
  public void process()
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          if (ProxyImpl.access$600().d()) {
            ProxyImpl.access$600().e("Proxy authentication required. User configured: '{}', but supported proxy authentication methods are: {}", ProxyImpl.access$500(this$0).authentication(), ((Set)localObject2).stream().map(d.a).collect(Collectors.joining(",")));
          }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.proton.transport.proxy.impl.ProxyImpl.ProxyTransportWrapper
