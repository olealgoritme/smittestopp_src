  ...
  implements Runnable
{
  ...
  public void run()
  {
    CommandCallback localCommandCallback = this$0.getCommandCallback(val$acquireTokenParameters.getCallback(), val$acquireTokenParameters);
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      new Handler(Looper.getMainLooper()).post(new PublicClientApplication.5.1(this, localCommandCallback, localBaseException));
    }
  }
}

/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.PublicClientApplication.5
