  ...
  implements a.b, a.d
{
  ...
  public static boolean markState(p paramp, g.b paramb)
  {
    ...
    {
      paramp = (Fragment)localIterator.next();
      if (paramp != null)
      {
        boolean bool2 = bool1;
        if (paramp.getHost() != null) {
          bool2 = bool1 | markState(paramp.getChildFragmentManager(), paramb);
        }
        bool1 = bool2;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      Object localObject2 = paramBundle.getParcelable("android:support:fragments");
      localObject1 = mFragments.a;
      if ((localObject1 instanceof f0))
      {
        A.a((Parcelable)localObject2);
        if (paramBundle.containsKey("android:support:next_request_index"))
        {
          ...
          localObject1 = paramBundle.getStringArray("android:support:request_fragment_who");
          if ((localObject2 != null) && (localObject1 != null) && (localObject2.length == localObject1.length))
          {
            mPendingFragmentActivityResults = new d.f.i(localObject2.length);
            for (int i = 0; i < localObject2.length; i++) {
              mPendingFragmentActivityResults.c(localObject2[i], localObject1[i]);
            }
          }
  ...
  public void onSaveInstanceState(Bundle paramBundle)
  {
    ...
    if (mPendingFragmentActivityResults.b() > 0)
    {
      ...
      {
        localObject[i] = mPendingFragmentActivityResults.b(i);
        arrayOfString[i] = ((String)mPendingFragmentActivityResults.d(i));
      }
  ...
  public void setEnterSharedElementCallback(d.i.a.k paramk)
  {
    d.i.a.a.e(this);
  }
  
  public void setExitSharedElementCallback(d.i.a.k paramk)
  {
    d.i.a.a.f(this);
  }
