  ...
  extends OutputStream
{
  ...
  private void dispatchWrite(int paramInt)
  {
    ...
    try
    {
      ...
      CloudFile localCloudFile = parentFileRef;
      long l1 = currentOffset;
      long l2 = paramInt;
      currentOffset += l2;
      Object localObject1 = new com/microsoft/azure/storage/file/FileOutputStream$1;
      ((FileOutputStream.1)localObject1).<init>(this, localCloudFile, localByteArrayInputStream, l1, l2);
      completionService.submit((Callable)localObject1);
  ...
  public void close()
  {
    ...
    //   84	2	1	localStorageException	com.microsoft.azure.storage.StorageException
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.file.FileOutputStream
