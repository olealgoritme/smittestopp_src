  ...
  implements i, e
{
  ...
  public void computeScroll()
  {
    ...
    if (i != 0)
    {
      ...
      arrayOfInt1[1] = 0;
      int[] arrayOfInt2 = O;
      U.a(0, j, 0, i, arrayOfInt2, 1, arrayOfInt1);
      j = i - P[1];
    }
    if (j != 0)
    {
    ...
    if (i != 0)
    {
      if (i != 1)
      {
        ...
        else
        {
          ...
          if (j == -1)
          {
            paramMotionEvent = e.a.a.a.a.a("Invalid pointerId=");
    ...
    extends View.BaseSavedState
  {
    ...
    {
      StringBuilder localStringBuilder = e.a.a.a.a.a("HorizontalScrollView.SavedState{");
