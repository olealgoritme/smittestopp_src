...
public class IotHubSSLContext
{
  ...
  private void generateSSLContextWithKeys(String paramString1, String paramString2, IotHubCertificateManager paramIotHubCertificateManager)
  {
    ...
    paramString1 = (X509Certificate[])paramString1.toArray(new X509Certificate[paramString1.size()]);
    char[] arrayOfChar = generateTemporaryPassword();
    KeyStore localKeyStore = KeyStore.getInstance(KeyStore.getDefaultType());
    localKeyStore.load(null);
    localKeyStore.setCertificateEntry("cert-alias", paramString1[0]);
    localKeyStore.setKeyEntry("key-alias", paramString2, arrayOfChar, paramString1);
    paramString1 = KeyManagerFactory.getInstance(KeyManagerFactory.getDefaultAlgorithm());
    paramString1.init(localKeyStore, arrayOfChar);
    Arrays.fill(arrayOfChar, 0, arrayOfChar.length, '0');
    paramIotHubCertificateManager = generateTrustManagerFactory(paramIotHubCertificateManager, localKeyStore);
    paramString2 = SSLContext.getInstance("TLSv1.2");
    sslContext = paramString2;
    paramString2.init(paramString1.getKeyManagers(), paramIotHubCertificateManager.getTrustManagers(), new SecureRandom());
  }
  ...
  private TrustManagerFactory generateTrustManagerFactory(IotHubCertificateManager paramIotHubCertificateManager, KeyStore paramKeyStore)
  {
    ...
    Iterator localIterator = paramIotHubCertificateManager.getCertificateCollection().iterator();
    while (localIterator.hasNext())
    {
      paramIotHubCertificateManager = (Certificate)localIterator.next();
      paramKeyStore = e.a.a.a.a.a("trustedIotHubCert-");
      paramKeyStore.append(UUID.randomUUID());
      localKeyStore.setCertificateEntry(paramKeyStore.toString(), paramIotHubCertificateManager);
    }
  ...
  public static Key getPrivateKey(Object paramObject)
  {
    ...
    {
      Object localObject1 = new k.b.g.g.a();
      paramObject = (c)paramObject;
      try
      {
        localObject1 = ((k.b.g.g.a)localObject1).a(b.y);
    ...
    {
      Object localObject2 = new k.b.g.g.a();
      paramObject = (f)paramObject;
      try
      {
        localObject2 = ((k.b.g.g.a)localObject2).a(y);
        localObject3 = new java/security/spec/PKCS8EncodedKeySpec;
        ((PKCS8EncodedKeySpec)localObject3).<init>(((n)paramObject).e());
        paramObject = ((KeyFactory)localObject2).generatePrivate((KeySpec)localObject3);
  ...
  public static Key parsePrivateKey(String paramString)
  {
    try
    {
      Object localObject = new k/b/e/a/a;
      ((k.b.e.a.a)localObject).<init>();
      Security.addProvider((Provider)localObject);
      localObject = new k/b/g/e;
  ...
  public static Collection<X509Certificate> parsePublicKeyCertificate(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_2
    //   13: invokespecial 274	k/b/e/a/a:<init>	()V
    //   16: aload_2
    ...
    //   43: aload_2
    //   44: aload 4
    //   46: invokespecial 311	k/b/j/h/b/d:<init>	(Ljava/io/Reader;)V
    //   49: aload_2
    //   50: invokevirtual 314	k/b/j/h/b/d:a	()Lk/b/j/h/b/b;
    //   53: astore_0
    //   54: aload_0
    //   55: ifnull +60 -> 115
    //   58: aload_0
    //   59: getfield 320	k/b/j/h/b/b:c	[B
    //   62: astore 4
    //   64: aload 4
    //   66: arraylength
    //   67: ifle +48 -> 115
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.deps.auth.IotHubSSLContext
