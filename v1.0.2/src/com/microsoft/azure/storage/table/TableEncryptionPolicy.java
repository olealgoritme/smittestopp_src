    ...
    if (keyWrapper != null)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((localObject1 != null) && (((EntityProperty)((Map.Entry)localObject3).getValue()).isEncrypted()))
          {
            if (((EntityProperty)((Map.Entry)localObject3).getValue()).getEdmType() == EdmType.STRING)
            {
              ...
              if (((Map.Entry)localObject3).getValue() != null)
              {
                ...
                byte[] arrayOfByte = localCipher.doFinal((byte[])localObject1, 0, localObject1.length);
                localObject1 = ((Map.Entry)localObject3).getKey();
                localObject4 = new com/microsoft/azure/storage/table/EntityProperty;
                ((EntityProperty)localObject4).<init>(arrayOfByte);
          ...
          localObject3 = localEncryptionData.getContentEncryptionIV();
          localObject1 = new java/lang/StringBuilder;
          ((StringBuilder)localObject1).<init>();
          ((StringBuilder)localObject1).append(paramString1);
          ((StringBuilder)localObject1).append(paramString2);
          ((StringBuilder)localObject1).append("_ClientEncryptionMetadata2");
          localObject3 = ((MessageDigest)localObject2).digest(Utility.binaryAppend((byte[])localObject3, ((StringBuilder)localObject1).toString().getBytes("UTF-8")));
          localObject1 = new byte[16];
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.table.TableEncryptionPolicy
