  ...
  extends f
{
  ...
  public byte[] a()
  {
    ...
    if (localObject2 != null)
    {
      i7 = i4 + ((a)localObject2).a("RuntimeVisibleAnnotations");
      i1 = i3 + 1;
    }
    localObject2 = t;
    i4 = i7;
    ...
    if (localObject2 != null)
    {
      i4 = i7 + ((a)localObject2).a("RuntimeInvisibleAnnotations");
      i3 = i1 + 1;
    }
    localObject2 = u;
    i8 = i4;
    ...
    {
      i1 = i3 + 1;
      i8 = i4 + ((a)localObject2).a("RuntimeVisibleTypeAnnotations");
    }
    localObject2 = v;
    i4 = i8;
    i7 = i1;
    ...
    {
      i7 = i1 + 1;
      i4 = i8 + ((a)localObject2).a("RuntimeInvisibleTypeAnnotations");
    }
    localObject2 = b;
    if (j != null)
    {
    ...
    if (i4 <= 65535)
    {
      ...
      while (localObject2 != null)
      {
        ...
        localObject4 = h;
        localObject8 = i;
        a.a(localx, (a)localObject4, (a)localObject8, j, k, localc);
        localObject4 = l;
        if (localObject4 != null) {
      ...
      while (localObject5 != null)
      {
        ...
        else
        {
          ...
          if (i1 > 0)
          {
            ...
            if (localObject7 != null)
            {
              i3 = i7 + ((a)localObject7).a("RuntimeVisibleTypeAnnotations");
              i1 = i8 + 1;
            }
            localObject7 = w;
            i4 = i1;
            ...
            if (localObject7 != null)
            {
              i7 = i3 + ((a)localObject7).a("RuntimeInvisibleTypeAnnotations");
              i4 = i1 + 1;
            }
            localObject7 = x;
            if (localObject7 != null)
            {
              localObject8 = c;
              localObject4 = k;
              i7 += ((b)localObject7).a((x)localObject8, a, b, i, j);
              i4 += x.a();
            }
            localc.d(c.c("Code"));
            localc.c(i7);
            ...
            if (localObject8 != null)
            {
              localObject4 = c;
              localObject7 = k;
              ((b)localObject8).a((x)localObject4, a, b, i, j, localc);
            }
          }
          if (y > 0)
          {
  ...
  public final byte[] a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    {
      localObject12 = c;
      localObject10 = ((d)localObject4).e(b[localObject4.e(i8)], (char[])localObject12);
      ...
      localObject9 = new u((x)localObject8, i7, i5, i1);
      w = ((u)localObject9);
      if (localObject2 != null) {
      ...
      while (i1 > 0)
      {
        ...
        localObject1 = ((d)localObject4).e(i5 + 4, (char[])localObject12);
        i9 = i5 + 6;
        localObject8 = f;
        ((c)localObject8).d(a.a(19, (String)localObject10).a);
        ((c)localObject8).d(i8);
        if (localObject1 == null) {
          i5 = 0;
        } else {
          i5 = a.c((String)localObject1);
        }
        ((c)localObject8).d(i5);
        e += 1;
        i1--;
      ...
      while (i9 > 0)
      {
        localObject8 = ((d)localObject4).d(i1, (char[])localObject12);
        i6 = ((d)localObject4).e(i1 + 2);
        i7 = ((d)localObject4).e(i1 + 4);
        i1 += 6;
        if (i7 != 0)
        {
          localObject10 = new String[i7];
          i8 = 0;
          i5 = i1;
          for (;;)
          {
        ...
        localObject2 = null;
        localObject10 = h;
        ((c)localObject10).d(a.a(20, (String)localObject8).a);
        ((c)localObject10).d(i6);
        if (localObject2 == null)
        {
          h.d(0);
        }
      ...
      while (i5 > 0)
      {
        ...
        localObject8 = j;
        ((c)localObject8).d(a.a(20, (String)localObject10).a);
        ((c)localObject8).d(i8);
        if (localObject2 == null)
        {
          j.d(0);
    ...
    if (i11 != 0)
    {
      ...
      while (i1 > 0)
      {
        i5 = ((d)localObject4).a(((f)localObject7).a(((d)localObject4).e(i5, (char[])localObject6), true), i5 + 2, true, (char[])localObject6);
        i1--;
      }
    }
    if (i12 != 0)
    {
      ...
      while (i1 > 0)
      {
        i5 = ((d)localObject4).a(((f)localObject7).a(((d)localObject4).e(i5, (char[])localObject6), false), i5 + 2, true, (char[])localObject6);
        i1--;
      }
    }
    if (i13 != 0)
    {
      ...
      while (i1 > 0)
      {
        ...
        i5 = ((d)localObject4).a(((f)localObject7).a(h, i, paramArrayOfByte, true), i5 + 2, true, (char[])localObject6);
        i1--;
      }
    }
    if (i14 != 0)
    {
      ...
      while (i1 > 0)
      {
        i5 = ((d)localObject4).a((i)localObject5, i5);
        paramArrayOfByte = ((d)localObject4).e(i5, (char[])localObject6);
        i5 = ((d)localObject4).a(((f)localObject7).a(h, i, paramArrayOfByte, false), i5 + 2, true, (char[])localObject6);
        i1--;
      }
    }
    ...
    if (i3 != 0)
    {
      ...
      while (i1 > 0)
      {
        localObject1 = ((d)localObject4).a(i5, (char[])localObject6);
        localObject11 = ((d)localObject4).a(i5 + 2, (char[])localObject6);
        paramArrayOfByte = ((d)localObject4).e(i5 + 4, (char[])localObject6);
        i4 = ((d)localObject4).e(i5 + 6);
        if (m == null) {
          m = new c();
        }
        localObject1 = b.a(7, (String)localObject1);
        if (g == 0)
        {
          l += 1;
          m.d(a);
          ...
          if (localObject11 == null) {
            ...
            i3 = b.a(7, (String)localObject11).a;
          }
    ...
    for (;;)
    {
      ...
      localObject8 = c;
      i1 = ((d)localObject4).e(i4);
      String str1 = ((d)localObject4).e(i4 + 2, (char[])localObject8);
      String str2 = ((d)localObject4).e(i4 + 4, (char[])localObject8);
      i5 = i4 + 6;
      ...
      while (i11 > 0)
      {
        String str3 = ((d)localObject4).e(i4, (char[])localObject8);
        i9 = ((d)localObject4).b(i4 + 2);
        i4 += 6;
        if ("ConstantValue".equals(str3))
        {
          i13 = ((d)localObject4).e(i4);
          if (i13 == 0) {
            localObject12 = null;
          } else {
            localObject12 = ((d)localObject4).b(i13, (char[])localObject8);
          }
        }
        else
        {
          ...
          {
            localObject5 = ((d)localObject4).e(i4, (char[])localObject8);
          }
          else
          {
        ...
        else
        {
          ...
          else
          {
            ...
            paramArrayOfByte = (byte[])localObject2;
            localObject2 = localObject13;
            localObject13 = ((d)localObject4).a((b[])localObject17, str3, i4, i9, (char[])localObject8, -1, null);
            c = ((b)localObject14);
            i14 = i13;
      ...
      if (i10 != 0)
      {
        ...
        while (i1 > 0)
        {
          i13 = ((d)localObject4).a(((l)localObject13).a(((d)localObject4).e(i13, (char[])localObject8), true), i13 + 2, true, (char[])localObject8);
          i1--;
        }
      }
      if (i3 != 0)
      {
        ...
        while (i1 > 0)
        {
          i3 = ((d)localObject4).a(((l)localObject13).a(((d)localObject4).e(i3, (char[])localObject8), false), i3 + 2, true, (char[])localObject8);
          i1--;
        }
      }
      if (i14 != 0)
      {
        ...
        while (i1 > 0)
        {
          ...
          localObject12 = ((d)localObject4).e(i3, (char[])localObject8);
          i3 = ((d)localObject4).a(((l)localObject13).a(h, i, (String)localObject12, true), i3 + 2, true, (char[])localObject8);
          i1--;
        }
      }
      ...
      if (i5 != 0)
      {
        ...
        for (;;)
        {
          ...
          localObject12 = ((d)localObject4).e(i5, (char[])localObject8);
          i5 = ((d)localObject4).a(((l)localObject13).a(h, i, (String)localObject12, false), i5 + 2, true, (char[])localObject8);
          i1--;
        }
      }
    ...
    while (i2 > 0)
    {
      ...
      e = ((d)localObject14).e(i16 + 2, (char[])localObject3);
      int i17 = i16 + 4;
      f = ((d)localObject14).e(i17, (char[])localObject3);
      i10 = i16 + 6;
      ...
      while (i18 > 0)
      {
        localObject16 = ((d)localObject14).e(i1, (char[])localObject3);
        int i20 = ((d)localObject14).b(i1 + 2);
        i1 += 6;
        if ("Code".equals(localObject16))
        {
          if ((b & 0x1) == 0) {
            i12 = i1;
          }
        ...
        {
          if ("Exceptions".equals(localObject16))
          {
            ...
            for (i4 = 0; i4 < i21; i4++)
            {
              localObject5[i4] = ((d)localObject14).a(i6, (char[])localObject3);
              i6 += 2;
            }
            i4 = i1;
            break label4277;
          }
          if (((String)localObject6).equals(localObject16))
          {
          ...
          else
          {
            ...
            if (!((String)localObject4).equals(localObject16)) {
              break label4255;
            }
            d |= 0x20000;
          }
        ...
        if (((String)localObject13).equals(localObject16))
        {
          i13 = i1;
        }
        else
        {
          ...
          if (((String)localObject1).equals(localObject16))
          {
            i14 = i1;
          }
          else
          {
            if (!"AnnotationDefault".equals(localObject16)) {
              break label4318;
            }
            i5 = i1;
          }
        ...
        for (;;)
        {
          break;
          label4318:
          if (((String)localObject2).equals(localObject16))
          {
            d |= 0x1000;
            i10 = i6;
          ...
          if (paramArrayOfByte.equals(localObject16))
          {
            i11 = i1;
          }
          else
          {
            ...
            else if ("RuntimeVisibleParameterAnnotations".equals(localObject16))
            {
              i15 = i1;
            }
            else if ("RuntimeInvisibleParameterAnnotations".equals(localObject16))
            {
              i8 = i1;
            }
            else
            {
              if (!"MethodParameters".equals(localObject16)) {
                break label4489;
              }
              i9 = i1;
            }
        ...
        localObject10 = localObject12;
        localObject12 = localObject13;
        localObject11 = ((d)localObject14).a((b[])localObject11, (String)localObject16, i1, i20, (char[])localObject3, -1, null);
        c = ((b)localObject9);
      ...
      if (i3 == 0) {
        ...
        localObject4 = ((d)localObject14).f(i3, (char[])localObject3);
      }
      i6 = i5;
      localObject13 = a(i18, (String)localObject13, (String)localObject16, (String)localObject4, (String[])localObject5);
      localObject4 = (t)localObject13;
      if ((d & 0x20000) != 0) {
        i5 = 1;
      } else {
        i5 = 0;
      ...
      else
      {
        if (i9 != 0)
        {
          ...
          while (i5 > 0)
          {
            localObject16 = ((d)localObject14).e(i3, (char[])localObject3);
        ...
        if (i6 != 0)
        {
          ...
          ((d)localObject14).a((a)localObject5, i6, null, (char[])localObject3);
          ((a)localObject5).a();
        }
        if (i13 != 0)
        {
          i3 = ((d)localObject14).e(i13);
          i5 = i13 + 2;
          while (i3 > 0)
          {
            i5 = ((d)localObject14).a(((s)localObject13).a(((d)localObject14).e(i5, (char[])localObject3), true), i5 + 2, true, (char[])localObject3);
            i3--;
          }
        }
        if (i11 != 0)
        {
          ...
          while (i5 > 0)
          {
            i3 = ((d)localObject14).a(((s)localObject13).a(((d)localObject14).e(i3, (char[])localObject3), false), i3 + 2, true, (char[])localObject3);
            i5--;
          }
        }
        if (i14 != 0)
        {
          ...
          while (i5 > 0)
          {
            ...
            localObject5 = ((d)localObject14).e(i3, (char[])localObject3);
            i3 = ((d)localObject14).a(((s)localObject13).b(h, i, (String)localObject5, true), i3 + 2, true, (char[])localObject3);
            i5--;
          }
        }
        if (i7 != 0)
        {
          ...
          while (i5 > 0)
          {
            i3 = ((d)localObject14).a((i)localObject15, i3);
            localObject5 = ((d)localObject14).e(i3, (char[])localObject3);
            i3 = ((d)localObject14).a(((s)localObject13).b(h, i, (String)localObject5, false), i3 + 2, true, (char[])localObject3);
            i5--;
          }
        }
        if (i15 != 0) {
          ((d)localObject14).a((s)localObject13, (i)localObject15, i15, true);
        }
        if (i8 != 0) {
          ((d)localObject14).a((s)localObject13, (i)localObject15, i8, false);
        }
        ...
        if (i12 != 0) {
          ((d)localObject14).a((s)localObject13, (i)localObject15, i12);
        }
      }
      localObject9 = null;
      i2--;
