  ...
  extends q
{
  ...
  public final void a()
  {
    if ((e != null) && ((h) || (i)))
    {
      Drawable localDrawable = r.c(e.mutate());
      e = localDrawable;
      if (h) {
  ...
  public void a(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = x0.a(d.getContext(), paramAttributeSet, R.styleable.AppCompatSeekBar, paramInt, 0);
    ...
    d.invalidate();
    if (paramAttributeSet.f(R.styleable.AppCompatSeekBar_tickMarkTintMode))
    {
      g = e0.a(paramAttributeSet.c(R.styleable.AppCompatSeekBar_tickMarkTintMode, -1), g);
      i = true;
    }
    if (paramAttributeSet.f(R.styleable.AppCompatSeekBar_tickMarkTint))
    {
