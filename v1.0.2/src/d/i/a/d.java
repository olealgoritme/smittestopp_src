...
public class d
  ...
  implements l, c.a
{
  public h<Class<? extends d.a>, d.a> mExtraDataMap = new h();
  ...
  @Deprecated
  public <T extends d.a> T getExtraData(Class<T> paramClass)
  {
    return (d.a)mExtraDataMap.getOrDefault(paramClass, null);
  }
  ...
  @Deprecated
  public void putExtraData(d.a parama)
  {
