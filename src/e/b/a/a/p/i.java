  ...
  extends Writer
{
  ...
  public void close()
  {
    ...
    if (localObject != null)
    {
      ...
      if (i > 0)
      {
        ((OutputStream)localObject).write(z, 0, i);
        B = 0;
      }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          i = j + 1;
          arrayOfByte[j] = ((byte)(byte)(i1 >> 6 & 0x3F | 0x80));
          arrayOfByte[i] = ((byte)(byte)(i1 & 0x3F | 0x80));
          paramInt2 = paramInt1;
          paramInt1 = i + 1;
        }
      }
...
/* Location:
 * Qualified Name:     base.e.b.a.a.p.i
