  ...
  public boolean onPrepareActionMode(ActionMode paramActionMode, Menu paramMenu)
  {
    ...
    try
    {
      ...
      for (i = 0; i < ((ArrayList)localObject2).size(); i++)
      {
        ...
        localObject5 = b;
        localObject4 = new Intent().setAction("android.intent.action.PROCESS_TEXT").setType("text/plain");
        int j;
        if (((localObject5 instanceof Editable)) && (((TextView)localObject5).onCheckIsTextEditor()) && (((TextView)localObject5).isEnabled())) {
          j = 1;
        } else {
          j = 0;
        }
        localObject4 = ((Intent)localObject4).putExtra("android.intent.extra.PROCESS_TEXT_READONLY", j ^ 0x1);
