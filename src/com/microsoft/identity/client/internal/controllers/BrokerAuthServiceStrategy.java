  ...
  extends BrokerBaseStrategy
{
  ...
  {
    return (Intent)performAuthServiceOperation(paramAcquireTokenOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.2(this));
  }
  
  /* Error */
  private <T> T performAuthServiceOperation(android.content.Context paramContext, BrokerAuthServiceStrategy.AuthServiceOperation<T> paramAuthServiceOperation)
  {
    // Byte code:
    //   0: aload_2
    ...
    //   0	266	2	paramAuthServiceOperation	BrokerAuthServiceStrategy.AuthServiceOperation<T>
  ...
  {
    return (AcquireTokenResult)performAuthServiceOperation(paramAcquireTokenSilentOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.3(this, paramAcquireTokenSilentOperationParameters));
  }
  
  public List<ICacheRecord> getBrokerAccounts(OperationParameters paramOperationParameters)
  {
    return (List)performAuthServiceOperation(paramOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.4(this, paramOperationParameters));
  }
  ...
  {
    return (List)performAuthServiceOperation(paramOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.7(this, paramOperationParameters));
  }
  
  public boolean getDeviceMode(OperationParameters paramOperationParameters)
  {
    return ((Boolean)performAuthServiceOperation(paramOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.6(this))).booleanValue();
  }
  
  public void hello(OperationParameters paramOperationParameters)
  {
    performAuthServiceOperation(paramOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.1(this, paramOperationParameters));
  }
  
  public void removeBrokerAccount(OperationParameters paramOperationParameters)
  {
    performAuthServiceOperation(paramOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.5(this, paramOperationParameters));
  }
  
  public void signOutFromSharedDevice(OperationParameters paramOperationParameters)
  {
    performAuthServiceOperation(paramOperationParameters.getAppContext(), new BrokerAuthServiceStrategy.8(this, paramOperationParameters));
  }
}

/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.internal.controllers.BrokerAuthServiceStrategy
