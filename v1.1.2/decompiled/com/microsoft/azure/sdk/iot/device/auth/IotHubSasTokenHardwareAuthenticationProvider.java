  ...
  private String generateSasTokenSignatureFromSecurityProvider(long paramLong)
  {
    try
    {
      ...
      if ((str != null) && (!str.isEmpty()))
      {
        ...
        {
          localObject3 = Base64.encodeBase64Local((byte[])localObject2);
          localObject2 = new java/lang/String;
          ((String)localObject2).<init>((byte[])localObject3);
          return String.format("SharedAccessSignature sr=%s&sig=%s&se=%s", new Object[] { str, URLEncoder.encode((String)localObject2, IotHubSasTokenAuthenticationProvider.ENCODING_FORMAT_NAME), localObject1 });
        }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.auth.IotHubSasTokenHardwareAuthenticationProvider
