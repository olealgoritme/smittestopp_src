...
public class BrowserSelector
{
  ...
  public static boolean isFullBrowser(ResolveInfo paramResolveInfo)
  {
    if ((filter.hasAction("android.intent.action.VIEW")) && (filter.hasCategory("android.intent.category.BROWSABLE")) && (filter.schemesIterator() != null))
    {
      ...
      Iterator localIterator = filter.schemesIterator();
      int i = 0;
      int j = 0;
      while (localIterator.hasNext())
      {
        paramResolveInfo = (String)localIterator.next();
        boolean bool1 = i | "http".equals(paramResolveInfo);
        boolean bool2 = j | "https".equals(paramResolveInfo);
        i = bool1;
        j = bool2;
        if (bool1)
        {
  ...
  public static Browser select(Context paramContext, List<BrowserDescriptor> paramList)
  {
    ...
    paramList = TAG;
    Object localObject = a.a("Browser's package name: ");
    ((StringBuilder)localObject).append(paramContext.getPackageName());
    ((StringBuilder)localObject).append(" version: ");
    ((StringBuilder)localObject).append(paramContext.getVersion());
    Logger.info(paramList, ((StringBuilder)localObject).toString());
    return paramContext;
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.ui.browser.BrowserSelector
