...
public class PublicClientApplicationConfiguration
{
  ...
  public Authority getDefaultAuthority()
  {
    ...
    if (localObject != null)
    {
      ...
      {
        Iterator localIterator = mAuthorities.iterator();
        while (localIterator.hasNext())
        {
          localObject = (Authority)localIterator.next();
          if (((Authority)localObject).getDefault()) {
            return (Authority)localObject;
          }
        }
        return null;
      }
  ...
  public void validateConfiguration()
  {
    ...
    {
      localObject = (Authority)localIterator.next();
      if (!(localObject instanceof UnknownAuthority))
      {
        if ((localObject instanceof AzureActiveDirectoryAuthority)) {
          validateAzureActiveDirectoryAuthority((AzureActiveDirectoryAuthority)localObject);
        }
      }
      else {
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.PublicClientApplicationConfiguration
