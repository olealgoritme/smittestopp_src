  ...
  implements u, Cloneable
{
  ...
  public <T> TypeAdapter<T> a(final Gson paramGson, final e.c.c.x.a<T> parama)
  {
    Class localClass = parama.getRawType();
    final boolean bool1 = a(localClass);
    final boolean bool2;
    ...
    new TypeAdapter()
    {
      ...
      public T read(e.c.c.y.a paramAnonymousa)
      {
        ...
        {
          localTypeAdapter = paramGson.a(Excluder.this, parama);
          a = localTypeAdapter;
        }
        return (T)localTypeAdapter.read(paramAnonymousa);
      }
      ...
      public void write(c paramAnonymousc, T paramAnonymousT)
      {
        ...
        localTypeAdapter.write(paramAnonymousc, paramAnonymousT);
      }
    };
  }
