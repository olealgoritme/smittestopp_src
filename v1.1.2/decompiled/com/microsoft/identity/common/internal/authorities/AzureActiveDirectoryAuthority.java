  ...
  extends Authority
{
  ...
  public MicrosoftStsOAuth2Configuration createOAuth2Configuration()
  {
    ...
    if (mFlightParameters != null)
    {
      ...
      Iterator localIterator = mFlightParameters.entrySet().iterator();
      while (localIterator.hasNext())
      {
        localObject2 = (Map.Entry)localIterator.next();
        ((AzureActiveDirectoryOAuth2Configuration)localObject1).getFlightParameters().put(((Map.Entry)localObject2).getKey(), ((Map.Entry)localObject2).getValue());
      }
    }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.authorities.AzureActiveDirectoryAuthority
