  ...
  extends CoordinatorLayout.c<V>
{
  ...
  {
    c = paramV.animate().translationY(paramInt).setInterpolator(paramTimeInterpolator).setDuration(paramLong).setListener(new HideBottomViewOnScrollBehavior.a(this));
  }
...
/* Location:
 * Qualified Name:     base.com.google.android.material.behavior.HideBottomViewOnScrollBehavior
