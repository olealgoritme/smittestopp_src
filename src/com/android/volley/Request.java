  ...
  implements Comparable<Request<T>>
{
  ...
  public Request.NetworkRequestCompleteListener mRequestCompleteListener;
  ...
  public void notifyListenerResponseNotUsable()
  {
    synchronized (mLock)
    {
      Request.NetworkRequestCompleteListener localNetworkRequestCompleteListener = mRequestCompleteListener;
  ...
  public void setNetworkRequestCompleteListener(Request.NetworkRequestCompleteListener paramNetworkRequestCompleteListener)
  {
    synchronized (mLock)
    {
...
/* Location:
 * Qualified Name:     base.com.android.volley.Request
