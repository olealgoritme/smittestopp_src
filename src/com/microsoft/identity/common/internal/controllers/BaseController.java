...
public abstract class BaseController
{
  ...
  public static void logResult(String paramString, IResult paramIResult)
  {
    ...
    else
    {
      ...
      if (paramIResult.getErrorResponse() != null)
      {
        ...
        {
          localObject = a.a("Error: ");
          ((StringBuilder)localObject).append(paramIResult.getErrorResponse().getError());
          Logger.warn(paramString, ((StringBuilder)localObject).toString());
        }
        if (paramIResult.getErrorResponse().getErrorDescription() != null)
        {
          localObject = a.a("Description: ");
          ((StringBuilder)localObject).append(paramIResult.getErrorResponse().getErrorDescription());
          Logger.warnPII(paramString, ((StringBuilder)localObject).toString());
        }
    ...
    {
      localObject = (AuthorizationResult)paramIResult;
      if (((AuthorizationResult)localObject).getAuthorizationStatus() != null)
      {
        paramIResult = a.a("Authorization Status: ");
        paramIResult.append(((AuthorizationResult)localObject).getAuthorizationStatus().toString());
        Logger.info(paramString, paramIResult.toString());
      }
    }
  }
  ...
  public AccountRecord getCachedAccountRecord(AcquireTokenSilentOperationParameters paramAcquireTokenSilentOperationParameters)
  {
    if (paramAcquireTokenSilentOperationParameters.getAccount() != null)
    {
      ...
      localObject = TAG;
      paramAcquireTokenSilentOperationParameters = new StringBuilder();
      paramAcquireTokenSilentOperationParameters.append("No accounts found for clientId [");
      paramAcquireTokenSilentOperationParameters.append(str1);
      paramAcquireTokenSilentOperationParameters.append(", ]");
      Logger.info((String)localObject, paramAcquireTokenSilentOperationParameters.toString(), null);
  ...
  public TokenResult performSilentTokenRequest(OAuth2Strategy paramOAuth2Strategy, AcquireTokenSilentOperationParameters paramAcquireTokenSilentOperationParameters)
  {
    ...
    if (((Authority.KnownAuthorityResult)localObject).getKnown())
    {
      ...
      {
        String str = a.a(new StringBuilder(), TAG, ":performSilentTokenRequest");
        paramAcquireTokenSilentOperationParameters = a.a("Scopes: [");
        paramAcquireTokenSilentOperationParameters.append(((TokenRequest)localObject).getScope());
        paramAcquireTokenSilentOperationParameters.append("]");
        Logger.infoPII(str, paramAcquireTokenSilentOperationParameters.toString());
      }
  ...
  public TokenResult performTokenRequest(OAuth2Strategy paramOAuth2Strategy, AuthorizationRequest paramAuthorizationRequest, AuthorizationResponse paramAuthorizationResponse, AcquireTokenOperationParameters paramAcquireTokenOperationParameters)
  {
    ...
    paramAuthorizationResponse = paramOAuth2Strategy.createTokenRequest(paramAuthorizationRequest, paramAuthorizationResponse, paramAcquireTokenOperationParameters.getAuthenticationScheme());
    paramAuthorizationRequest = new StringBuilder();
    paramAuthorizationRequest.append(TAG);
    paramAuthorizationRequest.append(":performTokenRequest");
    logExposedFieldsOfObject(paramAuthorizationRequest.toString(), paramAuthorizationResponse);
    paramOAuth2Strategy = paramOAuth2Strategy.requestToken(paramAuthorizationResponse);
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.controllers.BaseController
