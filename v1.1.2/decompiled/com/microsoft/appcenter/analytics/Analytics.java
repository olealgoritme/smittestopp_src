  ...
  extends AbstractAppCenterService
{
  ...
  {
    final AnalyticsTransmissionTarget localAnalyticsTransmissionTarget = new AnalyticsTransmissionTarget(paramString, null);
    ...
    postCommandEvenIfDisabled(new Runnable()
    {
      public void run()
      {
        localAnalyticsTransmissionTarget.initInBackground(Analytics.access$000(Analytics.this), Analytics.access$100(Analytics.this));
      }
    });
  ...
  private void pauseInstanceAsync()
  {
    try
    {
      Runnable local9 = new com/microsoft/appcenter/analytics/Analytics$9;
      local9.<init>(this);
      post(local9);
      return;
    }
  ...
  private void resumeInstanceAsync()
  {
    try
    {
      Runnable local10 = new com/microsoft/appcenter/analytics/Analytics$10;
      local10.<init>(this);
      post(local10);
      return;
    }
  ...
  private void trackEventAsync(String paramString, List<TypedProperty> paramList, AnalyticsTransmissionTarget paramAnalyticsTransmissionTarget, int paramInt)
  {
    try
    {
      ...
      Runnable local8 = new com/microsoft/appcenter/analytics/Analytics$8;
  ...
  private void trackPageAsync(String paramString, Map<String, String> paramMap)
  {
    ...
    ((7)localObject).<init>(this, paramString, paramMap);
  ...
  public Channel.GroupListener getChannelListener()
  {
    ...
    {
      public void onBeforeSending(Log paramAnonymousLog)
      {
        if (Analytics.access$500(Analytics.this) != null) {
          Analytics.access$500(Analytics.this).onBeforeSending(paramAnonymousLog);
        }
      }
      
      public void onFailure(Log paramAnonymousLog, Exception paramAnonymousException)
      {
        if (Analytics.access$500(Analytics.this) != null) {
          Analytics.access$500(Analytics.this).onSendingFailed(paramAnonymousLog, paramAnonymousException);
        }
      }
      
      public void onSuccess(Log paramAnonymousLog)
      {
        if (Analytics.access$500(Analytics.this) != null) {
          Analytics.access$500(Analytics.this).onSendingSucceeded(paramAnonymousLog);
        }
      }
    };
  }
  ...
  public void onActivityPaused(Activity paramActivity)
  {
    try
    {
      Runnable local4 = new com/microsoft/appcenter/analytics/Analytics$4;
      local4.<init>(this);
  ...
  public void onActivityResumed(Activity paramActivity)
  {
    try
    {
      Runnable local2 = new com/microsoft/appcenter/analytics/Analytics$2;
      local2.<init>(this, paramActivity);
      Runnable local3 = new com/microsoft/appcenter/analytics/Analytics$3;
...
/* Location:
 * Qualified Name:     com.microsoft.appcenter.analytics.Analytics
