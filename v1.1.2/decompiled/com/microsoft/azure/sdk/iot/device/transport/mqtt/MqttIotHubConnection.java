  ...
  implements IotHubTransportConnection, MqttMessageListener
{
  ...
  public void close()
  {
    ...
    try
    {
      ...
      log.e("Successfully closed MQTT connection");
      return;
    }
  ...
  public void onMessageArrived(int paramInt)
  {
    ...
    if (localObject == null)
    {
      ...
      log.c("Received message that could not be parsed. That message has been ignored.");
    }
    else
    {
    ...
    if (paramQueue.size() <= 1) {
      synchronized (MQTT_CONNECTION_LOCK)
      {
        ...
        try
        {
          ...
          {
            log.d("MQTT connection will use sas token based auth");
          ...
          else if (config.getAuthenticationType() == DeviceClientConfig.AuthType.X509_CERTIFICATE)
          {
            ...
            {
              log.d("MQTT connection will use X509 certificate based auth");
          ...
          paramScheduledExecutorService = config.getProductInfo().getUserAgentString();
          paramQueue = new java/lang/StringBuilder;
          paramQueue.<init>();
          paramQueue.append("DeviceClientType=");
          paramQueue.append(URLEncoder.encode(paramScheduledExecutorService, "UTF-8").replaceAll("\\+", "%20"));
          Object localObject3 = paramQueue.toString();
          paramScheduledExecutorService = config.getDeviceId();
          String str = config.getModuleId();
          ...
          if (config.isUseWebsocket())
          {
            ...
            paramScheduledExecutorService = new com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection;
            paramScheduledExecutorService.<init>((String)localObject3, paramQueue, iotHubUserName, iotHubUserPassword, (SSLContext)localObject2, config.getProxySettings());
            mqttConnection = paramScheduledExecutorService;
          }
          else
          {
            localObject3 = new java/lang/StringBuilder;
            ...
            localObject3 = ((StringBuilder)localObject3).toString();
            paramScheduledExecutorService = new com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttConnection;
            paramScheduledExecutorService.<init>((String)localObject3, paramQueue, iotHubUserName, iotHubUserPassword, (SSLContext)localObject2, null);
            mqttConnection = paramScheduledExecutorService;
          }
          localObject3 = new com/microsoft/azure/sdk/iot/device/transport/mqtt/MqttMessaging;
          localObject2 = mqttConnection;
          paramScheduledExecutorService = config.getDeviceId();
          IotHubListener localIotHubListener = listener;
          str = connectionId;
          paramQueue = config.getModuleId();
          boolean bool;
          ...
          ((MqttMessaging)localObject3).<init>((MqttConnection)localObject2, paramScheduledExecutorService, localIotHubListener, this, str, paramQueue, bool, unacknowledgedSentMessages);
          ...
          log.e("MQTT connection opened successfully");
  ...
  public boolean sendMessageResult(Message paramMessage, IotHubMessageResult paramIotHubMessageResult)
  {
    if ((paramMessage != null) && (paramIotHubMessageResult != null))
    {
      ...
      log.e("Mqtt layer could not acknowledge received message because it has no mapping to an outstanding mqtt message id ({})", paramMessage, paramIotHubMessageResult);
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.transport.mqtt.MqttIotHubConnection
