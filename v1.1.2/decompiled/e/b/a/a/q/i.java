  ...
  extends c
{
    ...
    if (paramInt3 != -2)
    {
      if ((paramInt1 > 5) && (paramInt1 < paramInt2))
      {
        ...
        if (paramChar > 'ÿ')
        {
          ...
          paramInt2 = paramInt1 + 1;
          localObject = P;
          paramArrayOfChar[paramInt1] = ((char)localObject[(paramInt3 >> 4)]);
          paramInt1 = paramInt2 + 1;
          paramArrayOfChar[paramInt2] = ((char)localObject[(paramInt3 & 0xF)]);
  ...
  public void close()
  {
      ...
      for (;;)
      {
        ...
        if (((k)localObject1).b())
        {
          if (z.b())
          {
            ...
            int i = K;
            K = (i + 1);
            localObject1[i] = ((char)93);
            z = z.c;
          }
          else
          {
            localObject1 = e.a.a.a.a.a("Current context not Array but ");
            ((StringBuilder)localObject1).append(z.e());
            throw new e.b.a.a.e(((StringBuilder)localObject1).toString(), this);
          }
        }
        else
        {
    ...
    if (localObject1 != null)
    {
      ...
      {
        ((b)localObject2).a((char[])localObject1, h);
        h = null;
        d.b[1] = localObject1;
      }
      else
    ...
    if (localObject2 != null)
    {
      ...
      if (localObject1 != null)
      {
        ((b)localObject1).a((char[])localObject2, i);
        i = null;
        d.b[3] = localObject2;
      }
      else
  ...
  public final void e(String paramString)
  {
    ...
    if (j != 0)
    {
      m = K + i;
      paramString = B;
      i3 = Math.min(paramString.length, j + 1);
      if (K < m) {
        label562:
        do
        {
    ...
    else
    {
      ...
      if (K < j) {
        do
        {
          ...
          m = K;
          i3 = localObject[m];
          if ((i3 < i) && (paramString[i3] != 0))
          {
            i3 = J;
            m -= i3;
            if (m > 0) {
              G.write((char[])localObject, i3, m);
            }
            localObject = I;
            m = K;
            K = (m + 1);
