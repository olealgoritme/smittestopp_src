      ...
      if ((n > 8) && (j < localObject.length / 3))
      {
        ...
        if (j == z)
        {
          if (paramInt > 0)
          {
            ...
            System.arraycopy(arrayOfObject, 0, y, 0, i);
          }
          if (paramInt < m)
          {
            k = paramInt + 1;
            int[] arrayOfInt = x;
            n = m - paramInt;
            System.arraycopy(localObject, k, arrayOfInt, paramInt, n);
            System.arraycopy(arrayOfObject, k << 1, y, i, n << 1);
          }
        }
        else
        {
    ...
    if (i >= x.length)
    {
      ...
      if (i == z)
      {
        ...
        if (arrayOfInt2.length > 0)
        {
          ...
          System.arraycopy(localObject, 0, y, 0, localObject.length);
        }
