...
public class ExceptionAdapter
{
  ...
  public static ServiceException exceptionFromTokenResult(TokenResult paramTokenResult)
  {
    ...
    {
      localObject = a.a(new StringBuilder(), TAG, ":exceptionFromTokenResult");
      StringBuilder localStringBuilder = a.a("Unknown error, Token result is null [");
      boolean bool;
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.controllers.ExceptionAdapter
