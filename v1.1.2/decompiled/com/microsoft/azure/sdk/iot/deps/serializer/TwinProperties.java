...
public class TwinProperties
{
  ...
  public void validate(Map<String, Object> paramMap)
  {
    ...
    while (paramMap.hasNext())
    {
      Map.Entry localEntry = (Map.Entry)paramMap.next();
      if (((String)localEntry.getKey()).equals("desired")) {
        desired.validate((Map)localEntry.getValue());
      } else if (((String)localEntry.getKey()).equals("reported")) {
        reported.validate((Map)localEntry.getValue());
      } else {
        throw new IllegalArgumentException("Invalid Property");
      }
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.deps.serializer.TwinProperties
