      ...
      if ((k & 0xFFC00000) == (0xFFC00000 & j))
      {
        if ((j & 0x3C00000) == 8388608)
        {
          ...
          if (a != null)
          {
            ...
            try
            {
              Class localClass = Class.forName(((String)localObject2).replace('/', '.'), false, (ClassLoader)localObject4);
              try
              {
                localObject4 = Class.forName(((String)localObject3).replace('/', '.'), false, (ClassLoader)localObject4);
              ...
              {
                throw new TypeNotPresentException((String)localObject3, paramx);
              }
              throw null;
            }
            catch (ClassNotFoundException paramx)
      ...
      default: 
        ...
        default: 
          ...
          case 189: 
            ...
            if (paramw.charAt(0) == '[')
            {
              ...
              a(paramx, ((StringBuilder)localObject).toString());
            }
            else
            {
              c(paramx.d(paramw) | 0x4800000);
            }
            break;
          case 188: 
            a();
        ...
        case 57: 
          ...
          if (paramInt2 > 0)
          {
            ...
            {
              paramInt2 = paramInt1 & 0x3C00000;
              if ((paramInt2 == 16777216) || (paramInt2 == 20971520)) {
                b(j, paramInt1 | 0x100000);
              }
            }
            else
            {
