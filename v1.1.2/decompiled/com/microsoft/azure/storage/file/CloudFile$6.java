  ...
  extends StorageRequest<CloudFileClient, CloudFile, Integer>
{
  ...
  public HttpURLConnection buildRequest(CloudFileClient paramCloudFileClient, CloudFile paramCloudFile, OperationContext paramOperationContext)
  {
    ...
    return FileRequest.getFile(localURI, localFileRequestOptions, paramOperationContext, paramCloudFileClient, str, localLong, paramCloudFile, bool);
  }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.file.CloudFile.6
