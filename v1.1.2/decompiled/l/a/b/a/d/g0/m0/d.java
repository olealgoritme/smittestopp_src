  ...
  implements h
{
  ...
  public d(b paramb, b0 paramb0, f0 paramf0)
  {
    ...
    if (l.isLoggable(Level.FINE))
    {
      ...
      paramb.append("Constructed ");
      paramb.append(this);
      paramb0.fine(paramb.toString());
    }
  }
  ...
  public final void a()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = a.unwrap((ByteBuffer)localObject2, (ByteBuffer)localObject3);
      a((SSLEngineResult)localObject1, "input");
      ((SSLEngineResult)localObject1).bytesProduced();
      ...
      if ((n != -1) && (n > 0))
      {
        ...
        {
          ByteBuffer localByteBuffer = b.tail();
          int i1 = i.limit();
          n = i.remaining() - n;
          if (n > 0) {
            i.limit(i1 - n);
      ...
      if (n != 1)
      {
        if (n != 2)
        {
          ...
          if ((e.position() <= 0) || (localObject2 != SSLEngineResult.Status.OK))
          {
            if ((e.position() != 0) || (localObject3 != SSLEngineResult.HandshakeStatus.NEED_UNWRAP) || (!d)) {
              break;
            }
            f = true;
            break;
      ...
      {
        n = e.remaining();
        if ((n <= 0) || (localObject2 != SSLEngineResult.Status.OK) || ((n >= m) && (m >= 0))) {
          break;
        }
        pending();
        m = n;
  ...
  public final void b()
  {
    for (;;)
    {
      ...
      m = c.pending();
      localObject2 = ((SSLEngineResult)localObject1).getStatus();
      int n = a.a[localObject2.ordinal()];
      if (n != 1)
      {
        if (n != 2)
        {
  ...
  public void process()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 50	l/a/b/a/d/g0/m0/d:d	Z
    //   4: ifne +112 -> 116
    //   7: aload_0
    //   8: getfield 86	l/a/b/a/d/g0/m0/d:e	Ljava/nio/ByteBuffer;
    //   11: invokevirtual 160	java/nio/ByteBuffer:flip	()Ljava/nio/Buffer;
    //   14: pop
    //   15: aload_0
    //   16: invokevirtual 333	l/a/b/a/d/g0/m0/d:a	()V
    //   19: aload_0
    //   20: getfield 86	l/a/b/a/d/g0/m0/d:e	Ljava/nio/ByteBuffer;
    ...
    //   29: goto +77 -> 106
    //   32: astore_2
    //   33: getstatic 43	l/a/b/a/d/g0/m0/d:l	Ljava/util/logging/Logger;
    ...
    //   42: ifeq +20 -> 62
    //   45: getstatic 43	l/a/b/a/d/g0/m0/d:l	Ljava/util/logging/Logger;
    ...
    //   59: goto +16 -> 75
    //   62: getstatic 43	l/a/b/a/d/g0/m0/d:l	Ljava/util/logging/Logger;
    ...
    //   75: aload_0
    //   76: getfield 86	l/a/b/a/d/g0/m0/d:e	Ljava/nio/ByteBuffer;
    //   79: aload_0
    //   80: getfield 86	l/a/b/a/d/g0/m0/d:e	Ljava/nio/ByteBuffer;
    //   83: invokevirtual 169	java/nio/ByteBuffer:limit	()I
    //   86: invokevirtual 331	java/nio/ByteBuffer:position	(I)Ljava/nio/Buffer;
    //   89: pop
    //   90: aload_0
    //   91: iconst_1
    //   92: putfield 50	l/a/b/a/d/g0/m0/d:d	Z
    //   95: new 184	l/a/b/a/d/d0
    //   98: astore_1
    //   99: aload_1
    //   100: aload_2
    //   101: invokespecial 339	l/a/b/a/d/d0:<init>	(Ljava/lang/Throwable;)V
    //   104: aload_1
    //   105: athrow
    //   106: aload_0
    //   107: getfield 86	l/a/b/a/d/g0/m0/d:e	Ljava/nio/ByteBuffer;
    //   110: invokevirtual 182	java/nio/ByteBuffer:compact	()Ljava/nio/ByteBuffer;
    //   113: pop
    //   114: aload_1
    //   115: athrow
    //   116: new 184	l/a/b/a/d/d0
    //   119: dup
    //   120: ldc_w 341
    //   123: invokespecial 188	l/a/b/a/d/d0:<init>	(Ljava/lang/String;)V
    //   126: athrow
    ...
    //   98	17	1	locald0	d0
    //   32	69	2	localSSLException	SSLException
    // Exception table:
    //   from	to	target	type
    //   15	19	28	finally
    //   33	59	28	finally
...
/* Location:
 * Qualified Name:     l.a.b.a.d.g0.m0.d
