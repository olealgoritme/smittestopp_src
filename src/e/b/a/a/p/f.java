...
public final class f
{
  ...
  public static int a(int paramInt1, char[] paramArrayOfChar, int paramInt2)
  {
    ...
    paramArrayOfChar[paramInt1] = ((char)(char)(i >> 8 & 0x7F));
    paramArrayOfChar[paramInt2] = ((char)(char)(i & 0x7F));
    return paramInt2 + 1;
  }
  ...
  public static int c(int paramInt1, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if (i >= 1000000000)
    {
      ...
      paramInt2 = paramInt1 + 1;
      paramArrayOfByte[paramInt1] = ((byte)(byte)(j >> 8));
      paramArrayOfByte[paramInt2] = ((byte)(byte)j);
      return paramInt2 + 1;
    }
    paramInt2 = i / 1000;
    paramInt1 = paramInt2 / 1000;
    return a(i - paramInt2 * 1000, paramArrayOfByte, a(paramInt2 - paramInt1 * 1000, paramArrayOfByte, b(paramInt1, paramArrayOfByte, j)));
  }
  ...
  public static int c(int paramInt1, char[] paramArrayOfChar, int paramInt2)
  {
    ...
    if (i >= 1000000000)
    {
      ...
      paramArrayOfChar[paramInt2] = ((char)(char)(i >> 16));
      k = n + 1;
      paramArrayOfChar[n] = ((char)(char)(i >> 8 & 0x7F));
      paramInt2 = k + 1;
      paramArrayOfChar[k] = ((char)(char)(i & 0x7F));
      j = arrayOfInt[(paramInt1 - j * 1000)];
      paramInt1 = paramInt2 + 1;
...
/* Location:
 * Qualified Name:     base.e.b.a.a.p.f
