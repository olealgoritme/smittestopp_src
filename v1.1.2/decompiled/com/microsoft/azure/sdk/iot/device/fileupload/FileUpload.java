...
public final class FileUpload
{
  ...
  public FileUpload(DeviceClientConfig paramDeviceClientConfig)
  {
    if (paramDeviceClientConfig != null)
    {
      ...
      try
      {
        ...
        fileUploadStatusCallBack = new FileUploadStatusCallBack(null);
        log.b("FileUpload object is created successfully");
        return;
      }
  ...
  public final class FileUploadStatusCallBack
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.fileupload.FileUpload
