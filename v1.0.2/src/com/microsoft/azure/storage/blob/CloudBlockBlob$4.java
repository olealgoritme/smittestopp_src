  ...
  extends StorageRequest<CloudBlobClient, CloudBlob, Void>
{
  ...
  public HttpURLConnection buildRequest(CloudBlobClient paramCloudBlobClient, CloudBlob paramCloudBlob, OperationContext paramOperationContext)
  {
    ...
    return BlobRequest.putBlob(paramCloudBlobClient, localBlobRequestOptions, localOperationContext, paramOperationContext, paramCloudBlob, paramCloudBlob.getBlobType(), getLength().longValue());
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.CloudBlockBlob.4
