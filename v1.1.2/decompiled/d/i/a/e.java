...
public class e
{
  ...
  public Notification a()
  {
    ...
    Object localObject4 = ((Notification.Builder)localObject3).setAutoCancel(bool).setDefaults(defaults).setContentTitle(d).setContentText(e).setContentInfo(j).setContentIntent(f).setDeleteIntent(deleteIntent);
    localObject3 = g;
    if ((flags & 0x80) != 0) {
      bool = true;
    } else {
    ...
    ((Notification.Builder)localObject4).setFullScreenIntent((PendingIntent)localObject3, bool).setLargeIcon(i).setNumber(k).setProgress(r, s, t);
    ...
    while (((Iterator)localObject5).hasNext())
    {
      ...
      {
        localObject4 = new RemoteInput[localObject7.length];
        if (localObject7.length <= 0)
        {
          i2 = localObject4.length;
          for (i1 = 0; i1 < i2; i1++) {
            ((Notification.Action.Builder)localObject3).addRemoteInput(localObject4[i1]);
          }
        }
        localObject1 = localObject7[0];
    ...
    if (c.size() > 0)
    {
      ...
      for (i1 = 0; i1 < c.size(); i1++) {
        ((Bundle)localObject4).putBundle(Integer.toString(i1), g.a((c)c.get(i1)));
      }
  ...
  {
    b.add(new c(paramInt, paramCharSequence, paramPendingIntent));
    return this;
  }
