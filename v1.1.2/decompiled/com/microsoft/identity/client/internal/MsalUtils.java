...
public final class MsalUtils
{
  ...
  public static String appendQueryParameterToUrl(String paramString, Map<String, String> paramMap)
  {
    if (!isEmpty(paramString))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localStringBuilder.append(urlFormEncode((String)paramMap.getValue()));
  ...
  public static Set<String> getScopesAsSet(String paramString)
  {
    ...
    paramString = paramString.toLowerCase(Locale.US).split(" ");
    HashSet localHashSet = new HashSet();
    for (int i = 0; i < paramString.length; i++) {
      if (!isEmpty(paramString[i])) {
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.internal.MsalUtils
