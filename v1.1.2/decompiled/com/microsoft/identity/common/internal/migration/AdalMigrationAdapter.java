  ...
  implements IMigrationAdapter<MicrosoftAccount, MicrosoftRefreshToken>
{
  ...
  public static MicrosoftAccount createAccount(ADALTokenCacheItem paramADALTokenCacheItem)
  {
    try
    {
      ...
      localObject3 = ((j)localObject4).toString();
      localObject2 = new java/lang/String;
      ((String)localObject2).<init>(Base64.encode(((String)localObject3).getBytes(), 0));
      localObject3 = new com/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/ClientInfo;
      ((ClientInfo)localObject3).<init>((String)localObject2);
      localObject2 = new com/microsoft/identity/common/internal/providers/oauth2/IDToken;
      ((IDToken)localObject2).<init>((String)localObject1);
      ...
      ((AzureActiveDirectoryAccount)localObject1).<init>((IDToken)localObject2, (ClientInfo)localObject3);
  ...
  private Map<String, ADALTokenCacheItem> deserialize(Map<String, String> paramMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localHashMap.put(paramMap.getKey(), localGson.a((String)paramMap.getValue(), ADALTokenCacheItem.class));
    }
    return localHashMap;
  }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.migration.AdalMigrationAdapter
