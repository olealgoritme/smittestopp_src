...
public class SharedAccessSignatureHelper
{
  ...
  public static UriQueryBuilder generateSharedAccessSignatureHelper(SharedAccessPolicy paramSharedAccessPolicy, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, IPRange paramIPRange, SharedAccessProtocols paramSharedAccessProtocols, String paramString7, String paramString8, SharedAccessHeaders paramSharedAccessHeaders)
  {
    ...
    if (paramSharedAccessPolicy != null)
    {
      str = paramSharedAccessPolicy.permissionsToString();
    ...
    addIfNotNullOrEmpty((UriQueryBuilder)localObject2, "sp", str);
    addIfNotNullOrEmpty((UriQueryBuilder)localObject2, "st", Utility.getUTCTimeOrEmpty(paramSharedAccessPolicy));
    addIfNotNullOrEmpty((UriQueryBuilder)localObject2, "se", Utility.getUTCTimeOrEmpty((Date)localObject3));
  ...
  public static StorageCredentialsSharedAccessSignature parseQuery(HashMap<String, String[]> paramHashMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject2 = ((String)localEntry.getKey()).toLowerCase(Utility.LOCALE_US);
      if (((String)localObject2).equals("sig")) {
        i = 1;
      } else if (((String)localObject2).equals("comp")) {
        ((ArrayList)localObject1).add(localEntry.getKey());
      } else if (((String)localObject2).equals("restype")) {
        ((ArrayList)localObject1).add(localEntry.getKey());
      } else if (((String)localObject2).equals("snapshot")) {
        ((ArrayList)localObject1).add(localEntry.getKey());
      } else if (((String)localObject2).equals("api-version")) {
        ((ArrayList)localObject1).add(localEntry.getKey());
      } else if (((String)localObject2).equals("sharesnapshot")) {
        ((ArrayList)localObject1).add(localEntry.getKey());
      }
    }
    ...
    if (i != 0)
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        for (i = 0; i < ((String[])localEntry.getValue()).length; i++)
        {
          ((StringBuilder)localObject2).append(((String[])localEntry.getValue())[i]);
          ((StringBuilder)localObject2).append(',');
        }
        ((StringBuilder)localObject2).deleteCharAt(((StringBuilder)localObject2).length() - 1);
        addIfNotNullOrEmpty((UriQueryBuilder)localObject1, ((String)localEntry.getKey()).toLowerCase(), ((StringBuilder)localObject2).toString());
      }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.core.SharedAccessSignatureHelper
