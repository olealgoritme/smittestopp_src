  ...
  implements Handler.Callback
{
  ...
  {
    r.b(paramServiceConnection, "ServiceConnection must not be null");
    synchronized (c)
    {
  ...
  public final boolean handleMessage(Message paramMessage)
  {
    ...
    if (i != 0)
    {
      ...
      synchronized (c)
      {
        ...
        localObject3 = (d0)c.get(localObject2);
        if ((localObject3 != null) && (b == 3))
        {
          ...
          ((d0)localObject3).onServiceDisconnected((ComponentName)???);
        }
        return true;
      }
    }
    ...
    {
      ??? = (i.a)obj;
      paramMessage = (d0)c.get(???);
      if ((paramMessage != null) && (a.isEmpty()))
      {
        if (c)
        {
          ...
          {
            ((Context)localObject2).unbindService(paramMessage);
            c = false;
            b = 2;
          }
          else
...
/* Location:
 * Qualified Name:     base.e.c.a.a.b.j.c0
