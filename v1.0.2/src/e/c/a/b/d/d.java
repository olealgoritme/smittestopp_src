  ...
  implements d.b.d.i.n
{
  ...
  public ColorStateList a(int paramInt)
  {
    ...
    int j = localColorStateList.getColorForState(W, i);
  ...
  public void a()
  {
    ...
    for (int j = 0; j < U.size(); j++)
    {
      ...
      H[j] = localObject2;
      ((a)localObject2).setIconTintList(K);
      ((a)localObject2).setIconSize(L);
      ((a)localObject2).setTextColor(N);
      ((a)localObject2).setTextAppearanceInactive(O);
      ((a)localObject2).setTextAppearanceActive(P);
      ((a)localObject2).setTextColor(M);
      localObject1 = Q;
      if (localObject1 != null) {
        ((a)localObject2).setItemBackground((Drawable)localObject1);
      } else {
        ((a)localObject2).setItemBackground(R);
      }
      ((a)localObject2).setShifting(bool);
      ((a)localObject2).setLabelVisibilityMode(G);
      ((a)localObject2).a((i)U.getItem(j), 0);
      ((a)localObject2).setItemPosition(j);
      ((FrameLayout)localObject2).setOnClickListener(D);
...
/* Location:
 * Qualified Name:     base.e.c.a.b.d.d
