...
public class ClaimsRequest
{
  ...
  {
    e locale = new e();
    Object localObject = new ClaimsRequestSerializer();
    RequestClaimAdditionalInformationSerializer localRequestClaimAdditionalInformationSerializer = new RequestClaimAdditionalInformationSerializer();
    locale.a(ClaimsRequest.class, localObject);
    locale.a(RequestedClaimAdditionalInformation.class, localRequestClaimAdditionalInformationSerializer);
    g = true;
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.claims.ClaimsRequest
