...
public final class DeviceClientConfig
{
  ...
  public DeviceClientConfig(IotHubConnectionString paramIotHubConnectionString)
  {
    ...
    log.e("Device configured to use software based SAS authentication provider");
  }
  ...
  public DeviceClientConfig(IotHubConnectionString paramIotHubConnectionString, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    log.e("Device configured to use software based x509 authentication provider");
  }
  ...
  public DeviceClientConfig(IotHubConnectionString paramIotHubConnectionString, SSLContext paramSSLContext)
  {
    ...
    if (paramIotHubConnectionString.isUsingX509())
    {
      ...
      log.e("Device configured to use software based x509 authentication provider with custom SSLContext");
    }
    else
    {
      ...
      log.e("Device configured to use software based SAS authentication provider with custom SSLContext");
    }
  }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.DeviceClientConfig
