...
public class CloudPageBlob$5
  extends StorageRequest<CloudBlobClient, CloudPageBlob, Void>
{
  public CloudPageBlob$5(CloudPageBlob paramCloudPageBlob, RequestOptions paramRequestOptions, StorageUri paramStorageUri, BlobRequestOptions paramBlobRequestOptions, AccessCondition paramAccessCondition, long paramLong)
  {
  ...
  {
    return BlobRequest.resize(paramCloudPageBlob.getTransformedAddress(paramOperationContext).getUri(getCurrentLocation()), val$options, paramOperationContext, val$accessCondition, Long.valueOf(val$size));
  }
  ...
  public Void preProcessResponse(CloudPageBlob paramCloudPageBlob, CloudBlobClient paramCloudBlobClient, OperationContext paramOperationContext)
  {
    ...
    paramCloudPageBlob.getProperties().setLength(val$size);
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.CloudPageBlob.5
