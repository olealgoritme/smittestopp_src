  ...
  extends a
{
  ...
  public int a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    l.b.c.e.a.b(k, paramArrayOfByte, paramInt + 28);
    e();
    return 32;
  }
  ...
  public void b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    int i4 = paramArrayOfByte[(i3 + 1)];
    paramArrayOfByte = l;
    i3 = m;
    paramArrayOfByte[i3] = (i4 & 0xFF | i1 << 24 | (paramInt & 0xFF) << 16 | (i2 & 0xFF) << 8);
    paramInt = i3 + 1;
    m = paramInt;
    if (paramInt == 16) {
      d();
