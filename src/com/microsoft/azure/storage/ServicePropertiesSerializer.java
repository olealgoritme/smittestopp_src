...
public final class ServicePropertiesSerializer
{
  ...
  public static void writeCorsProperties(XMLStreamWriter paramXMLStreamWriter, CorsProperties paramCorsProperties)
  {
    ...
    paramCorsProperties = paramCorsProperties.getCorsRules().iterator();
    while (paramCorsProperties.hasNext())
    {
      CorsRule localCorsRule = (CorsRule)paramCorsProperties.next();
      if ((!localCorsRule.getAllowedOrigins().isEmpty()) && (!localCorsRule.getAllowedMethods().isEmpty()) && (localCorsRule.getMaxAgeInSeconds() >= 0))
      {
        paramXMLStreamWriter.writeStartElement("CorsRule");
        paramXMLStreamWriter.writeStartElement("AllowedOrigins");
        paramXMLStreamWriter.writeCharacters(joinToString(localCorsRule.getAllowedOrigins(), ","));
        paramXMLStreamWriter.writeEndElement();
        paramXMLStreamWriter.writeStartElement("AllowedMethods");
        paramXMLStreamWriter.writeCharacters(joinToString(localCorsRule.getAllowedMethods(), ","));
        paramXMLStreamWriter.writeEndElement();
        paramXMLStreamWriter.writeStartElement("ExposedHeaders");
        paramXMLStreamWriter.writeCharacters(joinToString(localCorsRule.getExposedHeaders(), ","));
        paramXMLStreamWriter.writeEndElement();
        paramXMLStreamWriter.writeStartElement("AllowedHeaders");
        paramXMLStreamWriter.writeCharacters(joinToString(localCorsRule.getAllowedHeaders(), ","));
        paramXMLStreamWriter.writeEndElement();
        paramXMLStreamWriter.writeStartElement("MaxAgeInSeconds");
        paramXMLStreamWriter.writeCharacters(Integer.toString(localCorsRule.getMaxAgeInSeconds()));
        paramXMLStreamWriter.writeEndElement();
        paramXMLStreamWriter.writeEndElement();
      }
      else
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.ServicePropertiesSerializer
