...
public class AppCompatViewInflater
{
  ...
  public static final Map<String, Constructor<? extends View>> sConstructorMap = new a();
  ...
  private void checkOnClickListener(View paramView, AttributeSet paramAttributeSet)
  {
    ...
    if (((localObject instanceof ContextWrapper)) && (d.i.i.n.q(paramView)))
    {
      ...
      if (paramAttributeSet != null) {
        paramView.setOnClickListener(new AppCompatViewInflater.a(paramView, paramAttributeSet));
      }
  ...
  private View createViewFromTag(Context paramContext, String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   3: aload_2
    //   4: ldc -108
    //   6: invokevirtual 152	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   9: ifeq +14 -> 23
    //   12: aload_3
    //   13: aconst_null
    //   14: ldc -102
    //   16: invokeinterface 158 3 0
    //   21: astore 4
    //   23: aload_0
    ...
    //   38: aload 4
    //   40: bipush 46
    //   42: invokevirtual 162	java/lang/String:indexOf	(I)I
    //   45: if_icmpne +69 -> 114
    //   48: iconst_0
    //   49: istore 5
    //   51: iload 5
    ...
    //   67: iload 5
    //   69: aaload
    //   70: invokespecial 164	androidx/appcompat/app/AppCompatViewInflater:createViewByPrefix	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   73: astore_2
    //   74: aload_2
    //   75: ifnull +18 -> 93
    //   78: aload_0
    ...
    //   116: aload 4
    //   118: aconst_null
    //   119: invokespecial 164	androidx/appcompat/app/AppCompatViewInflater:createViewByPrefix	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   122: astore_1
    //   123: aload_0
...
/* Location:
 * Qualified Name:     base.androidx.appcompat.app.AppCompatViewInflater
