  ...
  extends ExpandableBehavior
{
  ...
  public boolean a(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    b = paramView1;
    paramView1.addListener(new ExpandableTransformationBehavior.a(this));
    b.start();
    if (!paramBoolean2) {
      b.end();
    }
...
/* Location:
 * Qualified Name:     base.com.google.android.material.transformation.ExpandableTransformationBehavior
