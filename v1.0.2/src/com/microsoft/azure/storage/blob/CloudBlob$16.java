...
public class CloudBlob$16
  extends StorageRequest<CloudBlobClient, CloudBlob, Void>
{
  public CloudBlob$16(CloudBlob paramCloudBlob, RequestOptions paramRequestOptions, StorageUri paramStorageUri, BlobRequestOptions paramBlobRequestOptions, AccessCondition paramAccessCondition)
  {
  ...
  {
    return BlobRequest.setBlobProperties(paramCloudBlob.getTransformedAddress(paramOperationContext).getUri(getCurrentLocation()), val$options, paramOperationContext, val$accessCondition, properties);
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.CloudBlob.16
