    ...
    if (a == -1)
    {
      ...
      if (k >= 23)
      {
        ...
        else
        {
          ...
          try
          {
            int m = ((Integer)localIcon.getClass().getMethod("getResId", new Class[0]).invoke(localIcon, new Object[0])).intValue();
            k = m;
          }
            ...
            if (k != 4)
            {
              if (k == 5)
              {
                ...
                else
                {
                  ...
                  ((Canvas)localObject1).drawCircle(f1, f1, 0.9166667F * f1, localPaint);
                  ((Canvas)localObject1).setBitmap(null);
                  localObject1 = Icon.createWithBitmap(localBitmap);
                }
              }
              else {
