...
public class i
{
  ...
  public Typeface a(Context paramContext, Resources paramResources, int paramInt1, String paramString, int paramInt2)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 25	d/b/a/r:a	(Landroid/content/Context;)Ljava/io/File;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnonnull +5 -> 11
    //   9: aconst_null
    ...
    //   12: aload_2
    //   13: iload_3
    //   14: invokestatic 28	d/b/a/r:a	(Ljava/io/File;Landroid/content/res/Resources;I)Z
    //   17: istore 6
    //   19: iload 6
    //   21: ifne +10 -> 31
    //   24: aload_1
  ...
  public Typeface a(Context paramContext, java.io.InputStream paramInputStream)
  {
    ...
    //   11: aload_1
    //   12: aload_2
    //   13: invokestatic 50	d/b/a/r:a	(Ljava/io/File;Ljava/io/InputStream;)Z
    //   16: istore_3
    //   17: iload_3
    //   18: ifne +10 -> 28
    //   21: aload_1
