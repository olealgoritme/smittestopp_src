  ...
  public b(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    if (paramArrayOfByte != null)
    {
      if (!a(paramArrayOfByte))
      {
        ...
        throw new IllegalArgumentException(e.a.a.a.a.a("lineSeparator must not contain base64 characters: [", new String(paramArrayOfByte, k.a.a.a.a.a), "]"));
      }
    }
    else
    {
      ...
      if (paramInt2 != 0) {
        if (paramInt2 != 1)
        {
          if (paramInt2 == 2)
          {
            ...
            arrayOfByte1 = f;
            i1 = a;
            paramArrayOfByte[paramInt1] = ((byte)arrayOfByte1[(i1 >> 10 & 0x3F)]);
            paramInt2 = n + 1;
            d = paramInt2;
            paramArrayOfByte[n] = ((byte)arrayOfByte1[(i1 >> 4 & 0x3F)]);
            n = paramInt2 + 1;
            d = n;
            paramArrayOfByte[paramInt2] = ((byte)arrayOfByte1[(i1 << 2 & 0x3F)]);
            if (arrayOfByte1 == k)
            {
              d = (n + 1);
        ...
        else
        {
          ...
          arrayOfByte1 = f;
          n = a;
          paramArrayOfByte[paramInt1] = ((byte)arrayOfByte1[(n >> 2 & 0x3F)]);
          paramInt2 = i1 + 1;
          d = paramInt2;
          paramArrayOfByte[i1] = ((byte)arrayOfByte1[(n << 4 & 0x3F)]);
          if (arrayOfByte1 == k)
          {
            i1 = paramInt2 + 1;
            d = i1;
    ...
    else
    {
      ...
      while (i1 < paramInt2)
      {
        ...
        if (h == 0)
        {
          ...
          int i4 = i3 + 1;
          d = i4;
          arrayOfByte1[i3] = ((byte)arrayOfByte2[(n >> 6 & 0x3F)]);
          i2 = i4 + 1;
          d = i2;
          arrayOfByte1[i4] = ((byte)arrayOfByte2[(n & 0x3F)]);
          n = g + 4;
          g = n;
          i3 = d;
          if ((i3 > 0) && (i3 <= n))
...
/* Location:
 * Qualified Name:     base.k.a.a.a.b.b
