  ...
  implements Ingestion
{
  ...
  public ServiceCall sendAsync(String paramString, UUID paramUUID, LogContainer paramLogContainer, ServiceCallback paramServiceCallback)
  {
    ...
    paramString = new AppCenterIngestion.IngestionCallTemplate(mLogSerializer, paramLogContainer);
...
/* Location:
 * Qualified Name:     base.com.microsoft.appcenter.ingestion.AppCenterIngestion
