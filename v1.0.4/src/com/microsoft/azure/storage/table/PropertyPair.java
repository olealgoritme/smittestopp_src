...
public final class PropertyPair
{
  ...
  public static HashMap<String, PropertyPair> generatePropertyPairsHelper(Class<?> paramClass)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localObject3 = (PropertyPair)((Map.Entry)localObject1).getValue();
      boolean bool;
      ...
      isEncrypted = bool;
      if (!((PropertyPair)((Map.Entry)localObject1).getValue()).shouldProcess()) {
        localArrayList.add(((Map.Entry)localObject1).getKey());
      } else if (!Utility.isNullOrEmpty(getValueeffectiveName)) {
        paramClass.add(((Map.Entry)localObject1).getKey());
      } else {
    ...
    localObject1 = paramClass.iterator();
    while (((Iterator)localObject1).hasNext())
    {
      paramClass = (String)((Iterator)localObject1).next();
      localObject2 = (PropertyPair)localHashMap.get(paramClass);
      localHashMap.remove(paramClass);
      localHashMap.put(effectiveName, localObject2);
    }
    return localHashMap;
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.table.PropertyPair
