...
public final class x
{
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    for (a locala = b(m); locala != null; locala = i) {
      if ((b == 129) && (h == m) && (f == paramInt) && (e.equals(paramString))) {
        return a;
      }
    }
    return a(new a(k, 129, paramString, paramInt, m));
  }
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    for (a locala = b(n); locala != null; locala = i) {
    ...
    m = g;
    g = (m + 1);
    paramString1 = new a(m, 12, paramString1, paramString2, n);
    b(paramString1);
    return a;
  }
  ...
  public final int a(a parama)
  {
    ...
    {
      arrayOfa2 = new a[arrayOfa1.length * 2];
  ...
  public final w a(int paramInt1, int paramInt2)
  {
    ...
    int n = g;
    g = (n + 1);
    localObject = new a(n, paramInt1, paramInt2, m);
    b((a)localObject);
    return (w)localObject;
  }
  ...
  public final w a(int paramInt, long paramLong)
  {
    ...
    localObject = a;
    int i4 = i3 + 1;
    localObject[i3] = ((byte)(byte)(n >>> 24));
    i3 = i4 + 1;
    localObject[i4] = ((byte)(byte)(n >>> 16));
    i4 = i3 + 1;
    localObject[i3] = ((byte)(byte)(n >>> 8));
    i3 = i4 + 1;
    localObject[i4] = ((byte)(byte)n);
    n = i3 + 1;
    localObject[i3] = ((byte)(byte)(m >>> 24));
    i4 = n + 1;
    localObject[n] = ((byte)(byte)(m >>> 16));
    n = i4 + 1;
    localObject[i4] = ((byte)(byte)(m >>> 8));
    localObject[n] = ((byte)(byte)m);
    b = (n + 1);
    g += 2;
    localObject = new a(i2, paramInt, paramLong, i1);
    b((a)localObject);
    return (w)localObject;
  }
  ...
  public final w a(int paramInt, String paramString)
  {
    ...
    int n = g;
    g = (n + 1);
    paramString = new a(n, paramInt, paramString, m);
    b(paramString);
    return paramString;
  }
  ...
  public final w a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    int n = g;
    g = (n + 1);
    paramString1 = new a(n, paramInt1, null, paramString1, paramString2, paramInt2, m);
    b(paramString1);
    return paramString1;
  }
  ...
  public w a(int paramInt, String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    int n = g;
    g = (n + 1);
    paramString1 = new a(n, 15, paramString1, paramString2, paramString3, paramInt, m);
    b(paramString1);
    return paramString1;
  }
  ...
  public w a(o paramo, Object... paramVarArgs)
  {
    ...
    n = i;
    i = (n + 1);
    paramo = new a(n, 64, i1, m);
    b(paramo);
    return paramo;
  }
  
  public final a a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    int n = g;
    g = (n + 1);
    paramString1 = new a(n, paramInt, paramString1, paramString2, paramString3, 0L, m);
    b(paramString1);
    return paramString1;
  }
  ...
  public int c(String paramString)
  {
    ...
    if (n <= 65535)
    {
      ...
      i1 = g;
      g = (i1 + 1);
      paramString = new a(i1, 1, paramString, m);
      b(paramString);
      return a;
    }
  ...
  public int d(String paramString)
  {
    ...
    return a(new a(k, 128, paramString, m));
  }
    ...
    extends w
  {
    ...
    {
      super(paramInt2, null, null, null, paramLong);
      h = paramInt3;
    }
    
    public a(int paramInt1, int paramInt2, String paramString, int paramInt3)
    {
      super(paramInt2, null, null, paramString, 0L);
      h = paramInt3;
    }
    
    public a(int paramInt1, int paramInt2, String paramString, long paramLong, int paramInt3)
    {
      super(paramInt2, null, null, paramString, paramLong);
      h = paramInt3;
    }
    
    public a(int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3)
    {
      super(paramInt2, null, paramString1, paramString2, 0L);
      h = paramInt3;
    }
    
    public a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, long paramLong, int paramInt3)
    {
      super(paramInt2, paramString1, paramString2, paramString3, paramLong);
      h = paramInt3;
    }
  }
}
