...
public final class h
  extends h.k.b.h
  implements p<CharSequence, Integer, h.c<? extends Integer, ? extends Integer>>
{
  ...
  public Object a(Object paramObject1, Object paramObject2)
  {
    ...
    if (localCharSequence != null)
    {
      ...
      if ((!bool) && (localList.size() == 1))
      {
        ...
        if (j != 0)
        {
          if (j == 1)
          {
            ...
            if (j >= 0)
            {
              paramObject1 = new h.c(Integer.valueOf(j), paramObject1);
              break label455;
            }
          }
          else
      ...
      else
      {
        ...
        paramObject1 = new h.l.c(j, localCharSequence.length());
        int k;
        Object localObject1;
        Object localObject2;
      ...
      label455:
      if (paramObject1 != null) {
        paramObject2 = new h.c(x, Integer.valueOf(((String)y).length()));
      }
      return paramObject2;
    }
    h.k.b.g.a("$receiver");
