...
public final class c
{
  ...
  public static final l.f.e.c c = new l.f.e.c();
  ...
  public static final void a()
  {
    ...
    {
      str = localNoSuchMethodError.getMessage();
    ...
    catch (NoClassDefFoundError localNoClassDefFoundError)
    {
      ...
      int i = 0;
      if ((str != null) && ((str.contains("org/slf4j/impl/StaticLoggerBinder")) || (str.contains("org.slf4j.impl.StaticLoggerBinder")))) {
        i = 1;
      }
      if (i == 0) {
        break label184;
  ...
  public static void b(Set<URL> paramSet)
  {
    ...
    if (j != 0)
    {
      ...
      {
        paramSet = (URL)localIterator.next();
  ...
  public static void c()
  {
    synchronized (b)
    {
      ...
      if (localObject1 != null)
      {
        ...
        {
          localObject3 = (l.f.e.d)((Iterator)localObject1).next();
          y = a(x);
        }
        return;
      }
  ...
  public static void f()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (l.f.d.d)localIterator.next();
        l.f.e.d locald;
        String str;
        if (localObject != null)
        {
          ...
          if ((k == 0) && (((y instanceof l.f.e.b)) || ((locald.g()) && (!locald.g())))) {}
        }
        try
        {
        ...
        if (j == 0) {
          ...
          else if (!(a.y instanceof l.f.e.b))
          {
