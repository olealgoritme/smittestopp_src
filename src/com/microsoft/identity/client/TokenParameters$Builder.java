...
public abstract class TokenParameters$Builder<B extends Builder<B>>
{
  ...
  public B withResource(String paramString)
  {
    if (mScopes == null)
    {
      if (!StringUtil.isEmpty(paramString))
      {
        mScopes = new TokenParameters.Builder.1(this, paramString);
        return self();
      }
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.TokenParameters.Builder
