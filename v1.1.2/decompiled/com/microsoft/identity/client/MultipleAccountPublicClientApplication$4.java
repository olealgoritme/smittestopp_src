  ...
  implements CommandCallback<List<ICacheRecord>, BaseException>
{
  ...
  public void onTaskCompleted(List<ICacheRecord> paramList)
  {
    if ((paramList != null) && (paramList.size() != 0))
    {
      ...
      {
        IAccount localIAccount = (IAccount)((Iterator)localObject1).next();
        if (((PublicClientApplication.AccountMatcher)localObject2).matches(paramList, localIAccount))
        {
          val$callback.onTaskCompleted(localIAccount);
          return;
        }
      }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.MultipleAccountPublicClientApplication.4
