...
public final class StringUtil
{
  ...
  public static Pair<String, String> getTenantInfo(String paramString)
  {
    ...
    if ((2 == i) && (!StringExtensions.isNullOrBlank(paramString[0])) && (!StringExtensions.isNullOrBlank(paramString[1])))
    {
    ...
    return new Pair(localObject, paramString);
  }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.util.StringUtil
