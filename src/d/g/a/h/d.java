...
public class d
{
  ...
  public d()
  {
    ...
    d.a locala = d.a.FIXED;
    C = new d.a[] { locala, locala };
    D = null;
    E = 0;
    F = 0;
    G = 0.0F;
  ...
  public void a(int paramInt)
  {
    ...
    if ((C[0] == d.a.MATCH_CONSTRAINT) && (i.a(this, 0))) {
      i1 = 1;
    } else {
      i1 = 0;
    }
    if ((h != 4) && (h != 4)) {
      if ((C[0] != d.a.FIXED) && ((i1 == 0) || (Y != 8)))
      {
        if (i1 != 0)
        {
          i1 = i();
    ...
    if ((C[1] == d.a.MATCH_CONSTRAINT) && (i.a(this, 1))) {
      i1 = 1;
    } else {
      i1 = 0;
    }
    if ((h != 4) && (h != 4)) {
      if ((C[1] != d.a.FIXED) && ((i1 == 0) || (Y != 8)))
      {
        if (i1 != 0)
        {
          i1 = d();
  ...
  public void a(d.g.a.e parame)
  {
    ...
    {
      if ((localObject3 != null) && (C[0] == d.a.WRAP_CONTENT)) {
        bool1 = true;
      } else {
        bool1 = false;
      }
      localObject3 = D;
      if ((localObject3 != null) && (C[1] == d.a.WRAP_CONTENT)) {
        bool2 = true;
      } else {
        bool2 = false;
      }
    ...
    int i5;
    if (C[0] != d.a.MATCH_CONSTRAINT) {
      i5 = 1;
    } else {
      i5 = 0;
    }
    int i6;
    if (C[1] != d.a.MATCH_CONSTRAINT) {
      i6 = 1;
    } else {
      i6 = 0;
    }
    ...
    if ((f1 > 0.0F) && (Y != 8))
    {
      ...
      localObject4 = d.a.MATCH_CONSTRAINT;
      if ((localObject5 == localObject4) && (localObject3[1] == localObject4) && (i4 == 3) && (i2 == 3))
      {
        if (n == -1) {
          if ((i5 != 0) && (i6 == 0))
          {
      ...
      else
      {
        ...
        localObject4 = d.a.MATCH_CONSTRAINT;
        if ((localObject3 == localObject4) && (i4 == 3))
        {
          n = 0;
          i3 = (int)(o * F);
          i5 = i3;
          if (localObject5[1] != localObject4)
          {
            i4 = i3;
            i7 = i1;
            i5 = i2;
        ...
        else
        {
          ...
          if (C[1] == d.a.MATCH_CONSTRAINT)
          {
            ...
            if (i2 == 3)
            {
              ...
              i7 = (int)(o * E);
              localObject4 = C[0];
              localObject3 = d.a.MATCH_CONSTRAINT;
              i6 = i3;
              int i8 = i4;
              i1 = i6;
              i5 = i7;
    ...
    boolean bool5 = false;
    label1406:
    if ((C[0] == d.a.WRAP_CONTENT) && ((this instanceof e))) {
      bool6 = true;
    } else {
      bool6 = false;
    }
    ...
    if (a != 2)
    {
      ...
      a(parame, bool3, (g)localObject4, (g)localObject3, C[0], bool6, s, u, I, i1, R, q[0], V, bool5, bool4, i4, h, i, j, bool7);
    }
    localObject3 = localObject1;
    if (b == 2) {
      return;
    }
    if ((C[1] == d.a.WRAP_CONTENT) && ((this instanceof e))) {
      bool3 = true;
    } else {
      bool3 = false;
    }
    ...
    if (i1 > 0)
    {
      ...
      {
        localObject4 = parame;
        ((d.g.a.e)localObject4).a((g)localObject2, (g)localObject3, i1, 6);
        localObject1 = w.d;
    ...
    a(parame, bool1, (g)localObject4, (g)localObject3, C[1], bool3, t, v, J, i2, S, q[1], W, bool4, bool2, i5, k, l, m, bool5);
    if (i3 != 0)
    {
      localObject3 = this;
      if (n == 1) {
    ...
    if (z.b())
    {
      ...
      i3 = z.a();
      localObject4 = parame.a(((d)localObject3).a(c.c.LEFT));
      localObject2 = parame.a(((d)localObject3).a(c.c.TOP));
      localg3 = parame.a(((d)localObject3).a(c.c.RIGHT));
      ...
      localObject5 = parame.a(((d)localObject5).a(c.c.BOTTOM));
      b localb = parame.b();
      double d1 = f1;
      double d2 = Math.sin(d1);
      double d3 = i3;
      localb.b((g)localObject2, (g)localObject1, localg1, (g)localObject5, (float)(d2 * d3));
      parame.a(localb);
      localObject2 = parame.b();
      ((b)localObject2).b((g)localObject4, localg3, (g)localObject3, localg2, (float)(Math.cos(d1) * d3));
      parame.a((b)localObject2);
    }
  }
  
  public final void a(d.g.a.e parame, boolean paramBoolean1, g paramg1, g paramg2, d.a parama, boolean paramBoolean2, c paramc1, c paramc2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat1, boolean paramBoolean3, boolean paramBoolean4, int paramInt5, int paramInt6, int paramInt7, float paramFloat2, boolean paramBoolean5)
  {
    ...
    else
    {
      ...
      else if (i2 == 2)
      {
        ...
        {
          localObject1 = parame.a(D.a(c.c.LEFT));
          localObject2 = parame.a(D.a(c.c.RIGHT));
        }
        else
        {
          localObject1 = parame.a(D.a(c.c.TOP));
          localObject2 = parame.a(D.a(c.c.BOTTOM));
        }
        b localb = parame.b();
        localb.a(localg2, localg1, (g)localObject2, (g)localObject1, paramFloat2);
        parame.a(localb);
        paramInt5 = 0;
      }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(" x ");
    return e.a.a.a.a.a(localStringBuilder, U, ")");
  }
}

/* Location:
 * Qualified Name:     base.d.g.a.h.d
