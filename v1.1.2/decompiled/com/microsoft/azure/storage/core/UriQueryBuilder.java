...
public final class UriQueryBuilder
{
  ...
  public URI addToURI(URI paramURI)
  {
    ...
    Iterator localIterator = PathUtility.parseQueryString(str1).entrySet().iterator();
    for (;;)
    {
      ...
      String[] arrayOfString = (String[])((Map.Entry)localObject).getValue();
      int j = arrayOfString.length;
      while (i < j)
      {
        String str4 = arrayOfString[i];
        insertKeyValue((String)((Map.Entry)localObject).getKey(), str4);
        i++;
      }
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.core.UriQueryBuilder
