...
public final class Base64
{
        ...
        if ((k >= 0) && (m >= 0) && (n != -1) && (i1 != -1))
        {
          ...
          for (;;)
          {
            ...
            if (i1 == -2)
            {
              n = m & 0xFFFFC0;
              m = j + 1;
              arrayOfByte[j] = ((byte)(byte)(n >> 16 & 0xFF));
              j = m + 1;
              arrayOfByte[m] = ((byte)(byte)(n >> 8 & 0xFF));
            }
            else
            {
              i1 = j + 1;
  ...
  public static Byte[] decodeAsByteObjectArray(String paramString)
  {
    ...
    while (i < paramString.length())
    {
      ...
      if ((k >= 0) && (m >= 0) && (n != -1) && (i1 != -1))
      {
        k = (k << 18) + (m << 12) + ((n & 0xFF) << 6) + (i1 & 0xFF);
        if (n == -2)
        {
          i1 = j + 1;
          arrayOfByte[j] = Byte.valueOf((byte)((k & 0xFFF000) >> 16 & 0xFF));
          j = i1;
        }
        for (;;)
        {
          ...
          if (i1 == -2)
          {
            k &= 0xFFFFC0;
            i1 = j + 1;
            arrayOfByte[j] = Byte.valueOf((byte)(k >> 16 & 0xFF));
            j = i1 + 1;
            arrayOfByte[i1] = Byte.valueOf((byte)(k >> 8 & 0xFF));
          }
          else
          {
            n = j + 1;
            arrayOfByte[j] = Byte.valueOf((byte)(k >> 16 & 0xFF));
            i1 = n + 1;
            arrayOfByte[n] = Byte.valueOf((byte)(k >> 8 & 0xFF));
            j = i1 + 1;
            arrayOfByte[i1] = Byte.valueOf((byte)(k & 0xFF));
          }
        }
        i += 4;
      }
  ...
  public static String encode(byte[] paramArrayOfByte)
  {
    ...
    while (j < paramArrayOfByte.length)
    {
      ...
      for (k = paramArrayOfByte[(j + 2)] & 0xFF;; k = (paramArrayOfByte[(j + 1)] & 0xFF) << 8)
      {
        k = m + k;
        break;
        if (i == 1)
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.core.Base64
