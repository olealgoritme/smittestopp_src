    ...
    if (paramArrayOfByte != null)
    {
      ...
      if (paramArrayOfByte.length % 4 == 0)
      {
        ...
        if (k == 3)
        {
          ...
          n = m + 1;
          i1 = byteToBase64(paramArrayOfByte[m]);
          i2 = byteToBase64(paramArrayOfByte[n]);
          m = i + 1;
          arrayOfByte[i] = ((byte)(byte)(j << 2 | i1 >> 4));
          arrayOfByte[m] = ((byte)(byte)(i1 << 4 | i2 >> 2));
        }
        if (k == 2)
        {
          i = byteToBase64(paramArrayOfByte[n]);
          arrayOfByte[m] = ((byte)(byte)(byteToBase64(paramArrayOfByte[(n + 1)]) >> 4 | i << 2));
        }
        return arrayOfByte;
      }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.proton.transport.ws.impl.Base64
