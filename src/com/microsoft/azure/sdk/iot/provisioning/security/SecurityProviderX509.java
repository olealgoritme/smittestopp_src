  ...
  extends SecurityProvider
{
  ...
  private KeyManager getDefaultX509KeyManager(KeyStore paramKeyStore, String paramString)
  {
    ...
    for (paramString : localKeyManagerFactory.getKeyManagers()) {
      if ((paramString instanceof X509KeyManager)) {
        return paramString;
      }
    }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.provisioning.security.SecurityProviderX509
