  ...
  implements ICacheKeyValueDelegate
{
  ...
  private String generateCacheValueInternal(Object paramObject)
  {
    ...
    {
      paramObject = (AccountCredentialBase)paramObject;
      Iterator localIterator = ((AccountCredentialBase)paramObject).getAdditionalFields().keySet().iterator();
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        localm.a(str, (j)((AccountCredentialBase)paramObject).getAdditionalFields().get(str));
      }
    }
  ...
  public static List<Field> getSerializedNameAnnotatedFields(List<Field> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      paramList = (Field)localIterator.next();
      if ((c)paramList.getAnnotation(c.class) != null) {
  ...
  public <T extends AccountCredentialBase> T fromCacheValue(String paramString, Class<? extends AccountCredentialBase> paramClass)
  {
    try
    {
      ...
      if (!StringExtensions.isNullOrBlank(paramString))
      {
        ...
        localHashMap.<init>();
        paramClass = a.keySet().iterator();
        while (paramClass.hasNext())
        {
          localObject2 = (String)paramClass.next();
          localHashMap.put(localObject2, paramString.a((String)localObject2));
        }
        ((AccountCredentialBase)localObject1).setAdditionalFields(localHashMap);
      }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.cache.CacheKeyValueDelegate
