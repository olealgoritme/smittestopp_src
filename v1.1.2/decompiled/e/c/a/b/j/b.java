  ...
  extends g0
{
  ...
  public b(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    P = paramContext.getInt(R.styleable.ForegroundLinearLayout_android_foregroundGravity, P);
    ...
    Q = paramContext.getBoolean(R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
