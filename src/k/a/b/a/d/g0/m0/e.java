    ...
    if (localObject1 != null)
    {
      ...
      if (a == null)
      {
        if (f.b.isLoggable(Level.FINE))
        {
          ...
          ((StringBuilder)localObject3).append("lazily creating new SSLContext using domain ");
          ((StringBuilder)localObject3).append(this);
          ((Logger)localObject4).fine(((StringBuilder)localObject3).toString());
        }
        localObject5 = "unused-passphrase".toCharArray();
        try
        {
          localObject4 = SSLContext.getInstance("TLS");
          localObject3 = ((f)localObject1).a(this, (char[])localObject5);
          localObject6 = KeyManagerFactory.getInstance(KeyManagerFactory.getDefaultAlgorithm());
          ((KeyManagerFactory)localObject6).init((KeyStore)localObject3, (char[])localObject5);
          if (a() == a0.b.ANONYMOUS_PEER)
          {
            localObject3 = new TrustManager[1];
            localObject5 = new k/a/b/a/d/g0/m0/f$b;
          ...
          ((SSLContext)localObject4).init(((KeyManagerFactory)localObject6).getKeyManagers(), (TrustManager[])localObject3, null);
          a = ((SSLContext)localObject4);
        }
      ...
      if (f.b.isLoggable(Level.FINE))
      {
        ...
        ((Logger)localObject1).log((Level)localObject4, ((StringBuilder)localObject3).toString());
      }
      ...
      {
        localObject2 = f.b;
        localObject3 = e.a.a.a.a.a("Created SSL engine: ");
        ...
        ((Logger)localObject2).fine(((StringBuilder)localObject3).toString());
      }
...
/* Location:
 * Qualified Name:     base.k.a.b.a.d.g0.m0.e
