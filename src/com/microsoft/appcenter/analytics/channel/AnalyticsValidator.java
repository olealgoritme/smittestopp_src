  ...
  public static void validateProperties(List<TypedProperty> paramList)
  {
    ...
    while (localListIterator.hasNext())
    {
      ...
      else if ((paramList != null) && (!paramList.isEmpty()))
      {
        ...
        {
          localObject = (StringTypedProperty)localObject;
          String str = ((StringTypedProperty)localObject).getValue();
          if (str == null)
          {
          ...
          if (str.length() > 125)
          {
            ...
            {
              localObject = new StringTypedProperty();
              ((TypedProperty)localObject).setName(paramList);
              ((StringTypedProperty)localObject).setValue(str);
              localListIterator.set(localObject);
            }
            else
            {
...
/* Location:
 * Qualified Name:     base.com.microsoft.appcenter.analytics.channel.AnalyticsValidator
