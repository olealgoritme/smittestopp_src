...
public class HttpsRequest
{
  ...
  public HttpsResponse send()
  {
    ...
    if (localObject1 != null)
    {
      ...
      Object localObject2 = headers.keySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject1 = (String)((Iterator)localObject2).next();
        Iterator localIterator = ((List)headers.get(localObject1)).iterator();
        while (localIterator.hasNext()) {
          localHttpsConnection.setRequestHeader((String)localObject1, (String)localIterator.next());
        }
      }
      ...
      localObject2 = localHttpsConnection.getResponseHeaders();
      if (i == 200) {
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.transport.https.HttpsRequest
