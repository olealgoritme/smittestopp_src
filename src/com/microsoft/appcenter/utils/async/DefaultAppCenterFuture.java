  ...
  public void complete(T paramT)
  {
    try
    {
      if (!isDone())
      {
        ...
        if (mConsumers != null)
        {
          DefaultAppCenterFuture.2 local2 = new com/microsoft/appcenter/utils/async/DefaultAppCenterFuture$2;
  ...
  public void thenAccept(AppCenterConsumer<T> paramAppCenterConsumer)
  {
    try
    {
      ...
      if (isDone())
      {
        ...
        ((DefaultAppCenterFuture.1)localObject).<init>(this, paramAppCenterConsumer);
...
/* Location:
 * Qualified Name:     base.com.microsoft.appcenter.utils.async.DefaultAppCenterFuture
