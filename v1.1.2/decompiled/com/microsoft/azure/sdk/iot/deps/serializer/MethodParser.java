...
public class MethodParser
{
  ...
  private j jsonizePayload(Object paramObject)
  {
    ...
    if ((paramObject instanceof Map))
    {
      ...
      while (((Iterator)paramObject).hasNext())
      {
        ...
        ((m)localObject1).a((String)((Map.Entry)localObject2).getKey(), jsonizePayload(((Map.Entry)localObject2).getValue()));
      }
        ...
        try
        {
          ...
          if ((!(paramString instanceof p)) && (!(paramString instanceof g)))
          {
            if ((paramString instanceof m))
            {
              ...
              localObject = paramString.a("status");
              j localj = paramString.a("methodName");
              if (localj == null)
              {
                if (localObject == null)
                {
                ...
                else
                {
                  ...
                  if ((localObject instanceof p)) {
                    status = Integer.valueOf(((j)localObject).a());
                  }
  ...
  public j toJsonElement()
  {
    ...
    if (localObject == Operation.invoke)
    {
      localObject = name;
    ...
    if (localObject == Operation.response)
    {
      localObject = new m();
    ...
    if (localObject == Operation.payload) {
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.deps.serializer.MethodParser
