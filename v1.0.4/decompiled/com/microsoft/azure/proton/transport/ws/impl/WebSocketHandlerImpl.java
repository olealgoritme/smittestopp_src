...
{
  public WebSocketUpgrade webSocketUpgrade = null;
  ...
  public String createUpgradeRequest(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, Map<String, String> paramMap)
  {
    paramString1 = createWebSocketUpgrade(paramString1, paramString2, paramString3, paramInt, paramString4, paramMap);
    webSocketUpgrade = paramString1;
    return paramString1.createUpgradeRequest();
  }
  
  public WebSocketUpgrade createWebSocketUpgrade(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, Map<String, String> paramMap)
  {
    return new WebSocketUpgrade(paramString1, paramString2, paramString3, paramInt, paramString4, paramMap);
  }
  ...
  public Boolean validateUpgradeReply(ByteBuffer paramByteBuffer)
  {
    ...
    if (webSocketUpgrade != null)
    {
      ...
      if (paramByteBuffer.remaining() > 0)
      {
        ...
        paramByteBuffer = webSocketUpgrade.validateUpgradeReply((byte[])localObject);
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.proton.transport.ws.impl.WebSocketHandlerImpl
