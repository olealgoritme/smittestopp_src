...
public class PartAUtils
{
  ...
  public static void addPartAFromLog(Log paramLog, CommonSchemaLog paramCommonSchemaLog, String paramString)
  {
    ...
    paramString = paramCommonSchemaLog.getExt().getUser();
    localObject = localDevice.getLocale();
    paramLog = "-";
    paramString.setLocale(((String)localObject).replace("_", "-"));
    paramCommonSchemaLog.getExt().setOs(new OsExtension());
    paramCommonSchemaLog.getExt().getOs().setName(localDevice.getOsName());
    paramString = paramCommonSchemaLog.getExt().getOs();
    localObject = new StringBuilder();
    ((StringBuilder)localObject).append(localDevice.getOsVersion());
    ((StringBuilder)localObject).append("-");
    ((StringBuilder)localObject).append(localDevice.getOsBuild());
    ((StringBuilder)localObject).append("-");
    ((StringBuilder)localObject).append(localDevice.getOsApiLevel());
    paramString.setVer(((StringBuilder)localObject).toString());
...
/* Location:
 * Qualified Name:     com.microsoft.appcenter.ingestion.models.one.PartAUtils
