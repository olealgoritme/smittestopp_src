  ...
  extends StorageRequest<CloudFileClient, CloudFileShare, FileSharePermissions>
{
  ...
  public FileSharePermissions postProcessResponse(HttpURLConnection paramHttpURLConnection, CloudFileShare paramCloudFileShare, CloudFileClient paramCloudFileClient, OperationContext paramOperationContext, FileSharePermissions paramFileSharePermissions)
  {
    ...
    paramCloudFileShare = paramHttpURLConnection.keySet().iterator();
    while (paramCloudFileShare.hasNext())
    {
      paramCloudFileClient = (String)paramCloudFileShare.next();
      paramFileSharePermissions.getSharedAccessPolicies().put(paramCloudFileClient, paramHttpURLConnection.get(paramCloudFileClient));
    }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.file.CloudFileShare.4
