  ...
  implements ITelemetryAdapter<List<Map<String, String>>>
{
  ...
  private Map<String, String> applyAggregationRule(Map<String, String> paramMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((!StringUtil.isEmpty((String)paramMap.getValue())) && (!TelemetryAggregationRules.getInstance().isRedundant((String)paramMap.getKey()))) {
        localHashMap.put(paramMap.getKey(), paramMap.getValue());
      }
    }
    return localHashMap;
  }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.telemetry.adapter.TelemetryAggregationAdapter
