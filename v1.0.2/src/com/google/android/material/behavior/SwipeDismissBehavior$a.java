  ...
  extends a.c
{
  ...
  public void a(View paramView, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        j = paramView.getLeft();
        m = a;
        k = Math.round(paramView.getWidth() * c.f);
      } while (Math.abs(j - m) < k);
    }
    if (k != 0)
    {
      j = paramView.getLeft();
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (f3 <= f1) {
      ...
      paramView.setAlpha(SwipeDismissBehavior.a(0.0F, 1.0F - (f3 - f1) / (f2 - f1), 1.0F));
    }
  }
...
/* Location:
 * Qualified Name:     base.com.google.android.material.behavior.SwipeDismissBehavior.a
