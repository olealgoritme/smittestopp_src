        ...
        if (validateBlobMd5)
        {
          ...
          if (currentAbsoluteReadPosition == streamLength + blobRangeOffset)
          {
            ...
            if (!str.equals(retrievedContentMD5Value))
            {
              ...
              paramArrayOfByte.<init>("InvalidMd5", String.format("Blob data corrupted (integrity check failed), Expected value is %s, retrieved %s", new Object[] { retrievedContentMD5Value, str }), 306, null, null);
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.BlobInputStream
