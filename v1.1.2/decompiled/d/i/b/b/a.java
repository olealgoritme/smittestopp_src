    ...
    if (paramInt == 2)
    {
      ...
      if (paramInt != 0)
      {
        if (paramInt == 1)
        {
          ...
          {
            localObject = s.a(paramResources, paramTheme, localAttributeSet, R.styleable.GradientColor);
            float f1 = s.a((TypedArray)localObject, localXmlResourceParser, "startX", R.styleable.GradientColor_android_startX, 0.0F);
            float f2 = s.a((TypedArray)localObject, localXmlResourceParser, "startY", R.styleable.GradientColor_android_startY, 0.0F);
            float f3 = s.a((TypedArray)localObject, localXmlResourceParser, "endX", R.styleable.GradientColor_android_endX, 0.0F);
            float f4 = s.a((TypedArray)localObject, localXmlResourceParser, "endY", R.styleable.GradientColor_android_endY, 0.0F);
            float f5 = s.a((TypedArray)localObject, localXmlResourceParser, "centerX", R.styleable.GradientColor_android_centerX, 0.0F);
            float f6 = s.a((TypedArray)localObject, localXmlResourceParser, "centerY", R.styleable.GradientColor_android_centerY, 0.0F);
            int j = s.b((TypedArray)localObject, localXmlResourceParser, "type", R.styleable.GradientColor_android_type, 0);
            int k = s.a((TypedArray)localObject, localXmlResourceParser, "startColor", R.styleable.GradientColor_android_startColor, 0);
            boolean bool1 = s.a(localXmlResourceParser, "centerColor");
            int m = s.a((TypedArray)localObject, localXmlResourceParser, "centerColor", R.styleable.GradientColor_android_centerColor, 0);
            i = s.a((TypedArray)localObject, localXmlResourceParser, "endColor", R.styleable.GradientColor_android_endColor, 0);
            paramInt = s.b((TypedArray)localObject, localXmlResourceParser, "tileMode", R.styleable.GradientColor_android_tileMode, 0);
            float f7 = s.a((TypedArray)localObject, localXmlResourceParser, "gradientRadius", R.styleable.GradientColor_android_gradientRadius, 0.0F);
            ...
            for (;;)
            {
              ...
              if (i1 == 2)
              {
                if (i2 <= n)
                {
                  ...
                  localObject = s.a((Resources)localObject, paramTheme, localAttributeSet, R.styleable.GradientColorItem);
            ...
            if (paramResources == null) {
              ...
              {
                if (bool1) {
                  paramResources = new f(k, m, i);
                } else {
                  paramResources = new f(k, i);
                }
              }
            }
            if (j != 1)
      ...
      paramResources = s.a(paramResources, localXmlResourceParser, localAttributeSet, paramTheme);
