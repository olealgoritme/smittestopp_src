  ...
  implements Runnable
{
  ...
  public void run()
  {
    CommandCallback localCommandCallback = this$0.getCommandCallback(val$acquireTokenSilentParameters.getCallback(), val$acquireTokenSilentParameters);
    try
    {
    ...
    {
      BaseException localBaseException = ExceptionAdapter.baseExceptionFromException(localException);
      new Handler(Looper.getMainLooper()).post(new PublicClientApplication.6.1(this, localCommandCallback, localBaseException));
    }
  }
}

/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.PublicClientApplication.6
