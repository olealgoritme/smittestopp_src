...
import k.a.b.a.b.h;
import k.a.b.a.b.n.a;
import k.a.b.a.b.n.c;
  ...
  implements f0
{
  ...
  public int pending()
  {
    ...
    if (!K) {
      ...
      {
        localObject3 = new k.a.b.a.b.n.m();
        localObject2 = J;
        localObject1 = "";
        if (localObject2 != null)
        {
          ...
          ((k.a.b.a.b.n.m)localObject3).a((String)localObject1);
          b = J.W;
          i = null;
          h = null;
          j = null;
      ...
      for (localObject1 = J; localObject1 != null; localObject1 = C) {
        if ((localObject1 instanceof y))
        {
          ...
          if ((x != g.UNINITIALIZED) && (!t))
          {
            ...
            j = -1;
            label542:
            localObject3 = new k.a.b.a.b.n.b();
            if (y != g.UNINITIALIZED) {
              a = k.a.b.a.b.j.a((short)d);
            }
            ((k0)localObject2).d();
            e = e;
            localObject4 = g;
    ...
    if ((localObject1 != null) && (K) && (!L)) {
      ...
      for (localObject1 = J; localObject1 != null; localObject1 = C) {
        if ((localObject1 instanceof m))
        {
          ...
          k0 localk0 = locala0.a(H);
          if ((x != g.UNINITIALIZED) && (!i) && (localk0.a()))
          {
            if (y == g.ACTIVE)
            {
              if (a != null) {
    ...
    if ((localObject1 != null) && (K) && (!L))
    {
      for (localObject1 = J; localObject1 != null; localObject1 = C) {
        if ((localObject1 instanceof q))
        {
          ...
          localObject3 = locala0.a((m)localObject4);
          localObject2 = locala0.a(H);
          if ((x == g.ACTIVE) && (((k0)localObject2).a()))
          {
            j = b0;
            b0 = 0;
            ...
            {
              e = h.a(e.x + j);
              locala0.a((k0)localObject2, (e0)localObject3);
            }
          }
        }
      }
      ...
      for (localObject1 = J; localObject1 != null; localObject1 = C) {
        if ((localObject1 instanceof x))
        {
          ...
          if ((X) && (T > 0))
          {
            ...
            T = 0;
            locala0.a((k0)localObject2, (e0)localObject4);
          }
        }
      }
    }
    ...
    if ((localObject1 != null) && (K))
    {
      ...
      while (localObject1 != null) {
        if ((localObject1 instanceof m))
        {
          ...
          localObject4 = locala0.a((m)localObject3);
          localObject2 = locala0.a(H);
          if (x == g.CLOSED)
          {
            if (a != null) {
            ...
            {
              if (((localObject3 instanceof x)) && (Q > 0) && (!h) && (!s) && (!Y))
              {
                localObject1 = C;
                continue;
              }
              ...
              a = null;
              l.remove(localObject5);
              localObject4 = new k.a.b.a.b.n.f();
              if (localObject5 != null)
              {
                a = ((h)localObject5);
                b = true;
    ...
    if ((localObject1 != null) && (K))
    {
      ...
      while (localObject1 != null) {
        if ((localObject1 instanceof y))
        {
          ...
          {
            localObject3 = L;
            if ((((k0)localObject3).a()) && (!L))
            {
              if (locala0.b((y)localObject2))
              {
                localObject1 = C;
                continue;
              }
...
/* Location:
 * Qualified Name:     base.k.a.b.a.d.g0.g0
