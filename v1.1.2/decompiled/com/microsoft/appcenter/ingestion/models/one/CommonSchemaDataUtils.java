    ...
    try
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject4 = localMetadataExtension.getMetadata();
          Object localObject5;
          for (int j = 0; j < i; j++)
          {
            String str = localObject3[j];
            localObject5 = ((JSONObject)localObject1).optJSONObject(str);
            if (localObject5 == null)
            {
              if (((JSONObject)localObject1).has(str))
              {
                ...
                ((StringBuilder)localObject5).append("Property key '");
                ((StringBuilder)localObject5).append(str);
                ((StringBuilder)localObject5).append("' already has a value, the old value will be overridden.");
                AppCenterLog.warn("AppCenter", ((StringBuilder)localObject5).toString());
              }
              localObject5 = new org/json/JSONObject;
              ((JSONObject)localObject5).<init>();
              ((JSONObject)localObject1).put(str, localObject5);
            ...
            localObject4 = addIntermediateMetadata((JSONObject)localObject4, str);
          }
          ...
          addLeafMetadata(localInteger, (JSONObject)localObject4, (String)localObject3);
        }
      ...
      Object localObject4 = paramList.optString("baseType", null);
      JSONObject localJSONObject = paramList.optJSONObject("baseData");
      if ((localObject4 == null) && (localJSONObject != null))
      {
...
/* Location:
 * Qualified Name:     com.microsoft.appcenter.ingestion.models.one.CommonSchemaDataUtils
