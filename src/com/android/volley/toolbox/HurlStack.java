  ...
  extends BaseHttpStack
{
  ...
  public final HurlStack.UrlRewriter mUrlRewriter;
  ...
  public HttpResponse executeRequest(Request<?> paramRequest, Map<String, String> paramMap)
  {
    ...
    {
      paramMap = ((HurlStack.UrlRewriter)localObject2).rewriteUrl((String)localObject1);
      if (paramMap == null) {
...
/* Location:
 * Qualified Name:     base.com.android.volley.toolbox.HurlStack
