...
public class MqttDeviceMethod
  extends Mqtt
{
  public static final k.f.b log = c.a(MqttDeviceMethod.class);
  ...
  public IotHubTransportMessage receive()
  {
    ...
    try
    {
      ...
      {
        String str = (String)((k.a.a.b.e.b)localObject3).getKey();
        ...
        if (str != null)
        {
          ...
          if (str.length() > 0)
          {
            localObject3 = (byte[])((k.a.a.b.e.b)localObject3).getValue();
            localObject4 = localObject2;
            if (str.length() > 16)
            {
              localObject4 = localObject2;
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.transport.mqtt.MqttDeviceMethod
