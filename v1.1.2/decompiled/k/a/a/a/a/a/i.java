...
public final class i
{
    ...
    try
    {
      while (i < paramArrayOfByte.length)
      {
        ...
        if (m != 22) {
          ...
          {
            m = paramArrayOfByte[(i1 + 1)];
            i = paramArrayOfByte[i1];
            arrayOfByte = a(paramArrayOfByte, i1 + 2, n - 2);
            ...
            ((SparseArray)localObject5).put(((m & 0xFF) << 8) + (0xFF & i), arrayOfByte);
        ...
        ParcelUuid localParcelUuid = e.a(a(paramArrayOfByte, i1, i));
        ...
        ((Map)localObject5).put(localParcelUuid, arrayOfByte);
  ...
  {
    StringBuilder localStringBuilder = a.a("ScanRecord [advertiseFlags=");
    localStringBuilder.append(a);
    localStringBuilder.append(", serviceUuids=");
    localStringBuilder.append(b);
    localStringBuilder.append(", manufacturerSpecificData=");
    ...
    else
    {
      ...
      {
        localObject2 = ((Map.Entry)localIterator.next()).getKey();
        ((StringBuilder)localObject1).append(localObject2);
        ((StringBuilder)localObject1).append("=");
        ((StringBuilder)localObject1).append(Arrays.toString((byte[])((Map)localObject3).get(localObject2)));
