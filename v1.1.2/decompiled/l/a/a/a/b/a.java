      ...
      if (paramInt2 != 0) {
        if (paramInt2 != 1)
        {
          ...
          else
          {
            ...
            paramInt2 = n + 1;
            d = paramInt2;
            paramArrayOfByte[n] = ((byte)arrayOfByte1[((int)(l1 >> 6) & 0x1F)]);
            i1 = paramInt2 + 1;
            d = i1;
            paramArrayOfByte[paramInt2] = ((byte)arrayOfByte1[((int)(l1 >> 1) & 0x1F)]);
            n = i1 + 1;
            d = n;
            paramArrayOfByte[i1] = ((byte)arrayOfByte1[((int)(l1 << 4) & 0x1F)]);
            i1 = n + 1;
            d = i1;
            paramInt2 = a;
    ...
    else
    {
      ...
      while (n < paramInt2)
      {
        ...
        if (h == 0)
        {
          ...
          d = i2;
          byte[] arrayOfByte2 = h;
          arrayOfByte1[i1] = ((byte)arrayOfByte2[((int)(l1 >> 35) & 0x1F)]);
          i1 = i2 + 1;
          d = i1;
          arrayOfByte1[i2] = ((byte)arrayOfByte2[((int)(l1 >> 30) & 0x1F)]);
          i2 = i1 + 1;
          d = i2;
          arrayOfByte1[i1] = ((byte)arrayOfByte2[((int)(l1 >> 25) & 0x1F)]);
          i1 = i2 + 1;
          d = i1;
          arrayOfByte1[i2] = ((byte)arrayOfByte2[((int)(l1 >> 20) & 0x1F)]);
          i2 = i1 + 1;
          d = i2;
          arrayOfByte1[i1] = ((byte)arrayOfByte2[((int)(l1 >> 15) & 0x1F)]);
          i1 = i2 + 1;
          d = i1;
          arrayOfByte1[i2] = ((byte)arrayOfByte2[((int)(l1 >> 10) & 0x1F)]);
          i2 = i1 + 1;
          d = i2;
          arrayOfByte1[i1] = ((byte)arrayOfByte2[((int)(l1 >> 5) & 0x1F)]);
          i1 = i2 + 1;
          d = i1;
