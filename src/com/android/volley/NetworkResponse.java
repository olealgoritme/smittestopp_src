...
public class NetworkResponse
{
  ...
  public NetworkResponse(int paramInt, byte[] paramArrayOfByte, Map<String, String> paramMap, List<Header> paramList, boolean paramBoolean, long paramLong)
  {
    statusCode = paramInt;
...
/* Location:
 * Qualified Name:     base.com.android.volley.NetworkResponse
