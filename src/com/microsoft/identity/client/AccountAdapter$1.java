...
{
  private boolean hasNoCorrespondingHomeAccount(ICacheRecord paramICacheRecord, List<ICacheRecord> paramList)
  {
    paramICacheRecord = paramICacheRecord.getAccount().getHomeAccountId();
    return new AccountAdapter.1.1(this, paramList).contains(paramICacheRecord) ^ true;
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.AccountAdapter.1
