  ...
  implements c<e>
{
  ...
  public static boolean a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    i = Math.min(paramArrayOfByte1.length, paramArrayOfByte2.length) - 1;
    for (j = 1; j < i; j++) {
  ...
  public boolean a(t paramt)
  {
    ...
    paramt = (f1)h();
    localObject = (f1)((x)localObject).h();
    for (int j = 0; j < i; j++)
    {
      t localt1 = x[j].b();
      t localt2 = x[j].b();
      if ((localt1 != localt2) && (!localt1.a(localt2))) {
        return false;
      }
    }
    return true;
