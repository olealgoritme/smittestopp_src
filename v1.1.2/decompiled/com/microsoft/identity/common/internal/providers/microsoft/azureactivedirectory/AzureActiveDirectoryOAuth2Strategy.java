  ...
  extends OAuth2Strategy<AzureActiveDirectoryAccessToken, AzureActiveDirectoryAccount, AzureActiveDirectoryAuthorizationRequest, AzureActiveDirectoryAuthorizationRequest.Builder, AuthorizationStrategy, AzureActiveDirectoryOAuth2Configuration, OAuth2StrategyParameters, AzureActiveDirectoryAuthorizationResponse, AzureActiveDirectoryRefreshToken, AzureActiveDirectoryTokenRequest, AzureActiveDirectoryTokenResponse, TokenResult, AuthorizationResult>
{
  ...
  public String getIssuerCacheIdentifier(AzureActiveDirectoryAuthorizationRequest paramAzureActiveDirectoryAuthorizationRequest)
  {
    ...
    {
      localObject1 = a.a(new StringBuilder(), TAG, ":", "getIssuerCacheIdentifier");
      localObject2 = a.a("Discovery data does not include cloud authority and validation is off. Returning passed in Authority: ");
      ((StringBuilder)localObject2).append(paramAzureActiveDirectoryAuthorizationRequest.getAuthority().toString());
    ...
    if ((!((AzureActiveDirectoryCloud)localObject1).isValidated()) && (!((AzureActiveDirectoryOAuth2Configuration)getOAuth2Configuration()).isAuthorityHostValidationEnabled()))
    {
      ...
      ((StringBuilder)localObject1).append("getIssuerCacheIdentifier");
      Logger.warn(((StringBuilder)localObject1).toString(), "Authority host validation not specified...but there is no cloud...Hence just return the passed in Authority");
      return paramAzureActiveDirectoryAuthorizationRequest.getAuthority().toString();
    }
    ...
    paramAzureActiveDirectoryAuthorizationRequest = new StringBuilder();
    paramAzureActiveDirectoryAuthorizationRequest.append("Issuer cache identifier created: ");
    paramAzureActiveDirectoryAuthorizationRequest.append((String)localObject1);
    Logger.infoPII((String)localObject2, paramAzureActiveDirectoryAuthorizationRequest.toString());
  ...
  public TokenResult getTokenResultFromHttpResponse(HttpResponse paramHttpResponse)
  {
    ...
    TokenResponse localTokenResponse = null;
    if (i >= 400)
    {
      String str = a.a(new StringBuilder(), TAG, ":", "getTokenResultFromHttpResponse");
      ...
      paramHttpResponse = (TokenErrorResponse)ObjectMapper.deserializeJsonStringToObject(paramHttpResponse.getBody(), MicrosoftTokenErrorResponse.class);
    }
    else
    {
      localTokenResponse = (TokenResponse)ObjectMapper.deserializeJsonStringToObject(paramHttpResponse.getBody(), AzureActiveDirectoryTokenResponse.class);
      paramHttpResponse = null;
    }
    return new TokenResult(localTokenResponse, paramHttpResponse);
  }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.providers.microsoft.azureactivedirectory.AzureActiveDirectoryOAuth2Strategy
