  ...
  public b(r paramr, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l1 = 0L; l1 < paramLong; l1 += 1L)
    {
      ...
      for (j = 1; j < d; j++)
      {
        ...
        ((a)localObject3).a(paramArrayOfByte1, paramArrayOfByte2, (j)localObject1);
        ((Map)localObject2).put(Integer.valueOf(j), localObject3);
        label442:
        if (n < m)
        {
          ...
          if (i1 != 0) {
            a(j, paramArrayOfByte1, paramArrayOfByte2, (j)localObject1);
          }
        }
      }
    }
