...
public class MSALControllerFactory
{
  ...
  public static boolean powerOptimizationEnabled(Context paramContext)
  {
    ...
    {
      boolean bool = paramContext.isIgnoringBatteryOptimizations((String)localObject) ^ true;
      paramContext = a.a(new StringBuilder(), TAG, ":powerOptimizationEnabled");
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("Is power optimization on? [");
      ((StringBuilder)localObject).append(bool);
      ((StringBuilder)localObject).append("]");
      Logger.verbose(paramContext, ((StringBuilder)localObject).toString());
      return bool;
    }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.internal.controllers.MSALControllerFactory
