...
public class CloudQueue$3
  extends StorageRequest<CloudQueueClient, CloudQueue, Void>
{
  public CloudQueue$3(CloudQueue paramCloudQueue, RequestOptions paramRequestOptions, StorageUri paramStorageUri, QueueRequestOptions paramQueueRequestOptions)
  {
  ...
  {
    return QueueRequest.create(CloudQueue.access$200(paramCloudQueue, paramOperationContext).getUri(getCurrentLocation()), val$options, paramOperationContext);
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.queue.CloudQueue.3
