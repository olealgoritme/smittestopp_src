  ...
  implements NavController.b
{
  ...
  public void a(NavController paramNavController, i parami, Bundle paramBundle)
  {
    ...
    if (!TextUtils.isEmpty(localCharSequence))
    {
      ...
      {
        paramNavController = localMatcher.group(1);
        if ((paramBundle != null) && (paramBundle.containsKey(paramNavController)))
        {
          localMatcher.appendReplacement(localStringBuffer, "");
          localStringBuffer.append(paramBundle.get(paramNavController).toString());
        }
        else
        {
          ...
          parami.append(localCharSequence);
