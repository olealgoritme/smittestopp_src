  ...
  extends h
{
  ...
  public void c()
  {
    ...
    n.b localb = new n.b(this);
    Object localObject = f0.iterator();
    while (((Iterator)localObject).hasNext()) {
      ((h)((Iterator)localObject).next()).a(localb);
    }
    h0 = f0.size();
    if (!g0)
    {
      for (int i = 1; i < f0.size(); i++) {
        ((h)f0.get(i - 1)).a(new n.a(this, (h)f0.get(i)));
      }
