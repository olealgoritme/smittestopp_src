      ...
      for (int i4 = 0; (i3 != -1) && (i1 < a); i4 = i5)
      {
        ...
        if (f1 != 0.0F) {
          if (g == g.a.UNRESTRICTED)
          {
            ...
            for (bool2 = locala.b((g)localObject1);; bool2 = locala.b((g)localObject1))
            {
              break;
              if (f2 <= f1) {
                break label429;
      ...
      if (i1 != 0)
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (c == -1)
          {
            if (a == localObject1)
            {
              localObject1 = d.a(null, (g)localObject1);
              if (localObject1 != null) {
                paramb.b((g)localObject1);
              }
            }
            if (!e) {
              a.c(paramb);
      ...
      for (int i3 = 0;; i3++)
      {
        ...
        if (c != -1)
        {
          ...
          if (!e)
          {
            ...
            {
              locala.a(c.c[f[i1]], h[i1] * f1, true);
              i1 = g[i1];
            }
          }
          float f2 = b;
