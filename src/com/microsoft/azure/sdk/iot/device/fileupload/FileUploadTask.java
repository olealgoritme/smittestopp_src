  ...
  implements Runnable
{
  ...
  {
    // Byte code:
    //   0: invokestatic 241	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   3: ldc 20
    //   5: invokevirtual 244	java/lang/Thread:setName	(Ljava/lang/String;)V
    ...
    //   11: astore_1
    //   12: aload_0
    //   13: invokespecial 246	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:getContainer	()Lcom/microsoft/azure/sdk/iot/device/IotHubStatusCode;
    //   16: astore_2
    //   17: goto +31 -> 48
    //   20: astore_1
    //   21: goto +12 -> 33
    ...
    //   29: goto +4 -> 33
    //   32: astore_1
    //   33: getstatic 49	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:log	Lk/f/b;
    //   36: ldc -8
    //   38: aload_1
    //   39: invokeinterface 228 3 0
    ...
    //   57: aconst_null
    //   58: astore_2
    //   59: new 250	com/microsoft/azure/storage/blob/CloudBlockBlob
    //   62: astore_1
    //   63: aload_1
    //   64: aload_0
    //   65: getfield 159	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:blobURI	Ljava/net/URI;
    //   68: invokespecial 253	com/microsoft/azure/storage/blob/CloudBlockBlob:<init>	(Ljava/net/URI;)V
    //   71: aload_1
    //   72: aload_0
    ...
    //   80: invokevirtual 257	com/microsoft/azure/storage/blob/CloudBlockBlob:upload	(Ljava/io/InputStream;J)V
    ...
    //   92: iconst_1
    //   93: invokestatic 263	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   96: iconst_0
    //   97: invokestatic 268	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   100: ldc_w 270
    //   103: invokespecial 273	com/microsoft/azure/sdk/iot/deps/serializer/FileUploadStatusParser:<init>	(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/String;)V
    //   106: aload_3
    //   107: astore_2
    ...
    //   113: aload_0
    //   114: aload_3
    //   115: invokespecial 275	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:sendNotification	(Lcom/microsoft/azure/sdk/iot/deps/serializer/FileUploadStatusParser;)Lcom/microsoft/azure/sdk/iot/device/IotHubStatusCode;
    //   118: astore_2
    //   119: aload 4
    //   121: astore_1
    //   122: aload 4
    ...
    //   165: aload_3
    //   166: astore_2
    //   167: getstatic 49	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:log	Lk/f/b;
    //   170: ldc -8
    //   172: aload_1
    //   173: invokeinterface 228 3 0
    //   178: aload_3
    //   179: astore_2
    ...
    //   195: iconst_0
    //   196: invokestatic 263	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: iconst_m1
    //   200: invokestatic 268	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   203: ldc_w 277
    //   206: invokespecial 273	com/microsoft/azure/sdk/iot/deps/serializer/FileUploadStatusParser:<init>	(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/String;)V
    //   209: astore_1
    //   210: aload_0
    //   211: aload_1
    //   212: invokespecial 275	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:sendNotification	(Lcom/microsoft/azure/sdk/iot/deps/serializer/FileUploadStatusParser;)Lcom/microsoft/azure/sdk/iot/device/IotHubStatusCode;
    //   215: astore_2
    //   216: aload 4
    //   218: astore_1
    //   219: aload 4
    ...
    //   233: aload_0
    //   234: aload_2
    //   235: invokespecial 275	com/microsoft/azure/sdk/iot/device/fileupload/FileUploadTask:sendNotification	(Lcom/microsoft/azure/sdk/iot/deps/serializer/FileUploadStatusParser;)Lcom/microsoft/azure/sdk/iot/device/IotHubStatusCode;
    //   238: pop
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.fileupload.FileUploadTask
