...
public class l
{
  ...
  public static void a(ViewGroup paramViewGroup, h paramh)
  {
    if ((!c.contains(paramViewGroup)) && (n.t(paramViewGroup)))
    {
      ...
      if ((g)paramViewGroup.getTag(R.id.transition_current_scene) == null)
      {
        ...
        if (paramh != null)
        {
          paramh = new a(paramh, paramViewGroup);
    ...
    implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener
  {
    ...
    public a(h paramh, ViewGroup paramViewGroup)
    {
      x = paramh;
      y = paramViewGroup;
    }
    ...
    public boolean onPreDraw()
    {
      ...
      if (localObject1 != null)
      {
        ...
        Object localObject6 = new d.f.a(a);
        Object localObject7 = new d.f.a(a);
        int j;
        Object localObject9;
