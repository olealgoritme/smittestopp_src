...
public final class IotHubUri
{
  ...
  public IotHubUri(String paramString1, String paramString2, String paramString3, Map<String, String> paramMap, String paramString4)
  {
    ...
    if (paramMap != null)
    {
      ...
      {
        paramString2 = (Map.Entry)paramString3.next();
        paramString1.append("&");
        appendQueryParam(paramString1, (String)paramString2.getKey(), (String)paramString2.getValue());
      }
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.net.IotHubUri
