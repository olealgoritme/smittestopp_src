  ...
  extends StorageRequest<CloudTableClient, TableOperation, TableResult>
{
  ...
  public HttpURLConnection buildRequest(CloudTableClient paramCloudTableClient, TableOperation paramTableOperation, OperationContext paramOperationContext)
  {
    ...
    URI localURI = paramCloudTableClient.getTransformedEndPoint(val$opContext).getUri(getCurrentLocation());
    TableRequestOptions localTableRequestOptions = val$options;
    paramOperationContext = val$opContext;
    ...
    return TableRequest.insert(localURI, localTableRequestOptions, null, paramOperationContext, str1, str2, paramCloudTableClient, paramTableOperation.getEchoContent(), TableOperation.access$000(paramTableOperation).getUpdateType());
  }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.table.TableOperation.2
