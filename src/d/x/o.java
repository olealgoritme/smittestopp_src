  ...
  public static View a(ViewGroup paramViewGroup, View paramView1, View paramView2)
  {
    ...
    if (i1 > 0)
    {
      ...
      if (i2 > 0)
      {
        ...
        if (a)
        {
          localObject = new Picture();
          paramView2 = ((Picture)localObject).beginRecording(i1, i2);
          paramView2.concat(localMatrix);
          paramView1.draw(paramView2);
          ((Picture)localObject).endRecording();
          paramView2 = Bitmap.createBitmap((Picture)localObject);
        }
        else
        {
