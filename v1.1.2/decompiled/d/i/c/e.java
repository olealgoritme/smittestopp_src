  ...
  extends i
{
  ...
  public Typeface a(Context paramContext, CancellationSignal paramCancellationSignal, b.f[] paramArrayOff, int paramInt)
  {
    ...
    while (i < j)
    {
      ...
      {
        localByteBuffer2 = s.a(paramContext, paramCancellationSignal, localUri);
  ...
  public Typeface a(Context paramContext, d.i.b.b.c paramc, android.content.res.Resources paramResources, int paramInt)
  {
    ...
    //   60: istore 9
    //   62: aload_1
    //   63: invokestatic 177	d/b/a/s:a	(Landroid/content/Context;)Ljava/io/File;
    //   66: astore 10
    //   68: aload 10
    //   70: ifnonnull +6 -> 76
    //   73: goto +24 -> 97
    ...
    //   78: aload_3
    //   79: iload 9
    //   81: invokestatic 180	d/b/a/s:a	(Ljava/io/File;Landroid/content/res/Resources;I)Z
    //   84: istore 11
    //   86: iload 11
    //   88: ifne +14 -> 102
    //   91: aload 10
