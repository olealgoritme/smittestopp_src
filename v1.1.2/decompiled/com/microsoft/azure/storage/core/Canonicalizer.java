...
public abstract class Canonicalizer
{
  ...
  public static void addCanonicalizedHeaders(HttpURLConnection paramHttpURLConnection, StringBuilder paramStringBuilder)
  {
    ...
    paramHttpURLConnection = new ArrayList();
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (((String)localObject2).toLowerCase(Utility.LOCALE_US).startsWith("x-ms-")) {
        paramHttpURLConnection.add(((String)localObject2).toLowerCase(Utility.LOCALE_US));
      }
    }
    Collections.sort(paramHttpURLConnection);
    Object localObject2 = paramHttpURLConnection.iterator();
  ...
  public static String getCanonicalizedResource(URL paramURL, String paramString)
  {
    ...
    if ((paramURL.getQuery() != null) && (paramURL.getQuery().contains("=")))
    {
      ...
      {
        paramURL = (String)((Iterator)localObject4).next();
        localObject2 = a.a(paramURL, ":");
        ((StringBuilder)localObject2).append((String)((HashMap)localObject1).get(paramURL));
        appendCanonicalizedElement(paramString, ((StringBuilder)localObject2).toString());
      }
  ...
  public static ArrayList<String> getHeaderValues(Map<String, List<String>> paramMap, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((String)paramMap.getKey()).toLowerCase(Utility.LOCALE_US).equals(paramString))
      {
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.core.Canonicalizer
