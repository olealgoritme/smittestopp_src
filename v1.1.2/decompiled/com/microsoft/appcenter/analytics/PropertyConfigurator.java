  ...
  extends AbstractChannelListener
{
  ...
  private boolean shouldOverridePartAProperties(Log paramLog)
  {
    ...
    {
      Object localObject = paramLog.getTag();
      paramLog = mTransmissionTarget;
      if ((localObject == paramLog) && (paramLog.isEnabled())) {
        return true;
      }
    }
    boolean bool = false;
  ...
  public void collectDeviceId()
  {
    Analytics.getInstance().postCommandEvenIfDisabled(new Runnable()
    {
      public void run()
      {
        PropertyConfigurator.access$402(PropertyConfigurator.this, true);
      }
    });
  }
  ...
  public void setAppLocale(final String paramString)
  {
    Analytics.getInstance().postCommandEvenIfDisabled(new Runnable()
    {
      public void run()
      {
        PropertyConfigurator.access$202(PropertyConfigurator.this, paramString);
      }
    });
  }
  
  public void setAppName(final String paramString)
  {
    Analytics.getInstance().postCommandEvenIfDisabled(new Runnable()
    {
      public void run()
      {
        PropertyConfigurator.access$002(PropertyConfigurator.this, paramString);
      }
    });
  }
  
  public void setAppVersion(final String paramString)
  {
    Analytics.getInstance().postCommandEvenIfDisabled(new Runnable()
    {
      public void run()
      {
        PropertyConfigurator.access$102(PropertyConfigurator.this, paramString);
      }
    });
  }
  ...
  public void setUserId(final String paramString)
  {
    if (UserIdContext.checkUserIdValidForOneCollector(paramString)) {
      Analytics.getInstance().postCommandEvenIfDisabled(new Runnable()
      {
        public void run()
        {
          PropertyConfigurator.access$302(PropertyConfigurator.this, UserIdContext.getPrefixedUserId(paramString));
        }
      });
    }
  }
...
/* Location:
 * Qualified Name:     com.microsoft.appcenter.analytics.PropertyConfigurator
