  ...
  extends AuthorizationStrategy<GenericOAuth2Strategy, GenericAuthorizationRequest>
{
  ...
  public void completeAuthorization(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    else
    {
      ...
      localStringBuilder.append("Unknown request code ");
      localStringBuilder.append(paramInt1);
      Logger.warnPII(paramIntent, localStringBuilder.toString());
    }
  }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.ui.browser.BrowserAuthorizationStrategy
