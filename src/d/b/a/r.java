...
public class r
{
  ...
  public static int a(d.g.a.h.d paramd, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    int i3 = Math.max(i11, Math.max(i1, paramInt2));
    int i2 = i10 + i7;
    int i4 = i7;
    paramInt2 = i2;
    if (i8 == -1)
    ...
    if (paramBoolean)
    {
      d.g.a.h.i.a(paramd, paramInt1, i4);
      paramd.a(i4, paramInt2, paramInt1);
    }
    else
    {
  ...
  public static int a(s.u paramu, d.t.a.r paramr, View paramView1, View paramView2, s.k paramk, boolean paramBoolean)
  {
    if ((paramk.d() != 0) && (paramu.a() != 0) && (paramView1 != null) && (paramView2 != null))
    {
      if (!paramBoolean) {
        return Math.abs(paramk.a(paramView1) - paramk.a(paramView2)) + 1;
      }
  ...
  public static int a(s.u paramu, d.t.a.r paramr, View paramView1, View paramView2, s.k paramk, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramk.d() != 0) && (paramu.a() != 0) && (paramView1 != null) && (paramView2 != null))
    {
      int i1 = Math.min(paramk.a(paramView1), paramk.a(paramView2));
      int i2 = Math.max(paramk.a(paramView1), paramk.a(paramView2));
      if (paramBoolean2) {
        i1 = Math.max(0, paramu.a() - i2 - 1);
      } else {
        i1 = Math.max(0, i1);
      }
      if (!paramBoolean1) {
      ...
      i2 = Math.abs(paramr.a(paramView2) - paramr.b(paramView1));
      int i3 = Math.abs(paramk.a(paramView1) - paramk.a(paramView2));
      float f1 = i2 / (i3 + 1);
      return Math.round(i1 * f1 + (paramr.b() - paramr.b(paramView1)));
    }
    return 0;
  }
    ...
    for (;;)
    {
      ...
      if (i2 == 2)
      {
        ...
        else
        {
          ...
          localObject4 = null;
          if ((localObject4 != null) && ((localObject1 instanceof ValueAnimator))) {
  ...
  public static ValueAnimator a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, ValueAnimator paramValueAnimator, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    if (localTypedArray2 != null)
    {
      ...
      if (paramAttributeSet != null)
      {
        ...
        paramAttributeSet = c(paramAttributeSet);
        ...
        for (;;)
        {
          ...
          if (!((PathMeasure)localObject).nextContour())
          {
            ...
            for (;;)
            {
              ...
              localPathMeasure.getPosTan(paramFloat - ((Float)localArrayList.get(i4)).floatValue(), arrayOfFloat2, null);
  ...
  public static Intent a(Activity paramActivity)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 638	android/app/Activity:getParentActivityIntent	()Landroid/content/Intent;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnull +5 -> 11
    //   9: aload_1
    ...
    //   11: aload_0
    //   12: aload_0
    //   13: invokevirtual 642	android/app/Activity:getComponentName	()Landroid/content/ComponentName;
    //   16: invokestatic 645	d/b/a/r:b	(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    //   19: astore_1
    //   20: aload_1
    //   21: ifnonnull +5 -> 26
    //   24: aconst_null
    //   25: areturn
    //   26: new 647	android/content/ComponentName
    //   29: dup
    //   30: aload_0
    //   31: aload_1
    //   32: invokespecial 650	android/content/ComponentName:<init>	(Landroid/content/Context;Ljava/lang/String;)V
    //   35: astore_2
    //   36: aload_0
    //   37: aload_2
    //   38: invokestatic 645	d/b/a/r:b	(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    //   41: ifnonnull +11 -> 52
    //   44: aload_2
    //   45: invokestatic 656	android/content/Intent:makeMainActivity	(Landroid/content/ComponentName;)Landroid/content/Intent;
    //   48: astore_0
    //   49: goto +17 -> 66
    //   52: new 652	android/content/Intent
    //   55: astore_0
    //   56: aload_0
    //   57: invokespecial 657	android/content/Intent:<init>	()V
    //   60: aload_0
    //   61: aload_2
    //   62: invokevirtual 660	android/content/Intent:setComponent	(Landroid/content/ComponentName;)Landroid/content/Intent;
    //   65: astore_0
    //   66: aload_0
    //   67: areturn
    //   68: astore_0
    ...
    //   106: invokestatic 670	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   109: pop
    //   110: aconst_null
    //   111: areturn
    //   112: astore_0
    //   113: new 43	java/lang/IllegalArgumentException
    //   116: dup
    //   117: aload_0
    //   118: invokespecial 673	java/lang/IllegalArgumentException:<init>	(Ljava/lang/Throwable;)V
    //   121: athrow
    ...
    if (((String)localObject1).equals("selector"))
    {
      ...
      for (;;)
      {
        ...
        if ((i3 == 2) && (i4 <= i1) && (paramXmlPullParser.getName().equals("item")))
        {
          ...
          i4 = 0;
          for (i3 = 0; i4 < i6; i3 = i8)
          {
            i7 = paramAttributeSet.getAttributeNameResource(i4);
            i8 = i3;
            if (i7 != 16843173)
            {
              i8 = i3;
          ...
          int[] arrayOfInt = StateSet.trimStateSet((int[])localObject3, i3);
  ...
  public static InputConnection a(InputConnection paramInputConnection, EditorInfo paramEditorInfo, View paramView)
  {
    if ((paramInputConnection != null) && (hintText == null)) {
      for (paramView = paramView.getParent(); (paramView instanceof View); paramView = paramView.getParent()) {
        if ((paramView instanceof e1))
        {
          hintText = ((e1)paramView).a();
          break;
        }
      }
    }
  ...
  public static final NavController a(Activity paramActivity, int paramInt)
  {
    if (paramActivity != null)
    {
      ...
      if (localObject != null)
      {
        h.k.b.g.a(localObject, "Navigation.findNavController(this, viewId)");
  ...
  public static d.i.b.b.b a(XmlPullParser paramXmlPullParser, Resources paramResources)
  {
    ...
    if (i1 == 2)
    {
      ...
      if (paramXmlPullParser.getName().equals("font-family"))
      {
        ...
        Object localObject2 = localTypedArray.getString(R.styleable.FontFamily_fontProviderPackage);
        String str2 = localTypedArray.getString(R.styleable.FontFamily_fontProviderQuery);
        int i2 = localTypedArray.getResourceId(R.styleable.FontFamily_fontProviderCerts, 0);
        i1 = localTypedArray.getInteger(R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int i3 = localTypedArray.getInteger(R.styleable.FontFamily_fontProviderFetchTimeout, 500);
        localTypedArray.recycle();
        if ((str1 != null) && (localObject2 != null) && (str2 != null))
        {
          while (paramXmlPullParser.next() != 3) {
            a(paramXmlPullParser);
          }
          paramXmlPullParser = new d.i.b.b.e(new d.i.f.a(str1, (String)localObject2, str2, a(paramResources, i2)), i1, i3);
        }
        else
        {
          ...
          while (paramXmlPullParser.next() != 3) {
            if (paramXmlPullParser.getEventType() == 2) {
              ...
              {
                localTypedArray = paramResources.obtainAttributes(Xml.asAttributeSet(paramXmlPullParser), R.styleable.FontFamilyFont);
                ...
                i2 = localTypedArray.getInt(i1, 400);
                ...
                boolean bool;
                if (1 == localTypedArray.getInt(i1, 0)) {
                  bool = true;
                } else {
                  bool = false;
                }
                ...
                i3 = localTypedArray.getInt(i1, 0);
                ...
                int i4 = localTypedArray.getResourceId(i1, 0);
                str1 = localTypedArray.getString(i1);
                localTypedArray.recycle();
                while (paramXmlPullParser.next() != 3) {
                  a(paramXmlPullParser);
                }
                ((ArrayList)localObject2).add(new d.i.b.b.d(str1, i2, bool, str2, i3, i4));
              }
              else
              {
                a(paramXmlPullParser);
          ...
          if (((ArrayList)localObject2).isEmpty()) {
            ...
            paramXmlPullParser = new d.i.b.b.c((d.i.b.b.d[])((ArrayList)localObject2).toArray(new d.i.b.b.d[((ArrayList)localObject2).size()]));
          }
        }
      }
      else
  ...
  public static java.nio.ByteBuffer a(Context paramContext, android.os.CancellationSignal paramCancellationSignal, android.net.Uri paramUri)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 1324	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   4: astore_0
    //   5: aload_0
    //   6: aload_2
    //   7: ldc_w 1325
    //   10: aload_1
    //   11: invokevirtual 1331	android/content/ContentResolver:openFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/os/ParcelFileDescriptor;
    //   14: astore_0
    //   15: aload_0
    //   16: ifnonnull +13 -> 29
    //   19: aload_0
    //   20: ifnull +7 -> 27
    //   23: aload_0
    //   24: invokevirtual 1336	android/os/ParcelFileDescriptor:close	()V
    //   27: aconst_null
    //   28: areturn
    //   29: new 1338	java/io/FileInputStream
    //   32: astore_1
    //   33: aload_1
    //   34: aload_0
    //   35: invokevirtual 1342	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   38: invokespecial 1345	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   41: aload_1
    //   42: invokevirtual 1349	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   45: astore_2
    //   46: aload_2
    //   47: invokevirtual 1353	java/nio/channels/FileChannel:size	()J
    //   50: lstore_3
    //   51: aload_2
    //   52: getstatic 1359	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   55: lconst_0
    //   56: lload_3
    //   57: invokevirtual 1363	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   60: astore_2
    //   61: aload_1
    //   62: invokevirtual 1364	java/io/FileInputStream:close	()V
    //   65: aload_0
    //   66: invokevirtual 1336	android/os/ParcelFileDescriptor:close	()V
    //   69: aload_2
    //   70: areturn
    //   71: astore_2
    //   72: aload_2
    ...
    //   74: astore 5
    //   76: aload_1
    //   77: invokevirtual 1364	java/io/FileInputStream:close	()V
    //   80: goto +9 -> 89
    //   83: astore_1
    //   84: aload_2
    //   85: aload_1
    //   86: invokevirtual 1369	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   89: aload 5
    //   91: athrow
    //   92: astore_2
    //   93: aload_2
    ...
    //   95: astore_1
    //   96: aload_0
    //   97: invokevirtual 1336	android/os/ParcelFileDescriptor:close	()V
    //   100: goto +9 -> 109
    //   103: astore_0
    //   104: aload_2
    //   105: aload_0
    //   106: invokevirtual 1369	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   109: aload_1
    //   110: athrow
    //   111: astore_0
    //   112: aconst_null
    ...
    //   0	114	1	paramCancellationSignal	android.os.CancellationSignal
    //   0	114	2	paramUri	android.net.Uri
    //   50	7	3	l1	long
    //   74	16	5	localObject	Object
    // Exception table:
    //   from	to	target	type
    //   41	61	71	finally
    //   72	74	74	finally
    ...
    //   93	95	95	finally
    //   96	100	103	finally
    //   5	15	111	java/io/IOException
    //   23	27	111	java/io/IOException
    //   65	69	111	java/io/IOException
    //   104	109	111	java/io/IOException
    //   109	111	111	java/io/IOException
  }
  ...
  public static void a(View paramView, CharSequence paramCharSequence)
  {
    ...
    {
      a1 locala1 = a1.G;
      if ((locala1 != null) && (x == paramView)) {
        a1.a(null);
      }
      if (TextUtils.isEmpty(paramCharSequence))
      {
        paramCharSequence = a1.H;
      ...
      {
        new a1(paramView, paramCharSequence);
      }
    }
  }
  ...
  public static void a(d.g.a.h.e parame)
  {
    ...
    {
      localObject3 = (d.g.a.h.d)((Iterator)localObject2).next();
      p = null;
      d0 = false;
      ((d.g.a.h.d)localObject3).l();
    }
    localObject1 = ((List)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (d.g.a.h.d)((Iterator)localObject1).next();
      if (p == null)
      {
        localObject3 = new f(new ArrayList(), true);
        localList.add(localObject3);
        if (!a((d.g.a.h.d)localObject2, (f)localObject3, localList, bool))
        {
          w0.clear();
          w0.add(0, new f(k0));
          D0 = false;
    ...
    int i3 = 0;
    for (int i4 = 0; ((Iterator)localObject3).hasNext(); i4 = Math.max(i4, a((f)localObject1, 1)))
    {
      localObject1 = (f)((Iterator)localObject3).next();
      i3 = Math.max(i3, a((f)localObject1, 0));
    }
    if (i1 != 0)
    {
      parame.a(d.a.FIXED);
  ...
  public static void a(d.g.a.h.e parame, d.g.a.e parame1, int paramInt1, int paramInt2, d.g.a.h.b paramb)
  {
    ...
    if (locald3 != null)
    {
      ...
      {
        localObject4 = A[i2];
        parame1.c(i, d.i, -((d.g.a.h.c)localObject4).a(), 5);
      }
    }
    if (i1 != 0)
    {
      ...
      parame = i;
      localObject7 = A;
      parame1.b(parame, i, localObject7[i2].a(), 6);
    }
      ...
      if (i3 > 1)
      {
        ...
        for (;;)
        {
          ...
          if (localObject4 != null)
          {
            ...
            parame1.a((d.g.a.b)localObject8);
          }
          localObject4 = parame;
          f3 = f1;
          label1208:
    ...
    if ((locald2 != null) && ((locald2 == locald3) || (i6 != 0)))
    {
      ...
      if ((paramb != null) && (localObject7 != null))
      {
        ...
        parame1.a(i, paramb, i2, f1, (d.g.a.g)localObject7, i, paramInt1, 5);
      }
    }
    else
    {
      ...
      while (localObject7 != null)
      {
        ...
        for (;;)
        {
          ...
          if ((localg != null) && (paramb != null) && (localObject6 != null) && (localObject1 != null))
          {
            if (localObject7 == locald2) {
              i3 = A[paramInt2].a();
            }
            ...
            parame1.a(localg, paramb, i3, 0.5F, (d.g.a.g)localObject6, (d.g.a.g)localObject1, i2, i6);
          }
        }
        if (Y != 8) {
          localObject4 = localObject7;
        ...
        if ((i4 != 0) && (locald2 != null))
        {
          ...
          while (localObject7 != null)
          {
            ...
            if ((localObject7 != locald2) && (localObject7 != locald3) && (paramb != null))
            {
              ...
              if (localObject4 != null) {
                i3 = ((d.g.a.h.c)localObject4).a() + i3;
              }
              i9 = A[i1].a();
              if (i2 != 0) {
                i1 = 6;
              ...
              if ((localObject9 != null) && (localg != null) && (localObject1 != null) && (localObject2 != null)) {
                parame1.a((d.g.a.g)localObject9, localg, i9 + i6, 0.5F, (d.g.a.g)localObject1, (d.g.a.g)localObject2, i3, i1);
              }
            }
            if (Y == 8) {
              localObject7 = localObject3;
    ...
    if (((i5 != 0) || (i4 != 0)) && (locald2 != null))
    {
      ...
      {
        paramInt2 = ((d.g.a.h.c)localObject7).a();
  ...
  public static void a(List<f> paramList, int paramInt1, int paramInt2)
  {
    ...
    while (i2 < i1)
    {
      ...
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          d.g.a.h.d locald = (d.g.a.h.d)((Iterator)localObject1).next();
          if (b0)
          {
            int i3 = paramInt1 * 2;
            ...
            if (i4 != 0)
            {
              i4 = a(locald, paramInt1);
              d.g.a.h.i.a(locald, paramInt1, localHashSet.a() + i4);
            }
            else if ((G != 0.0F) && (locald.b(paramInt1) == d.a.MATCH_CONSTRAINT))
            {
              i4 = a(locald);
              i3 = (int)A[i3].a.g;
              localObject2 = a;
            ...
            else
            {
              ...
              i4 = paramInt2 - i4;
              i3 = i4 - locald.c(paramInt1);
              locald.a(i3, i4, paramInt1);
              d.g.a.h.i.a(locald, paramInt1, i3);
            }
          }
        }
        i2++;
  ...
  public static boolean a(File paramFile, Resources paramResources, int paramInt)
  {
    ...
    //   0: aload_1
    //   1: iload_2
    //   2: invokevirtual 1939	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   5: astore_1
    //   6: aload_0
    //   7: aload_1
    //   8: invokestatic 1942	d/b/a/r:a	(Ljava/io/File;Ljava/io/InputStream;)Z
    //   11: istore_3
    //   12: aload_1
    //   13: ifnull +9 -> 22
    //   16: aload_1
    //   17: invokeinterface 1945 1 0
    //   22: iload_3
    //   23: ireturn
    //   24: astore_0
    //   25: goto +6 -> 31
  ...
  {
    // Byte code:
    //   0: invokestatic 1951	android/os/StrictMode:allowThreadDiskWrites	()Landroid/os/StrictMode$ThreadPolicy;
    //   3: astore_2
    //   4: aconst_null
    //   5: astore_3
    //   6: aconst_null
    ...
    //   9: aload 4
    //   11: astore 5
    //   13: new 1953	java/io/FileOutputStream
    //   16: astore 6
    //   18: aload 4
    //   20: astore 5
    //   22: aload 6
    //   24: aload_0
    //   25: iconst_0
    //   26: invokespecial 1956	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   29: sipush 1024
    //   32: newarray <illegal type>
    //   34: astore_0
    //   35: aload_1
    //   36: aload_0
    //   37: invokevirtual 1962	java/io/InputStream:read	([B)I
    //   40: istore 7
    //   42: iload 7
    //   44: iconst_m1
    //   45: if_icmpeq +15 -> 60
    ...
    //   51: iconst_0
    //   52: iload 7
    //   54: invokevirtual 1966	java/io/FileOutputStream:write	([BII)V
    //   57: goto -22 -> 35
    //   60: aload 6
    //   62: invokevirtual 1967	java/io/FileOutputStream:close	()V
    //   65: aload_2
    //   66: invokestatic 1971	android/os/StrictMode:setThreadPolicy	(Landroid/os/StrictMode$ThreadPolicy;)V
    //   69: iconst_1
    //   70: ireturn
    //   71: astore_0
    //   72: aload 6
    ...
    //   102: astore 5
    //   104: aload 6
    //   106: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   109: aload_0
    //   110: astore 5
    //   112: aload 6
    //   114: ldc_w 1973
    ...
    //   124: aload 6
    //   126: aload_1
    //   127: invokevirtual 1976	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   145: invokestatic 670	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   148: pop
    //   149: aload_0
    //   150: ifnull +9 -> 159
    //   153: aload_0
    //   154: invokeinterface 1945 1 0
    //   159: aload_2
    //   160: invokestatic 1971	android/os/StrictMode:setThreadPolicy	(Landroid/os/StrictMode$ThreadPolicy;)V
    //   163: iconst_0
    //   164: ireturn
    //   165: aload 5
    //   167: ifnull +10 -> 177
    //   170: aload 5
    //   172: invokeinterface 1945 1 0
    //   177: aload_2
    //   178: invokestatic 1971	android/os/StrictMode:setThreadPolicy	(Landroid/os/StrictMode$ThreadPolicy;)V
    //   181: aload_0
    //   182: athrow
    //   183: astore_0
    //   184: goto -119 -> 65
  ...
  public static int b(Parcel paramParcel)
  {
    ...
    i1 = i2 + i3;
    if ((i1 >= i3) && (i1 <= paramParcel.dataSize())) {
      return i1;
    }
  ...
  public static int b(s.u paramu, d.t.a.r paramr, View paramView1, View paramView2, s.k paramk, boolean paramBoolean)
  {
    if ((paramk.d() != 0) && (paramu.a() != 0) && (paramView1 != null) && (paramView2 != null))
    {
      if (!paramBoolean) {
      ...
      int i2 = paramr.b(paramView1);
      int i3 = Math.abs(paramk.a(paramView1) - paramk.a(paramView2));
      return (int)((i1 - i2) / (i3 + 1) * paramu.a());
    }
    return 0;
  }
  ...
  public static String b(Context paramContext, ComponentName paramComponentName)
  {
    ...
    paramComponentName = ((PackageManager)localObject).getActivityInfo(paramComponentName, i1);
