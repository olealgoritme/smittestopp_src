...
public class b
{
  ...
  public static Typeface a(Context paramContext, final a parama, g arg2, final Handler paramHandler, boolean paramBoolean, int paramInt1, final int paramInt2)
  {
    ...
    if (localObject4 != null)
    {
      if (packageName.equals(b))
      {
        ...
        if (localObject3 == null) {
          localObject3 = s.a((Resources)localObject2, e);
        }
        int j;
        for (i = 0;; i++)
        {
        ...
        try
        {
          ...
          if (paramCancellationSignal != null)
          {
            ...
            if (paramCancellationSignal.getCount() > 0)
            {
              ...
              for (;;)
              {
                ...
                localObject3 = paramCancellationSignal;
                ((f)localObject2).<init>(paramContext, j, i4, bool, i);
                localObject3 = paramCancellationSignal;
          ...
          return new e(0, (f[])paramContext.toArray(new f[0]));
        }
        finally
        {
          if (localObject3 != null) {
  ...
  public static g a(Context paramContext, a parama, int paramInt)
  {
    try
    {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      if (e == 0)
      {
        ...
        if (!localHashMap.containsKey(localObject)) {
          localHashMap.put(localObject, s.a(paramContext, paramCancellationSignal, (Uri)localObject));
        }
      }
    }
  ...
  {
    public a(Context paramContext, a parama, int paramInt, String paramString) {}
    ...
    public Object call()
    {
      ...
      if (localTypeface != null) {
        b.a.a(localObject, localTypeface);
      }
      return localg;
    }
  }
  ...
  public static final class b
    implements c.c<b.g>
  {
    public b(g paramg, Handler paramHandler) {}
    
    public void a(Object paramObject)
    {
      paramObject = (b.g)paramObject;
      if (paramObject == null)
      {
        a.a(1, paramHandler);
      }
  ...
  public static final class g
  {
    ...
    public g(Typeface paramTypeface, int paramInt)
    {
      a = paramTypeface;
      b = paramInt;
    }
