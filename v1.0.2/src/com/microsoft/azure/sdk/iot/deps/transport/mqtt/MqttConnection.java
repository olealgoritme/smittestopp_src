  ...
  implements g
{
  ...
  public void connect()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 58	com/microsoft/azure/sdk/iot/deps/transport/mqtt/MqttConnection:mqttAsyncClient	Lk/c/a/a/a/f;
    //   6: invokevirtual 156	k/c/a/a/a/f:b	()Z
    //   9: ifne +42 -> 51
    //   12: aload_0
    //   13: getfield 58	com/microsoft/azure/sdk/iot/deps/transport/mqtt/MqttConnection:mqttAsyncClient	Lk/c/a/a/a/f;
    //   16: aload_0
    //   17: getfield 63	com/microsoft/azure/sdk/iot/deps/transport/mqtt/MqttConnection:connectionOptions	Lk/c/a/a/a/i;
    //   20: aconst_null
    //   21: aconst_null
    //   22: invokevirtual 159	k/c/a/a/a/f:a	(Lk/c/a/a/a/i;Ljava/lang/Object;Lk/c/a/a/a/a;)Lk/c/a/a/a/e;
    //   25: astore_1
    //   26: aload_1
    //   27: checkcast 161	k/c/a/a/a/q
    //   30: astore_1
    //   31: aload_1
    //   32: invokevirtual 163	k/c/a/a/a/q:a	()V
    //   35: aload_0
    ...
    //   62	13	1	localIOException	IOException
    //   58	9	2	localk	k
    // Exception table:
    //   from	to	target	type
    //   2	26	54	finally
  ...
  public void disconnect()
  {
    ...
    //   12: aload_0
    //   13: getfield 58	com/microsoft/azure/sdk/iot/deps/transport/mqtt/MqttConnection:mqttAsyncClient	Lk/c/a/a/a/f;
    //   16: invokevirtual 183	k/c/a/a/a/f:a	()Lk/c/a/a/a/e;
    //   19: astore_1
    //   20: aload_1
    //   21: checkcast 161	k/c/a/a/a/q
    //   24: astore_1
    //   25: aload_1
    //   26: invokevirtual 163	k/c/a/a/a/q:a	()V
    //   29: aload_0
    //   30: monitorexit
    //   31: return
    //   32: astore_1
        ...
        if (bool)
        {
          if (paramMqttMessage != null) {
            ...
            catch (k localk)
            {
              ...
              ((StringBuilder)localObject).append("Unable to publish message on topic : ");
              ((StringBuilder)localObject).append(paramMqttMessage.getTopic());
              localIOException.<init>(((StringBuilder)localObject).toString(), localk);
  ...
  public void unsubscribe(String paramString)
  {
    ...
    //   3: getfield 58	com/microsoft/azure/sdk/iot/deps/transport/mqtt/MqttConnection:mqttAsyncClient	Lk/c/a/a/a/f;
    //   6: aload_1
    //   7: invokevirtual 248	k/c/a/a/a/f:a	(Ljava/lang/String;)Lk/c/a/a/a/e;
    //   10: astore_2
    //   11: aload_2
    //   12: checkcast 161	k/c/a/a/a/q
    //   15: astore_2
    //   16: aload_2
    //   17: invokevirtual 163	k/c/a/a/a/q:a	()V
    //   20: aload_0
    //   21: monitorexit
    //   22: return
    //   23: astore_1
    ...
    //   28	67	23	finally
    //   2	11	27	k/c/a/a/a/k
    //   16	20	27	k/c/a/a/a/k
  }
}

/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.deps.transport.mqtt.MqttConnection
