...
public class OpenIdProviderConfigurationClient
{
  ...
  public OpenIdProviderConfiguration loadOpenIdProviderConfiguration()
  {
    ...
    //   284	15	1	localServiceException	com.microsoft.identity.common.exception.ServiceException
    //   9	266	2	localObject3	Object
    //   280	11	2	localIOException	java.io.IOException
    //   154	20	3	localStringBuilder	StringBuilder
    //   198	60	4	i	int
    // Exception table:
    //   from	to	target	type
    //   2	51	276	finally
  ...
  public void loadOpenIdProviderConfiguration(OpenIdProviderConfigurationClient.OpenIdProviderConfigurationCallback paramOpenIdProviderConfigurationCallback)
  {
    sBackgroundExecutor.submit(new OpenIdProviderConfigurationClient.1(this, paramOpenIdProviderConfigurationCallback));
  }
}

/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.providers.oauth2.OpenIdProviderConfigurationClient
