...
public class HttpsHsmClient
{
  ...
  {
    log.e("Reading response from unix socket channel...");
    ...
    if (i >= 0)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = a.a((String)localObject2);
        int m = localByteBuffer.get();
        localObject2 = StandardCharsets.US_ASCII;
        ((StringBuilder)localObject1).append(new String(new byte[] { m }, (Charset)localObject2));
  ...
  {
    // Byte code:
    //   0: getstatic 31	com/microsoft/azure/sdk/iot/device/hsm/HttpsHsmClient:log	Ll/f/b;
    //   3: ldc 124
    ...
    //   27: aload 6
    //   29: aload 4
    //   31: invokespecial 133	h/e/h:<init>	(Ljava/lang/String;)V
    //   34: new 88	h/e/i
    //   37: astore_2
    //   38: aload_2
    //   39: invokespecial 134	h/e/i:<init>	()V
    //   42: aload_2
    //   43: aload 6
    //   45: invokevirtual 137	h/e/i:a	(Lh/e/h;)Z
    //   48: pop
    //   49: aload_1
    ...
    //   90: invokevirtual 159	h/e/i:write	(Ljava/nio/ByteBuffer;)I
    //   93: pop
    //   94: goto +12 -> 106
    //   97: aload_2
    //   98: aload_3
    //   99: invokestatic 157	java/nio/ByteBuffer:wrap	([B)Ljava/nio/ByteBuffer;
    //   102: invokevirtual 159	h/e/i:write	(Ljava/nio/ByteBuffer;)I
    //   105: pop
    //   106: aload_0
    //   107: aload_2
    //   108: invokespecial 161	com/microsoft/azure/sdk/iot/device/hsm/HttpsHsmClient:readResponseFromChannel	(Lh/e/i;)Ljava/lang/String;
    //   111: astore 4
    ...
    //   136: astore_1
    //   137: getstatic 31	com/microsoft/azure/sdk/iot/device/hsm/HttpsHsmClient:log	Ll/f/b;
    //   140: ldc -81
    //   142: invokeinterface 177 2 0
    //   147: aload_2
    //   148: invokevirtual 182	java/nio/channels/SocketChannel:close	()V
    //   151: aload_1
    //   152: areturn
    //   153: astore_1
    //   154: goto +14 -> 168
    //   157: astore_1
    //   158: aload_2
    //   159: invokevirtual 182	java/nio/channels/SocketChannel:close	()V
    //   162: aload_1
    //   163: athrow
    //   164: astore_1
    //   165: aload 5
    ...
    //   168: aload_2
    //   169: ifnull +17 -> 186
    //   172: getstatic 31	com/microsoft/azure/sdk/iot/device/hsm/HttpsHsmClient:log	Ll/f/b;
    //   175: ldc -81
    //   177: invokeinterface 177 2 0
    //   182: aload_2
    //   183: invokevirtual 182	java/nio/channels/SocketChannel:close	()V
    //   186: aload_1
    //   187: athrow
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.hsm.HttpsHsmClient
