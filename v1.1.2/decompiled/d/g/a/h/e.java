    ...
    for (;;)
    {
      ...
      if (!w0.get(i4)).d)
      {
        ...
        if (g(32)) {
          if ((e() == d.a.FIXED) && (h() == d.a.FIXED))
          {
            ...
            else
            {
              ...
              while (i5 < i3)
              {
                localObject6 = (d)a.get(i5);
                if (!b0) {
                  ((f)localObject1).a((ArrayList)j, (d)localObject6);
                }
                i5++;
              }
              k.clear();
        ...
        while (j != 0)
        {
          ...
          label1099:
          Object localObject7 = System.out;
          localObject6 = new StringBuilder();
          ((StringBuilder)localObject6).append("EXCEPTION : ");
          ((StringBuilder)localObject6).append(localException3);
          ((PrintStream)localObject7).println(((StringBuilder)localObject6).toString());
          if (n != 0)
          {
            localObject2 = m0;
            localObject6 = i.a;
