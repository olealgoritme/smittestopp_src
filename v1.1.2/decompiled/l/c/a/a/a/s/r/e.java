...
public class e
{
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((StringBuilder)localObject4).<init>("GET ");
      ((StringBuilder)localObject4).append((String)localObject1);
      ((StringBuilder)localObject4).append(" HTTP/1.1");
      ((StringBuilder)localObject4).append("\r\n");
      ((PrintWriter)localObject2).print(((StringBuilder)localObject4).toString());
      int i = e;
      if (i != 80)
      {
        localObject1 = new java/lang/StringBuilder;
      ...
      if (f != null)
      {
        localObject1 = f.keySet().iterator();
        while (((Iterator)localObject1).hasNext())
        {
          String str3 = (String)((Iterator)localObject1).next();
          localObject4 = f.getProperty(str3);
      ...
      localObject3 = ((URI)localObject3).getUserInfo();
      if (localObject3 != null)
      {
        localObject1 = new java/lang/StringBuilder;
        ((StringBuilder)localObject1).<init>("Authorization: Basic ");
        a.b.putByteArray("akey", ((String)localObject3).getBytes());
        ((StringBuilder)localObject1).append(ba);
        ((StringBuilder)localObject1).append("\r\n");
        ((PrintWriter)localObject2).print(((StringBuilder)localObject1).toString());
      }
...
/* Location:
 * Qualified Name:     l.c.a.a.a.s.r.e
