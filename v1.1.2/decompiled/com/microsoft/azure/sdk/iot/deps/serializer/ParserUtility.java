...
public class ParserUtility
{
  ...
  public static Date getDateTimeUtc(String paramString)
  {
    ...
    if ((paramString != null) && (!paramString.isEmpty())) {
      try
      {
        ...
        ((StringBuilder)localObject2).append("invalid time:");
  ...
  public static j mapToJsonElement(Map<String, Object> paramMap)
  {
    ...
    g = true;
    Gson localGson = ((e)localObject).a();
    localObject = new m();
    if (paramMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (paramMap.getValue() == null) {
          ((m)localObject).a((String)paramMap.getKey(), null);
        } else if ((paramMap.getValue() instanceof Map)) {
          ((m)localObject).a((String)paramMap.getKey(), mapToJsonElement((Map)paramMap.getValue()));
        } else {
          ((m)localObject).a((String)paramMap.getKey(), localGson.b(paramMap.getValue()));
        }
      }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.deps.serializer.ParserUtility
