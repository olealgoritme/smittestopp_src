...
public class a
{
  ...
  public a(Context paramContext, ViewGroup paramViewGroup, c paramc)
  {
          ...
          if (i1 != 3)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  i5 = i3;
                  if (i1 >= paramMotionEvent.getLeft())
                  {
                    i5 = i3;
                    if (i1 < paramMotionEvent.getRight())
                    {
                      i5 = i3;
                      if (i2 >= paramMotionEvent.getTop())
                      {
                        i5 = i3;
                        if (i2 < paramMotionEvent.getBottom()) {
                          i5 = 1;
                        }
                      }
                    }
        ...
        else
        {
          ...
          for (i5 = i4; i5 < i3; i5++)
          {
            ...
            if (c(i4))
            {
              ...
              localObject = a((int)f3, (int)f2);
              if ((a((View)localObject, f4, f1)) && (b((View)localObject, i4))) {
                break;
              }
            }
          }
  ...
  public final boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    View localView = r;
    int i3 = a(paramInt3, (int)n, (int)m);
    paramInt3 = a(paramInt4, (int)n, (int)m);
    int i4 = Math.abs(paramInt1);
    paramInt4 = Math.abs(paramInt2);
    int i5 = Math.abs(i3);
    int i6 = Math.abs(paramInt3);
    int i7 = i5 + i6;
    int i8 = i4 + paramInt4;
    if (i3 != 0)
    {
    ...
    float f1 = f2 / f1;
    paramInt4 = b(paramInt1, i3, q.a(localView));
    paramInt3 = b(paramInt2, paramInt3, q.b(localView));
    float f2 = paramInt4;
    paramInt3 = (int)(paramInt3 * f1 + f2 * f3);
              ...
              for (i1 = 0; i1 < i3; i1++)
              {
                ...
                if (c(i4))
                {
                  ...
                  if (i2 != 0)
                  {
                    ...
                    int i6 = (int)f3;
                    i6 = q.a(localView, i5 + i6, i6);
                    int i7 = localView.getTop();
                    int i8 = (int)f4;
                    i8 = q.b(localView, i7 + i8, i8);
