    ...
    if (paramArrayOfByte != null)
    {
      ...
      if (paramArrayOfByte.length % 4 == 0)
      {
        ...
        if (k == 3)
        {
          ...
          i1 = n + 1;
          m = byteToBase64(paramArrayOfByte[n]);
          i2 = byteToBase64(paramArrayOfByte[i1]);
          n = i + 1;
          arrayOfByte[i] = ((byte)(byte)(j << 2 | m >> 4));
          arrayOfByte[n] = ((byte)(byte)(m << 4 | i2 >> 2));
        }
        if (k == 2)
        {
          i = byteToBase64(paramArrayOfByte[i1]);
          arrayOfByte[n] = ((byte)(byte)(byteToBase64(paramArrayOfByte[(i1 + 1)]) >> 4 | i << 2));
        }
        return arrayOfByte;
      }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.proton.transport.ws.impl.Base64
