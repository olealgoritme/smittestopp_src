  ...
  implements Closeable
{
  ...
  private void notifyNetworkStateUpdated(boolean paramBoolean)
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      ((Listener)((Iterator)localObject).next()).onNetworkStateUpdated(paramBoolean);
    }
  }
  ...
  public void reopen()
  {
    try
    {
      ...
      ConnectivityManager.NetworkCallback local1 = new com/microsoft/appcenter/utils/NetworkStateHelper$1;
      local1.<init>(this);
    ...
    extends BroadcastReceiver
  {
    ...
    {
      NetworkStateHelper.access$300(NetworkStateHelper.this);
    }
  }
  
  public static abstract interface Listener
  {
    public abstract void onNetworkStateUpdated(boolean paramBoolean);
  }
}

/* Location:
 * Qualified Name:     com.microsoft.appcenter.utils.NetworkStateHelper
