  ...
  public void onTaskCompleted(Boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if ((val$config.getAccountMode() != AccountMode.SINGLE) && (!paramBoolean.booleanValue()))
      {
        ...
        localObject = new com/microsoft/identity/client/MultipleAccountPublicClientApplication;
        ((MultipleAccountPublicClientApplication)localObject).<init>(val$config);
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.client.PublicClientApplication.2
