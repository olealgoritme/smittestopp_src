  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   133: astore 5
    //   135: aload 5
    //   137: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   140: aload 5
    //   142: invokestatic 109	com/microsoft/identity/common/internal/controllers/CommandDispatcher:access$400	()Ljava/lang/String;
    ...
    //   162: ldc 118
    //   164: aload_3
    //   165: invokestatic 124	com/microsoft/identity/common/internal/logging/Logger:errorPII	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   168: aload_3
    //   169: instanceof 126
    //   172: ifeq +11 -> 183
    //   175: aload_3
    //   176: checkcast 126	com/microsoft/identity/common/exception/BaseException
    //   179: astore_3
    //   180: goto +8 -> 188
    //   183: aload_3
    ...
    //   129	47	3	localException	Exception
    //   179	167	3	localBaseException	BaseException
    //   70	15	4	locala	a
    //   75	199	5	localObject4	Object
    // Exception table:
    //   from	to	target	type
    //   66	109	125	finally
    //   130	180	125	finally
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.controllers.CommandDispatcher.3
