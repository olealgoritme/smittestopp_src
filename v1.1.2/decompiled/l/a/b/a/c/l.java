  ...
  implements k0
{
  ...
  public l a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt <= f))
    {
      ...
      if (m >= 0) {
        while (m > 0)
        {
          ...
          if ((n != -1) && (n < a.size() - 1))
          {
            ...
            n = b + 1;
            b = n;
            c = ((byte[])((ArrayList)localObject).get(n));
            d = 0;
          }
          else
          {
      ...
      while (m > 0)
      {
        ...
        n = b - 1;
        b = n;
        localObject = (byte[])((ArrayList)localObject).get(n);
        c = ((byte[])localObject);
    ...
    if ((paramInt1 | paramInt2) >= 0)
    {
      if (paramInt1 + paramInt2 <= m)
      {
        if (paramInt2 <= c())
        {
          ...
          while (m > 0)
          {
            n = Math.min(c.length - d, m);
            System.arraycopy(c, d, paramArrayOfByte, paramInt1 + paramInt2, n);
            d += n;
            m -= n;
            paramInt2 += n;
            p();
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((!o()) && (m > c.length - d))
    {
      ...
      try
      {
        for (n = ((k0)paramObject).position(); b(); n++)
        {
          i1 = get();
          i2 = ((k0)paramObject).get(n);
          if (i1 == i2) {
            i1 = 1;
          } else {
            i1 = 0;
    ...
    byte[] arrayOfByte = c;
    int i2 = d;
    int i1 = ((k0)paramObject).position();
    for (int n = 0;; n++)
    {
      bool2 = bool1;
      if (n >= m) {
      ...
      if (arrayOfByte[(i2 + n)] != ((k0)paramObject).get(i1 + n))
      {
        bool2 = false;
        break;
      }
  ...
  public long f()
  {
    if (c() >= 8)
    {
      ...
      if (m - n >= 8)
      {
        m = n + 1;
        d = m;
        l1 = arrayOfByte[n] & 0xFF;
        n = m + 1;
        d = n;
        long l2 = arrayOfByte[m] & 0xFF;
        m = n + 1;
        d = m;
        long l3 = arrayOfByte[n] & 0xFF;
        int i1 = m + 1;
        d = i1;
        l4 = arrayOfByte[m] & 0xFF;
        n = i1 + 1;
        d = n;
        long l5 = arrayOfByte[i1] & 0xFF;
        m = n + 1;
        d = m;
        long l6 = arrayOfByte[n] & 0xFF;
        n = m + 1;
        d = n;
        long l7 = arrayOfByte[m] & 0xFF;
        d = (n + 1);
        l4 = l1 << 56 | l2 << 48 | l3 << 40 | l4 << 32 | l5 << 24 | l6 << 16 | l7 << 8 | (arrayOfByte[n] & 0xFF) << 0;
        p();
      }
      else
      {
  ...
  public byte get(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < f))
    {
      ...
      else
      {
        ...
        int i1 = paramInt - m;
        for (paramInt = i3; i1 >= 0; paramInt = 0)
        {
          if (i1 < localObject.length - paramInt)
          {
            paramInt = localObject[(paramInt + i1)];
            n = paramInt;
            break label229;
          }
          i1 -= localObject.length - paramInt;
          localObject = a;
          i2++;
          localObject = (byte[])((ArrayList)localObject).get(i2);
        }
        paramInt = 0;
        n = paramInt;
      }
  ...
  public int h()
  {
    if (c() >= 4)
    {
      ...
      if (m - n >= 4)
      {
        ...
        i2 = arrayOfByte[i2];
        d = (n + 1);
        i1 = (arrayOfByte[n] & 0xFF) << 0 | (m & 0xFF) << 16 | (i1 & 0xFF) << 24 | (i2 & 0xFF) << 8;
        p();
      }
      else
      {
