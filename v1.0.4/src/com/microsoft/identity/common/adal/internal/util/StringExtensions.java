...
public final class StringExtensions
{
  ...
  public static HashMap<String, String> getUrlParameters(String paramString)
  {
    ...
    if (!HashMapExtensions.urlFormDecode(paramString.getFragment()).isEmpty())
    {
      Logger.warn(TAG, "Received url contains unexpected fragment parameters.");
      String str = TAG;
      StringBuilder localStringBuilder = a.a("Unexpected fragment: ");
      localStringBuilder.append(paramString.getFragment());
      Logger.warnPII(str, localStringBuilder.toString());
    }
    return HashMapExtensions.urlFormDecode(paramString.getEncodedQuery());
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.adal.internal.util.StringExtensions
