  ...
  public void launchIntent(Intent paramIntent)
  {
    ...
    if (localFragment != null)
    {
      ...
      if (localObject != null)
      {
        ...
        ((y)localObject).a(localFragment.getId(), paramIntent, AuthorizationFragment.class.getName(), 1);
        ((y)localObject).a();
        return;
      }
      throw null;
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.providers.oauth2.AuthorizationStrategy
