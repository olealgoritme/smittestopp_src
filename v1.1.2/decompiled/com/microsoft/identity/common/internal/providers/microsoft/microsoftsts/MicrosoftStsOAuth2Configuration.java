  ...
  extends AzureActiveDirectoryOAuth2Configuration
{
  ...
  private URL getEndpointUrlFromAuthority(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      localStringBuilder.append(":getEndpointUrlFromAuthority");
      Logger.error(localStringBuilder.toString(), "Unable to create URL from provided authority.", null);
      String str = a.a(new StringBuilder(), TAG, ":getEndpointUrlFromAuthority");
      localStringBuilder = new StringBuilder();
      localStringBuilder.append(localException.getMessage());
      localStringBuilder.append(" Unable to create URL from provided authority. authority = ");
      localStringBuilder.append(paramString);
      Logger.errorPII(str, localStringBuilder.toString(), localException);
    }
    return null;
  }
  ...
  private URL getEndpointUrlFromRootAndSuffix(URL paramURL, String paramString)
  {
    ...
    catch (Exception localException)
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(TAG);
      localStringBuilder.append(":getEndpointUrlFromRootAndSuffix");
      Logger.error(localStringBuilder.toString(), "Unable to create URL from provided root and suffix.", null);
      String str = a.a(new StringBuilder(), TAG, ":getEndpointUrlFromRootAndSuffix");
      localStringBuilder = new StringBuilder();
      localStringBuilder.append(localException.getMessage());
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.providers.microsoft.microsoftsts.MicrosoftStsOAuth2Configuration
