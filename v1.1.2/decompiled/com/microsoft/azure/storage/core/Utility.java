...
public final class Utility
{
  ...
  public static ThreadLocal<DateFormat> RFC1123_GMT_DATE_TIME_FORMATTER = new ThreadLocal()
  {
  ...
  static
  {
    ...
    saxParserThreadLocal = new ThreadLocal()
    {
  ...
  public static e.b.a.a.i getJsonParser(InputStream paramInputStream)
  {
    ...
    if (locala.b(4))
    {
      paramInputStream = c;
      int m = d;
      n = paramInputStream[m];
      int i1 = paramInputStream[(m + 1)];
      i2 = m + 2;
      int i3 = paramInputStream[i2];
      i4 = m + 3;
      n = paramInputStream[i4] & 0xFF | (i3 & 0xFF) << 8 | n << 24 | (i1 & 0xFF) << 16;
      if (n != -16842752)
      {
        if (n != -131072)
        {
    ...
    else
    {
      ...
      paramInputStream = c;
      n = d;
      i4 = paramInputStream[n];
      i2 = i;
      if (!locala.a(paramInputStream[(n + 1)] & 0xFF | (i4 & 0xFF) << 8)) {
        break label499;
      }
    }
    int i2 = 1;
  ...
  public static void logHttpRequest(HttpURLConnection paramHttpURLConnection, OperationContext paramOperationContext)
  {
    ...
    try
    {
      ...
      localStringBuilder.append("\n");
      paramHttpURLConnection = paramHttpURLConnection.getRequestProperties().entrySet().iterator();
      while (paramHttpURLConnection.hasNext())
      {
        ...
        for (int i = 0; i < ((List)localEntry.getValue()).size(); i++)
        {
          localStringBuilder.append((String)((List)localEntry.getValue()).get(i));
          if (i < ((List)localEntry.getValue()).size() - 1) {
            localStringBuilder.append(",");
          }
        }
        localStringBuilder.append('\n');
  ...
  public static String safeRelativize(URI paramURI1, URI paramURI2)
  {
    ...
    {
      paramURI1 = paramURI1.getPath();
      String str = paramURI2.getPath();
      int i = 0;
      int j = 0;
      int m;
      for (int k = 1; i < paramURI1.length(); k = n)
      {
        if (i >= str.length())
        {
          m = j;
        ...
        {
          if (paramURI1.charAt(i) != str.charAt(i)) {
            break;
          }
          m = j;
          n = k;
      ...
      if (!isNullOrEmpty(str)) {
        paramURI1.append(str);
      }
      if (!isNullOrEmpty(paramURI2.getQuery()))
      {
        paramURI1.append("?");
        paramURI1.append(paramURI2.getQuery());
      }
      if (!isNullOrEmpty(paramURI2.getFragment()))
      {
        paramURI1.append("#");
        paramURI1.append(paramURI2.getRawFragment());
      }
      return paramURI1.toString();
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.core.Utility
