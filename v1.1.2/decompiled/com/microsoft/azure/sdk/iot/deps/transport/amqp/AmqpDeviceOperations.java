...
public class AmqpDeviceOperations
{
  ...
  public Map<l.a.b.a.b.f, Object> amqpProperties = new HashMap();
  ...
  {
    amqpProperties.put(l.a.b.a.b.f.a(paramString1), paramString2);
  }
  ...
  public void initLink(n paramn)
  {
    ...
    //   19: ifeq +35 -> 54
    //   22: new 79	l/a/b/a/b/k/v
    //   25: astore_2
    //   26: aload_2
    //   27: invokespecial 80	l/a/b/a/b/k/v:<init>	()V
    //   30: aload_2
    //   31: aload_0
    //   32: getfield 82	com/microsoft/azure/sdk/iot/deps/transport/amqp/AmqpDeviceOperations:amqpLinkAddress	Ljava/lang/String;
    //   35: putfield 86	l/a/b/a/b/k/w:a	Ljava/lang/String;
    //   38: aload_1
    //   39: aload_2
    //   40: invokeinterface 89 2 0
    //   45: aload_1
    //   46: getstatic 95	l/a/b/a/b/n/p:UNSETTLED	Ll/a/b/a/b/n/p;
    ...
    //   0	155	1	paramn	n
    //   25	63	2	localObject	Object
    //   100	22	2	localException	Exception
  ...
  public void openLinks(y paramy)
  {
    if (paramy != null) {
      try
      {
        t localt = paramy.c(receiverLinkTag);
        receiverLink = localt;
        localt.a(amqpProperties);
        receiverLink.open();
        paramy = paramy.b(senderLinkTag);
        senderLink = paramy;
            ...
            if (locale != null)
            {
              ...
              if (locale.D())
              {
                ...
                if (!locale.P())
                {
                  ...
                  i = receiverLink.a(paramString, 0, i);
                  receiverLink.d();
  ...
  public void sendMessage(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2)
  {
    ...
    senderLink.b(paramArrayOfByte2, paramInt2, paramInt1);
    senderLink.d();
  }
}

/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.deps.transport.amqp.AmqpDeviceOperations
