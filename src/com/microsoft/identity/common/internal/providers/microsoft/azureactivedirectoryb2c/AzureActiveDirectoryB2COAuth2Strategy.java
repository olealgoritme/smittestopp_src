...
public class AzureActiveDirectoryB2COAuth2Strategy
  extends OAuth2Strategy
{
  public AzureActiveDirectoryB2COAuth2Strategy(OAuth2Configuration paramOAuth2Configuration, OAuth2StrategyParameters paramOAuth2StrategyParameters)
  {
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.providers.microsoft.azureactivedirectoryb2c.AzureActiveDirectoryB2COAuth2Strategy
