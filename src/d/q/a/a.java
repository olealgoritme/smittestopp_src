...
public final class a
{
  ...
  public final HashMap<BroadcastReceiver, ArrayList<a.c>> b = new HashMap();
  public final HashMap<String, ArrayList<a.c>> c = new HashMap();
  ...
  {
    a = paramContext;
    e = new a.a(this, paramContext.getMainLooper());
  }
  ...
  public boolean a(Intent paramIntent)
  {
    synchronized (b)
    {
      ...
      if (localArrayList != null)
      {
        ...
        {
          Object localObject4 = (a.c)localArrayList.get(j);
          if (i != 0)
          {
            localObject2 = new java/lang/StringBuilder;
            ((StringBuilder)localObject2).<init>();
        ...
        if (localObject3 != null)
        {
          ...
          ((a.b)localObject1).<init>(paramIntent, (ArrayList)localObject3);
