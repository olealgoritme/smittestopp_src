...
public class o
{
  ...
  public static j a(Object paramObject)
  {
    ...
    {
      List localList = (List)b.get(localObject);
      int i = localList.size();
      int j = 0;
      if (i == 1) {
        return new SingleGeneratedAdapterObserver(a((Constructor)localList.get(0), paramObject));
      }
      localObject = new e[localList.size()];
      while (j < localList.size())
      {
        localObject[j] = a((Constructor)localList.get(j), paramObject);
        j++;
      }
      return new CompositeGeneratedAdaptersObserver((e[])localObject);
    }
