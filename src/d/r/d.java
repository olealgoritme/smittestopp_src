  ...
  implements Closeable
{
  ...
  public static void a(Context paramContext, String paramString, long paramLong1, long paramLong2, List<d.a> paramList)
  {
    ...
    {
      localObject = (d.a)paramList.next();
  ...
  public static void a(ZipFile paramZipFile, ZipEntry paramZipEntry, File paramFile, String paramString)
  {
    ...
    //   58	51	5	localObject2	Object
    //   63	11	6	localFileOutputStream	java.io.FileOutputStream
    //   124	23	7	i	int
  ...
  public static long b(File paramFile)
  {
    ...
    try
    {
      Object localObject1 = r.a(paramFile);
    ...
    try
    {
      ...
      while (localObject1 != null)
      {
        ...
        else
        {
          ...
          ((StringBuilder)localObject1).append(i);
          ((StringBuilder)localObject1).append(")");
          ((IOException)localObject4).<init>(((StringBuilder)localObject1).toString());
  ...
  public final List<d.a> a(Context paramContext, String paramString)
  {
    ...
    localObject1 = paramContext.getSharedPreferences("multidex.version", 4);
    paramContext = new StringBuilder();
    paramContext.append(paramString);
    paramContext.append("dex.number");
    int i = ((SharedPreferences)localObject1).getInt(paramContext.toString(), 1);
    ArrayList localArrayList = new ArrayList(i - 1);
    int j = 2;
    paramContext = (Context)localObject2;
    while (j <= i)
    {
      localObject2 = a.b(paramContext, j, ".zip");
      localObject2 = new d.a(z, (String)localObject2);
      if (((File)localObject2).isFile())
      {
        x = b((File)localObject2);
        StringBuilder localStringBuilder = new StringBuilder();
        localStringBuilder.append(paramString);
        localStringBuilder.append("dex.crc.");
        localStringBuilder.append(j);
        long l1 = ((SharedPreferences)localObject1).getLong(localStringBuilder.toString(), -1L);
        localStringBuilder = new StringBuilder();
        localStringBuilder.append(paramString);
        localStringBuilder.append("dex.time.");
        localStringBuilder.append(j);
        long l2 = ((SharedPreferences)localObject1).getLong(localStringBuilder.toString(), -1L);
        long l3 = ((File)localObject2).lastModified();
        if ((l2 == l3) && (l1 == x))
        {
