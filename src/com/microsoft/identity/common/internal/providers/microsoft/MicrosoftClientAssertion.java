  ...
  extends ClientAssertion
{
  ...
  public MicrosoftClientAssertion(String paramString, CertificateCredential paramCertificateCredential)
  {
    ...
    {
      setClientAssertion(createSignedJwt(paramCertificateCredential.getClientId(), paramString, paramCertificateCredential).b());
  ...
  private e createSignedJwt(String paramString1, String paramString2, CertificateCredential paramCertificateCredential)
  {
    ...
    paramString2 = new e.e.b.c((Map)localObject1, null);
    try
    {
      localObject1 = l.C;
      Object localObject2;
      ...
      if (!x.equals(yx))
      {
        ...
        localObject3 = paramCertificateCredential.getPublicCertificate();
      }
      try
      {
        localObject2 = createSHA1ThumbPrint((X509Certificate)localObject3);
        localObject3 = new e/e/b/e;
        m localm = new e/e/a/m;
        localm.<init>((l)localObject1, null, null, null, null, null, null, (e.e.a.v.c)localObject2, null, paramString1, null, null, null);
        ((e)localObject3).<init>(localm, paramString2);
        paramString1 = new e/e/a/s/a;
        paramString1.<init>(paramCertificateCredential.getPrivateKey());
        ((n)localObject3).b(paramString1);
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.providers.microsoft.MicrosoftClientAssertion
