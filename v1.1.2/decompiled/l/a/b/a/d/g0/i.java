  ...
  implements b0
{
  ...
  public final h a;
  public final l.a.b.a.c.i b;
  public final int c;
  public final int d;
  public final a0 e;
  public ByteBuffer f = null;
  public boolean g = false;
  public a h = a.HEADER0;
  public long i = 0L;
  public int j;
  public ByteBuffer k;
  public l.a.b.a.e.a l;
  
  public i(h paramh, l.a.b.a.c.i parami, int paramInt, a0 parama0)
  {
    a = paramh;
    b = parami;
    d = paramInt;
  ...
  public final void a(ByteBuffer paramByteBuffer)
  {
    ...
    label2236:
    Object localObject6;
    while ((((ByteBuffer)localObject4).hasRemaining()) && (paramByteBuffer != a.ERROR) && (i2 != 0))
    {
      ...
      case 0: 
        if (((ByteBuffer)localObject4).hasRemaining())
        {
          ...
          if (b1 != b.a[0])
          {
            ...
            paramByteBuffer = a.ERROR;
          }
          else
          {
            localObject7 = a.HEADER1;
          }
        }
        break;
      case 1: 
      ...
      case 14: 
        for (;;)
        {
          ...
          if (!((ByteBuffer)localObject4).hasRemaining())
          {
            paramByteBuffer = a.SIZE_3;
            localObject1 = localObject2;
          }
          else
          {
            i6 = i5 | ((ByteBuffer)localObject4).get() & 0xFF;
            localObject15 = a.PRE_PARSE;
            if (i6 < 8)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (k != null)
                  {
                    ...
                    k.flip();
                    localObject1 = k;
                    paramByteBuffer = a.PARSING;
                    localObject17 = localObject4;
                    i8 = i7;
                  }
                  i7 = ((ByteBuffer)localObject1).get() << 2 & 0x3FF;
                  if (i7 < 8)
                  {
                    localObject3 = new d0("specified frame data offset %d smaller than minimum frame header size %d", new Object[] { Integer.valueOf(i7), Integer.valueOf(8) });
                    paramByteBuffer = a.ERROR;
                  ...
                  {
                    localObject3 = new d0("specified frame data offset %d larger than the frame size %d", new Object[] { Integer.valueOf(i7), Integer.valueOf(i8) });
                    paramByteBuffer = a.ERROR;
                    localObject4 = localObject1;
                    i1 = i8;
                    localObject1 = localObject3;
                  ...
                  else
                  {
                    ...
                    if (i1 != 0)
                    {
                      localObject3 = new d0("unknown frame type: %d", new Object[] { Integer.valueOf(i1) });
                      paramByteBuffer = a.ERROR;
                      localObject4 = localObject1;
                      i1 = i8;
                      localObject1 = localObject3;
                    ...
                    {
                      if (i7 != 8) {
                        ((ByteBuffer)localObject1).position(((ByteBuffer)localObject1).position() + i7 - 8);
                      }
                      i7 = i8 - i7;
                      ...
                      try
                      {
                        ...
                        if (i7 > 0)
                        {
                          ...
                          if (((ByteBuffer)localObject1).hasRemaining())
                          {
                            ...
                            i1 = i2;
                            localObject17 = new l/a/b/a/b/a;
                            i1 = i2;
                            ((l.a.b.a.b.a)localObject17).<init>((byte[])localObject4);
                            localObject4 = localObject3;
                            localObject3 = localObject17;
                            break label1748;
                          }
                        ...
                        if ((localObject4 instanceof l))
                        {
                          ...
                          if (m.isLoggable(Level.FINE))
                          {
                            ...
                            i1 = i2;
                            ((Logger)localObject10).log((Level)localObject8, ((StringBuilder)localObject15).toString());
                          }
                          i1 = i2;
                          localObject4 = new l/a/b/a/e/a;
                          i1 = i2;
                          ((l.a.b.a.e.a)localObject4).<init>(i6, (l)localObject17, (l.a.b.a.b.a)localObject3);
                          i1 = i2;
                          localObject3 = a;
                          localObject3 = (a0)localObject3;
                          i1 = i2;
                          if (((a0)localObject3).X())
                          {
                            i1 = i2;
                            localObject3 = a;
                            localObject3 = (a0)localObject3;
                            i1 = i2;
                            g = ((a0)localObject3).a((l.a.b.a.e.a)localObject4);
                          }
                          try
                          {
                            l = ((l.a.b.a.e.a)localObject4);
                            i2 = 0;
                            i1 = i2;
                            j = 0;
                            i1 = i2;
                        ...
                        localObject17 = new l/a/b/a/d/d0;
                        i1 = i2;
                        localObject3 = new java/lang/StringBuilder;
                        i1 = i2;
                        ((StringBuilder)localObject3).<init>();
                        i1 = i2;
                        ((StringBuilder)localObject3).append("Frameparser encountered a ");
                        Object localObject5;
                        if (localq2 == null)
                        {
                          localObject5 = "null";
                        ...
                        i1 = i2;
                        ((StringBuilder)localObject3).append(" which is not a ");
                        i1 = i2;
                        ((StringBuilder)localObject3).append(l.class);
                        i1 = i2;
                        ((d0)localObject17).<init>(((StringBuilder)localObject3).toString());
                        i1 = i2;
    ...
    if (g) {
      ...
      {
        localObject1 = a.ERROR;
        localObject3 = new d0("framing error");
      }
      else if (paramByteBuffer != a.SIZE_0)
      {
        localObject1 = a.ERROR;
  ...
  public void process()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnull +122 -> 128
    //   9: aload_1
    //   10: invokevirtual 230	java/nio/ByteBuffer:flip	()Ljava/nio/Buffer;
    //   13: pop
    //   14: aload_0
    //   15: aload_0
    //   16: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   19: invokevirtual 343	l/a/b/a/d/g0/i:a	(Ljava/nio/ByteBuffer;)V
    //   22: aload_0
    //   23: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   26: invokevirtual 99	java/nio/ByteBuffer:hasRemaining	()Z
    //   29: ifeq +14 -> 43
    //   32: aload_0
    //   33: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   36: invokevirtual 346	java/nio/ByteBuffer:compact	()Ljava/nio/ByteBuffer;
    //   39: pop
    //   40: goto +95 -> 135
    //   43: aload_0
    //   44: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   47: invokevirtual 348	java/nio/ByteBuffer:capacity	()I
    //   50: getstatic 351	l/a/b/a/d/g0/a0:B0	I
    //   53: if_icmple +11 -> 64
    //   56: aload_0
    //   57: aconst_null
    //   58: putfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   61: goto +74 -> 135
    //   64: aload_0
    //   65: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   68: invokevirtual 354	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   71: pop
    //   72: goto +63 -> 135
    //   75: astore_1
    //   76: aload_0
    //   77: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   80: invokevirtual 99	java/nio/ByteBuffer:hasRemaining	()Z
    //   83: ifne +35 -> 118
    //   86: aload_0
    //   87: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   90: invokevirtual 348	java/nio/ByteBuffer:capacity	()I
    //   93: getstatic 351	l/a/b/a/d/g0/a0:B0	I
    //   96: if_icmple +11 -> 107
    //   99: aload_0
    //   100: aconst_null
    //   101: putfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   104: goto +22 -> 126
    //   107: aload_0
    //   108: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   111: invokevirtual 354	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   114: pop
    //   115: goto +11 -> 126
    //   118: aload_0
    //   119: getfield 59	l/a/b/a/d/g0/i:f	Ljava/nio/ByteBuffer;
    //   122: invokevirtual 346	java/nio/ByteBuffer:compact	()Ljava/nio/ByteBuffer;
    //   125: pop
    //   126: aload_1
    //   127: athrow
    //   128: aload_0
    //   129: getstatic 52	l/a/b/a/d/g0/i:n	Ljava/nio/ByteBuffer;
    //   132: invokevirtual 343	l/a/b/a/d/g0/i:a	(Ljava/nio/ByteBuffer;)V
    //   135: return
