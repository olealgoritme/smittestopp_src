  ...
  public AcquireTokenResult execute()
  {
    ...
    while (i < getControllers().size())
    {
      ...
      try
      {
        ...
        localAcquireTokenResult2 = localAcquireTokenResult1;
        localAcquireTokenResult3 = localAcquireTokenResult1;
        Logger.verbose((String)localObject3, ((StringBuilder)localObject2).toString());
        localAcquireTokenResult2 = localAcquireTokenResult1;
        localAcquireTokenResult3 = localAcquireTokenResult1;
        ...
        localAcquireTokenResult2 = localAcquireTokenResult1;
        localAcquireTokenResult3 = localAcquireTokenResult1;
        ((StringBuilder)localObject3).append("Executing with controller: ");
        localAcquireTokenResult2 = localAcquireTokenResult1;
        localAcquireTokenResult3 = localAcquireTokenResult1;
        ((StringBuilder)localObject3).append(localBaseController.getClass().getSimpleName());
        localAcquireTokenResult2 = localAcquireTokenResult1;
        localAcquireTokenResult3 = localAcquireTokenResult1;
        ((StringBuilder)localObject3).append(": Succeeded");
        localAcquireTokenResult2 = localAcquireTokenResult1;
        localAcquireTokenResult3 = localAcquireTokenResult1;
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.controllers.TokenCommand
