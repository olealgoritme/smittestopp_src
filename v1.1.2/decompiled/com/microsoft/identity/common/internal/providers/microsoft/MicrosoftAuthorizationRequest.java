  ...
  extends AuthorizationRequest<T>
{
  ...
  public MicrosoftAuthorizationRequest(Builder paramBuilder)
  {
    super(paramBuilder);
    ...
    if (Builder.access$100(paramBuilder) != null) {
      mSlice = Builder.access$100(paramBuilder);
    }
    mFlightParameters = Builder.access$200(paramBuilder);
    mMultipleCloudAware = Builder.access$300(paramBuilder);
    mLibraryVersion = Builder.access$400(paramBuilder);
    mLibraryName = Builder.access$500(paramBuilder);
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.providers.microsoft.MicrosoftAuthorizationRequest
