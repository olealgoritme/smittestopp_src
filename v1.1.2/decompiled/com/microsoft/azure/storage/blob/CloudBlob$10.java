  ...
  extends StorageRequest<CloudBlobClient, CloudBlob, Integer>
{
  ...
  public HttpURLConnection buildRequest(CloudBlobClient paramCloudBlobClient, CloudBlob paramCloudBlob, OperationContext paramOperationContext)
  {
    ...
    return BlobRequest.getBlob(localURI, localBlobRequestOptions, paramOperationContext, paramCloudBlobClient, paramCloudBlob, localLong1, localLong2, bool);
  }
  ...
  public Integer postProcessResponse(HttpURLConnection paramHttpURLConnection, CloudBlob paramCloudBlob, CloudBlobClient paramCloudBlobClient, OperationContext paramOperationContext, Integer paramInteger)
  {
    ...
    //   117	47	11	localHashMap	java.util.HashMap
  ...
  public void recoveryAction(OperationContext paramOperationContext)
  {
    ...
    {
      paramOperationContext = new AccessCondition();
      paramOperationContext.setIfMatch(getLockedETag());
      AccessCondition localAccessCondition = val$accessCondition;
      if (localAccessCondition != null) {
        paramOperationContext.setLeaseID(localAccessCondition.getLeaseID());
      }
      setETagLockCondition(paramOperationContext);
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.blob.CloudBlob.10
