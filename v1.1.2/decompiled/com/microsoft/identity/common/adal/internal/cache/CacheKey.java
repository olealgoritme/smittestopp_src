  ...
  implements Serializable
{
  ...
  public String toString()
  {
    ...
    if (bool)
    {
      ...
      return String.format((Locale)localObject1, "%s$%s$%s$%s$%s", new Object[] { str2, str3, localObject2, str1, mUserId });
    }
    ...
    return String.format((Locale)localObject2, "%s$%s$%s$%s$%s$%s", new Object[] { str3, str2, localObject1, str1, mUserId, mFamilyClientId });
  }
}

/* Location:
 * Qualified Name:     com.microsoft.identity.common.adal.internal.cache.CacheKey
