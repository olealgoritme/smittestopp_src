  ...
  public static void addMetadata(HttpURLConnection paramHttpURLConnection, Map<String, String> paramMap, OperationContext paramOperationContext)
  {
    if (paramMap != null)
    {
      ...
      while (paramMap.hasNext())
      {
        ...
        addMetadata(paramHttpURLConnection, (String)localEntry.getKey(), (String)localEntry.getValue(), paramOperationContext);
      }
    }
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.core.BaseRequest
