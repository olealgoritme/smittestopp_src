  ...
  implements Collection<E>, Set<E>
{
  ...
  public boolean add(E paramE)
  {
    ...
    if (m >= x.length)
    {
      ...
      a((int[])localObject, arrayOfObject, z);
    }
    m = z;
    if (k < m)
    {
      ...
      localObject = y;
      System.arraycopy(localObject, k, localObject, i, z - k);
    }
    x[k] = j;
    y[k] = paramE;
    z += 1;
  ...
  public E b(int paramInt)
  {
    ...
    else
    {
      ...
      if ((j > 8) && (i < localObject.length / 3))
      {
        ...
        if (paramInt > 0)
        {
          System.arraycopy(localObject, 0, x, 0, paramInt);
          System.arraycopy(arrayOfObject, 0, y, 0, paramInt);
        }
        k = z;
        if (paramInt < k)
        {
          i = paramInt + 1;
          System.arraycopy(localObject, i, x, paramInt, k - paramInt);
          System.arraycopy(arrayOfObject, i, y, paramInt, z - paramInt);
        }
      }
      else
      {
        ...
        if (paramInt < k)
        {
          localObject = x;
          i = paramInt + 1;
          System.arraycopy(localObject, i, localObject, paramInt, k - paramInt);
          localObject = y;
          System.arraycopy(localObject, i, localObject, paramInt, z - paramInt);
        }
        y[z] = null;
      }
    }
