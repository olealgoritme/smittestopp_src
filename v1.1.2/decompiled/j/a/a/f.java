...
public class f
{
  ...
  static
  {
    ...
    for (int j = 0;; j++)
    {
      if (j >= i)
      {
        localObject1 = DateFormatSymbols.getAvailableLocales();
        ...
        if ((!"ja".equals(((Locale)localObject2).getLanguage())) && (!"ko".equals(((Locale)localObject2).getLanguage())) && (!"zh".equals(((Locale)localObject2).getLanguage())))
        {
          localObject2 = DateFormatSymbols.getInstance((Locale)localObject2);
          arrayOfString = ((DateFormatSymbols)localObject2).getMonths();
        }
        for (i = 0;; i++)
        {
          if (i >= arrayOfString.length)
          {
            Object localObject3 = ((DateFormatSymbols)localObject2).getShortMonths();
            for (i = 0;; i++)
            {
              if (i >= localObject3.length)
              {
                arrayOfString = ((DateFormatSymbols)localObject2).getWeekdays();
                for (i = 0;; i++)
                {
                  if (i >= arrayOfString.length)
                  {
                    localObject2 = ((DateFormatSymbols)localObject2).getShortWeekdays();
                    for (i = 0;; i++)
                    {
                  ...
                  {
                    a(b, (String)localObject3, Integer.valueOf(i));
                    a(b, ((String)localObject3).replace(".", ""), Integer.valueOf(i));
                  }
                }
              }
              arrayOfString = localObject3[i];
              if ((arrayOfString.length() != 0) && (!Character.isDigit(arrayOfString.charAt(arrayOfString.length() - 1))))
              {
                a(a, localObject3[i], Integer.valueOf(i));
                a(a, localObject3[i].replace(".", ""), Integer.valueOf(i));
              }
            }
          }
      ...
      d.put(localObject2, TimeZone.getTimeZone((String)localObject2));
    }
  }
