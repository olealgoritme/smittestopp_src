...
public class CloudBlob$13
  extends StorageRequest<CloudBlobClient, CloudBlob, Void>
{
  public CloudBlob$13(CloudBlob paramCloudBlob, RequestOptions paramRequestOptions, StorageUri paramStorageUri, BlobRequestOptions paramBlobRequestOptions, AccessCondition paramAccessCondition)
  {
  ...
  {
    return BlobRequest.leaseBlob(paramCloudBlob.getTransformedAddress(paramOperationContext).getUri(getCurrentLocation()), val$options, paramOperationContext, val$accessCondition, LeaseAction.RENEW, null, null, null);
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.CloudBlob.13
