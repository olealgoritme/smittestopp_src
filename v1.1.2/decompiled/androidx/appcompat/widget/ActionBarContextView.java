  ...
  extends d.b.e.a
{
  ...
  public void a(final d.b.d.a parama)
  {
    ...
    H.findViewById(R.id.action_mode_close_button).setOnClickListener(new a(parama));
    localObject = (h)parama.c();
    parama = A;
    if (parama != null) {
      parama.a();
    }
    ...
    if (localObject == null)
    {
      localp = (p)A.inflate(C, this, false);
      E = localp;
      localp.a(z);
      localc.a(true);
    }
    ...
    if (localObject != localp) {
      ((ActionMenuView)localp).setPresenter(localc);
    }
    localObject = (ActionMenuView)localp;
    z = ((ActionMenuView)localObject);
    n.a((View)localObject, null);
    addView(z, parama);
  }
    ...
    if (localObject != null)
    {
      ...
      if (I == null)
      {
        ...
        if (((LinearLayout)localObject).getVisibility() != 8) {
          paramInt4 = paramInt2 + a(J, paramInt2, j, k, paramBoolean);
        }
      }
    }
    localObject = I;
    if (localObject != null) {
      a((View)localObject, paramInt4, j, k, paramBoolean);
    }
    if (paramBoolean) {
