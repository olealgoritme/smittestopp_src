  ...
  implements i.a.b.b, Serializable
{
  ...
  public static d a(i.a.b.d paramd)
  {
      ...
      if (f.a(e.c.a.a.b.l.c.d(paramd, "kty")) == f.z)
      {
        ...
        if (paramd.containsKey("oth"))
        {
          ...
          for (;;)
          {
            ...
            if ((localObject2 instanceof i.a.b.d))
            {
              localObject2 = (i.a.b.d)localObject2;
              localArrayList.add(new k.a(new e.e.a.v.c(e.c.a.a.b.l.c.d((i.a.b.d)localObject2, "r")), new e.e.a.v.c(e.c.a.a.b.l.c.d((i.a.b.d)localObject2, str)), new e.e.a.v.c(e.c.a.a.b.l.c.d((i.a.b.d)localObject2, "t"))));
            }
          }
        }
        try
  ...
  public i.a.b.d f()
  {
    ...
    if (z != null)
    {
      localObject1 = new ArrayList(z.size());
      localObject2 = z.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((ArrayList)localObject1).add(((e)((Iterator)localObject2).next()).identifier());
      }
      locald.put("key_ops", localObject1);
    }
    localObject1 = A;
    if (localObject1 != null) {
      locald.put("alg", x);
    ...
    if (F != null)
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((ArrayList)localObject2).add(nextx);
      }
      locald.put("x5c", localObject2);
    }
    return locald;
  }
