  ...
  extends AbstractErrorLog
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject != null) && (ManagedErrorLog.class == paramObject.getClass()))
    {
      ...
      Object localObject = (ManagedErrorLog)paramObject;
      paramObject = exception;
      if (paramObject != null ? !((Exception)paramObject).equals(exception) : exception != null) {
        return false;
      }
      paramObject = threads;
      localObject = threads;
...
/* Location:
 * Qualified Name:     com.microsoft.appcenter.crashes.ingestion.models.ManagedErrorLog
