  ...
  extends FilterInputStream
{
    ...
    if (paramInt != 10)
    {
      if (paramInt != 12)
      {
        if (paramInt != 30)
        {
          ...
          case 3: 
            ...
            if (j >= 1)
            {
              ...
              if (j != 0) {
                if (k.b.j.h.a.a(paramw1, paramArrayOfByte, 0, j) == j)
                {
        ...
        if ((j & 0x1) == 0)
        {
          ...
          paramInt = 0;
          while (j >= 8) {
            if (k.b.j.h.a.a(paramw1, paramArrayOfByte, 0, 8) == 8)
            {
  ...
  public static byte[] a(w1 paramw1, byte[][] paramArrayOfByte)
  {
    ...
    if (i < paramArrayOfByte.length)
    {
      ...
      k.b.j.h.a.a(paramw1, arrayOfByte2, 0, arrayOfByte2.length);
      return arrayOfByte2;
    }
    return paramw1.a();
  }
  ...
  public t a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (bool)
    {
      ...
      f localf = a((w1)localObject1);
      paramInt2 = b;
      Object localObject2 = new p[paramInt2];
      paramInt1 = i;
      while (paramInt1 != paramInt2)
      {
        localObject1 = localf.a(paramInt1);
        if ((localObject1 instanceof p))
        {
          localObject2[paramInt1] = ((p)localObject1);
          paramInt1++;
        }
        else
        {
  ...
  public t readObject()
  {
    ...
    if (m < 0)
    {
      if (k != 0)
      {
        ...
        return new i0(localIllegalArgumentException1).a();
      }
