...
public final class Base64
{
    ...
    if (paramArrayOfByte != null)
    {
      ...
      if (paramArrayOfByte.length % 4 == 0)
      {
        ...
        while (k >= 4)
        {
          ...
          j = i1 + 1;
          i1 = byteToBase64(paramArrayOfByte[i1]);
          i2 = byteToBase64(paramArrayOfByte[j]);
          int i3 = i + 1;
          arrayOfByte[i] = ((byte)(byte)(n << 2 | m >> 4));
          n = i3 + 1;
          arrayOfByte[i3] = ((byte)(byte)(m << 4 | i1 >> 2));
          i = n + 1;
          arrayOfByte[n] = ((byte)(byte)(i1 << 6 | i2));
          k -= 4;
          j++;
        }
        int n = j;
        ...
        if (k == 3)
        {
          ...
          n = i1 + 1;
          m = byteToBase64(paramArrayOfByte[i1]);
          i2 = byteToBase64(paramArrayOfByte[n]);
          i1 = i + 1;
          arrayOfByte[i] = ((byte)(byte)(j << 2 | m >> 4));
          arrayOfByte[i1] = ((byte)(byte)(m << 4 | i2 >> 2));
        }
        if (k == 2)
        {
          i = byteToBase64(paramArrayOfByte[n]);
          arrayOfByte[i1] = ((byte)(byte)(byteToBase64(paramArrayOfByte[(n + 1)]) >> 4 | i << 2));
        }
        return arrayOfByte;
      }
  ...
  public static byte[] encodeBase64Internal(byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte.length - i == 2)
    {
      ...
      m = paramArrayOfByte[i];
      j = i + 1;
      arrayOfByte[k] = base64ToByte((byte)(m << 4 & 0x3F | paramArrayOfByte[j] >> 4 & 0xF));
      k = n + 1;
      arrayOfByte[n] = base64d16ToByte((byte)(paramArrayOfByte[j] & 0xF));
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.deps.util.Base64
