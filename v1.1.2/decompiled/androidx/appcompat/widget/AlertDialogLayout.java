  ...
  extends g0
{
  ...
  private void b(int paramInt1, int paramInt2)
  {
    ...
    for (int j = 0; j < paramInt1; j++)
    {
      ...
      {
        g0.a locala = (g0.a)localView.getLayoutParams();
        if (width == -1)
        {
          int k = height;
    ...
    while (paramInt3 < n)
    {
      ...
      if (localObject != null)
      {
        ...
        if (((View)localObject).getVisibility() != 8)
        {
          ...
          g0.a locala = (g0.a)((View)localObject).getLayoutParams();
          int i4 = b;
          paramInt4 = i4;
          if (i4 < 0) {
          ...
          ((View)localObject).layout(paramInt4, paramInt1, i2 + paramInt4, i3 + paramInt1);
