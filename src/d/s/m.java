...
public final class m
{
    ...
    if (str != null)
    {
      ...
      else
      {
        if (!str.isEmpty()) {
          try
          {
            if ((str.startsWith(".")) && (localObject4 != null))
            {
  ...
  public final i a(Resources paramResources, XmlResourceParser paramXmlResourceParser, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((k == 2) && (m <= i))
      {
        ...
        {
          TypedArray localTypedArray = paramResources.obtainAttributes(paramAttributeSet, R.styleable.NavAction);
          m = localTypedArray.getResourceId(R.styleable.NavAction_android_id, 0);
          c localc = new c(localTypedArray.getResourceId(R.styleable.NavAction_destination, 0));
          b = new n(localTypedArray.getBoolean(R.styleable.NavAction_launchSingleTop, false), localTypedArray.getResourceId(R.styleable.NavAction_popUpTo, -1), localTypedArray.getBoolean(R.styleable.NavAction_popUpToInclusive, false), localTypedArray.getResourceId(R.styleable.NavAction_enterAnim, -1), localTypedArray.getResourceId(R.styleable.NavAction_exitAnim, -1), localTypedArray.getResourceId(R.styleable.NavAction_popEnterAnim, -1), localTypedArray.getResourceId(R.styleable.NavAction_popExitAnim, -1));
          localObject1 = new Bundle();
          k = paramXmlResourceParser.getDepth() + 1;
          int n;
          int i1;
          do
          {
          ...
          for (;;)
          {
            if (i1 <= k)
            {
              ...
              {
                localObject3 = paramResources.obtainAttributes(paramAttributeSet, R.styleable.NavArgument);
                String str = ((TypedArray)localObject3).getString(R.styleable.NavArgument_android_name);
                if (str != null)
                {
                  localObject2 = a((TypedArray)localObject3, paramResources, j);
                  boolean bool = c;
                  if ((bool) && (bool)) {
                    a.a((Bundle)localObject1, str, d);
                  }
  ...
  public j a(int paramInt)
  {
    ...
    //   18	126	4	localObject2	Object
    //   166	66	4	localException	Exception
    //   26	21	5	i	int
    //   55	172	6	localObject3	Object
    //   100	137	7	localObject4	Object
    // Exception table:
    //   from	to	target	type
    //   20	28	162	finally
    //   49	83	162	finally
