  ...
  extends SSLSocket
{
  ...
  public static final k.f.b log = k.f.c.a(ProxiedSSLSocket.class);
  ...
  private void doTunnelHandshake(Socket paramSocket, String paramString, int paramInt)
  {
    ...
    if ((proxyUsername != null) && (proxyPassword != null))
    {
      ...
      {
        k.a.a.a.b.b localb = new k.a.a.a.b.b(0, k.a.a.a.b.b.j, false);
    ...
    localObject2 = new ProxiedSSLSocket.HttpConnectResponseReader(this, paramSocket.getInputStream(), localCharset).readHttpConnectResponse().split("\r\n");
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.transport.ProxiedSSLSocket
