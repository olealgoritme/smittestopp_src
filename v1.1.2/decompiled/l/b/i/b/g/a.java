  ...
  implements Serializable
{
  ...
  public a(a parama, l.b.a.o paramo)
  {
    ...
    {
      paramo = (Integer)localIterator.next();
      D.put(paramo, (LinkedList)((LinkedList)D.get(paramo)).clone());
    }
    paramo = new Stack();
    E = paramo;
    paramo.addAll(E);
  ...
  public final void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, j paramj)
  {
    if (paramj != null)
    {
      ...
      while (i < 1 << y)
      {
        ...
        localObject1 = l.b.c.e.a.a(x, (n)localObject3, (i)localObject2);
        ...
        for (paramj = (g)((g.b)((o.a)localObject3).a(d)).b(); !E.isEmpty(); paramj = (g)((g.b)((o.a)localObject3).a(d)).b())
        {
          ...
          if ((k >= 3) && ((k & 0x1) == 1))
          {
            ...
            j = y;
            if ((k >= j - A) && (k <= j - 2)) {
              if (D.get(Integer.valueOf(k)) == null)
              {
          ...
          localObject1 = l.b.c.e.a.a(x, (u)E.pop(), (u)localObject1, paramj);
      ...
      if (!H)
      {
        ...
        if (i <= I - 1)
        {
          ...
          if (m == 0)
          {
            ...
            paramj = l.b.c.e.a.a(x, paramj, (i)localObject1);
            C.set(0, paramj);
            j = k;
          }
          else
          {
            ...
            localObject2 = l.b.c.e.a.a(x, (u)C.get(j), (u)F.get(Integer.valueOf(j)), (o)localObject1);
            ...
            for (j = 0; j < m; j++)
            {
              ...
              {
                localObject2 = C;
                localObject1 = z.get(j)).x;
              }
              else
              {
                localObject2 = C;
                localObject1 = ((LinkedList)D.get(Integer.valueOf(j))).removeFirst();
              }
              ((List)localObject2).set(j, localObject1);
            }
            i = Math.min(m, y - A);
            for (m = 0;; m++)
            {
          ...
          while (j < y - A >> 1)
          {
            ...
            if (localObject1 != null)
            {
              ...
              if ((!C) && (B))
              {
                ...
                paramj = l.b.c.e.a.a((k)localObject5, ((k)localObject5).a(paramj), (i)localObject6);
                while ((!((Stack)localObject4).isEmpty()) && (peekx == x) && (peekx != y))
                {
                  ...
                  paramj = l.b.c.e.a.a((k)localObject5, (u)((Stack)localObject4).pop(), paramj, (o)localObject3);
                ...
                else if (x == x)
                {
                  ...
                  paramj = l.b.c.e.a.a((k)localObject5, x, paramj, (o)localObject3);
