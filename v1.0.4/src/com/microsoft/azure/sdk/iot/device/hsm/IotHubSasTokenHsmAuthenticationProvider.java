  ...
  extends IotHubSasTokenWithRefreshAuthenticationProvider
{
  ...
  public static IotHubSasToken createNewSasToken(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, SignatureProvider paramSignatureProvider, long paramLong)
  {
    try
    {
      ...
      paramString1 = new IotHubSasToken(paramString1, paramString3, null, IotHubSasToken.buildSharedAccessToken(str, paramString5, paramLong), paramString4, paramLong);
      return paramString1;
    }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.hsm.IotHubSasTokenHsmAuthenticationProvider
