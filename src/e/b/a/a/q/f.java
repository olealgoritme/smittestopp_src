  ...
  extends e.b.a.a.o.b
{
  ...
  public final l a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    if (paramInt1 == 46)
    {
      ...
      {
        c(m, "Decimal point not followed by a digit");
        throw null;
      }
    }
    if (m != 101)
      ...
      if (bool1)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            localObject2 = P;
            i = j;
            localObject1 = ((e.b.a.a.s.g)localObject2).h();
            j = c;
            if (j < 0) {
              j = 0;
            }
            m = ((e.b.a.a.s.g)localObject2).j();
            localObject1 = W.a((char[])localObject1, j, m, i);
            label1534:
  ...
  public void o()
  {
    ...
    if ((l ^ true))
    {
      e.b.a.a.r.b localb = a;
      if ((localb != null) && (e))
      {
        localObject2 = new b.b((e.b.a.a.r.b)localObject1);
        int i = a;
  ...
  public final void p()
  {
    ...
    k = null;
    if (f) {
      ((e.b.a.a.s.g)localObject2).a();
    } else if (h == null) {
      h = ((e.b.a.a.s.g)localObject2).a(m);
    }
    g = 0;
    i = 0;
    if (c >= 0) {
      ((e.b.a.a.s.g)localObject2).b(m);
    }
    j = null;
    k = null;
    ...
    if (i2 >= m)
    {
      System.arraycopy(localObject1, n, localObject3, i1, m);
      i += m;
    }
    else
    {
      ...
      if (i2 > 0)
      {
        System.arraycopy(localObject1, n, localObject3, i1, i2);
        j = n + i2;
        i = m - i2;
      }
      do
      {
        ((e.b.a.a.s.g)localObject2).d();
        m = Math.min(h.length, i);
        System.arraycopy(localObject1, j, h, 0, m);
        i += m;
        j += m;
        m = i - m;
        i = m;
  ...
  public boolean q()
  {
    ...
    {
      Object localObject = U;
      i = localReader.read((char[])localObject, 0, localObject.length);
      if (i > 0)
      {
        G = 0;
        H = i;
...
/* Location:
 * Qualified Name:     base.e.b.a.a.q.f
