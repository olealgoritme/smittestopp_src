  ...
  implements IMultipleAccountPublicClientApplication
{
  ...
  private void getAccountInternal(String paramString1, IMultipleAccountPublicClientApplication.GetAccountCallback paramGetAccountCallback, String paramString2)
  {
    ...
    try
    {
      ...
      CommandCallback local4 = new com/microsoft/identity/client/MultipleAccountPublicClientApplication$4;
  ...
  private void getAccountsInternal(final IPublicClientApplication.LoadAccountsCallback paramLoadAccountsCallback, final String paramString)
  {
    ...
    if (((List)localObject1).isEmpty())
    {
      ...
      new TokenMigrationUtility()._import(new AdalMigrationAdapter(mPublicClientConfiguration.getAppContext(), (Map)localObject1, false), (Map)localObject2, (IShareSingleSignOnState)mPublicClientConfiguration.getOAuth2TokenCache(), new TokenMigrationCallback()
      {
        public void onMigrationFinished(int paramAnonymousInt)
        {
    ...
    catch (MsalClientException paramString)
    {
      localHandler.post(new Runnable()
      {
        public void run()
        {
          paramLoadAccountsCallback.onError(paramString);
        }
      });
    }
  }
  ...
  private void removeAccountInternal(IAccount paramIAccount, IMultipleAccountPublicClientApplication.RemoveAccountCallback paramRemoveAccountCallback, String paramString)
  {
    ...
    try
    {
      localObject1 = new com/microsoft/identity/common/internal/controllers/RemoveAccountCommand;
      localObject2 = MSALControllerFactory.getAllControllers(mPublicClientConfiguration.getAppContext(), paramIAccount.getAuthority(), mPublicClientConfiguration);
      CommandCallback local6 = new com/microsoft/identity/client/MultipleAccountPublicClientApplication$6;
      local6.<init>(this, paramRemoveAccountCallback);
      ((RemoveAccountCommand)localObject1).<init>(paramIAccount, (List)localObject2, local6);
      ((BaseCommand)localObject1).setPublicApiId(paramString);
      CommandDispatcher.submitSilent((BaseCommand)localObject1);
    }
  ...
  public IAccount getAccount(String paramString)
  {
    ...
    final ResultFuture localResultFuture = new ResultFuture();
    getAccountInternal(paramString, new IMultipleAccountPublicClientApplication.GetAccountCallback()
    {
      public void onError(MsalException paramAnonymousMsalException)
      {
        localResultFuture.setResult(new AsyncResult(null, paramAnonymousMsalException));
      }
      
      public void onTaskCompleted(IAccount paramAnonymousIAccount)
      {
        localResultFuture.setResult(new AsyncResult(paramAnonymousIAccount, null));
      }
    }, "925");
  ...
  public List<IAccount> getAccounts()
  {
    ...
    getAccountsInternal(new IPublicClientApplication.LoadAccountsCallback()
    {
      ...
      public void onTaskCompleted(List<IAccount> paramAnonymousList)
      {
        localObject.setResult(new AsyncResult(paramAnonymousList, null));
      }
    }, "923");
  ...
  {
    final ResultFuture localResultFuture = new ResultFuture();
    removeAccountInternal(paramIAccount, new IMultipleAccountPublicClientApplication.RemoveAccountCallback()
    {
      public void onError(MsalException paramAnonymousMsalException)
      {
        localResultFuture.setResult(new AsyncResult(Boolean.valueOf(false), paramAnonymousMsalException));
      }
      
      public void onRemoved()
      {
        localResultFuture.setResult(new AsyncResult(Boolean.valueOf(true), null));
      }
    }, "929");
...
/* Location:
 * Qualified Name:     com.microsoft.identity.client.MultipleAccountPublicClientApplication
