  ...
  public static String computeHmac256(StorageCredentials paramStorageCredentials, String paramString)
  {
    try
    {
      ...
      if (bool) {
        ...
        {
          paramStorageCredentials = new java/lang/IllegalArgumentException;
          paramStorageCredentials.<init>(paramString);
          throw paramStorageCredentials;
        }
      }
      return null;
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.core.StorageCredentialsHelper
