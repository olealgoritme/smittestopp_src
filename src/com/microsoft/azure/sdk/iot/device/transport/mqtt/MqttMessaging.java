  ...
  extends Mqtt
{
  ...
  public void send(Message paramMessage)
  {
    if ((paramMessage != null) && (paramMessage.getBytes() != null))
    {
      ...
      Object localObject1 = paramMessage.getMessageId();
      int i = 0;
      boolean bool1 = appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, appendPropertyIfPresent(localStringBuilder, false, "$.mid", (String)localObject1), "$.cid", paramMessage.getCorrelationId()), "$.uid", paramMessage.getUserId()), "$.to", paramMessage.getTo()), "$.on", paramMessage.getOutputName()), "$.cdid", paramMessage.getConnectionDeviceId()), "$.cmid", paramMessage.getConnectionModuleId()), "$.ce", paramMessage.getContentEncoding()), "$.ct", paramMessage.getContentType()), "$.ctime", paramMessage.getCreationTimeUTCString());
      boolean bool2 = bool1;
      ...
      while (i < j)
      {
        ...
        bool2 = appendPropertyIfPresent(localStringBuilder, bool2, ((MessageProperty)localObject2).getName(), ((MessageProperty)localObject2).getValue());
        i++;
      }
      localObject1 = moduleId;
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.transport.mqtt.MqttMessaging
