...
public class BrokerValidator
{
  ...
  public String verifySignatureAndThrow(String paramString)
  {
    try
    {
      try
      {
        List localList = readCertDataForBrokerApp(paramString);
        paramString = verifySignatureHash(localList);
        if (localList.size() > 1) {
          verifyCertificateChain(localList);
        }
        return paramString;
      }
...
/* Location:
 * Qualified Name:     com.microsoft.identity.common.internal.broker.BrokerValidator
