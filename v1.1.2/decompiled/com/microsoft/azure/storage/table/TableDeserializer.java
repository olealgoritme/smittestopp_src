...
public final class TableDeserializer
{
  ...
  public static <T extends TableEntity, R> TableResult parseJsonEntity(i parami, Class<T> paramClass, HashMap<String, PropertyPair> paramHashMap, EntityResolver<R> paramEntityResolver, TableRequestOptions paramTableRequestOptions, OperationContext paramOperationContext)
  {
    ...
    if (parami != null)
    {
      ...
      localObject4 = (EntityProperty)localHashMap.get("_ClientEncryptionMetadata1");
      if ((parami != null) && (!parami.getIsNull()) && (localObject4 != null) && (!((EntityProperty)localObject4).getIsNull()))
      {
        localObject3 = paramTableRequestOptions.getEncryptionPolicy().decryptMetadataAndReturnCEK(str1, (String)localObject1, (EntityProperty)localObject4, parami, localEncryptionData);
        localObject4 = key;
        localBoolean = isJavaV1;
        localHashMap.put("_ClientEncryptionMetadata2", parami);
        localObject3 = parsePropertyDetails(parami);
        break label528;
      }
    ...
    if ((paramTableRequestOptions.getTablePayloadFormat() == TablePayloadFormat.JsonNoMetadata) && ((paramTableRequestOptions.getPropertyResolver() != null) || (paramClass != null)))
    {
      ...
      Object localObject5;
      label1034:
      for (parami = paramHashMap; localIterator.hasNext(); parami = (i)localObject5)
      {
        ...
        for (;;)
        {
          ...
          else if (paramTableRequestOptions.getPropertyResolver() != null)
          {
            ...
            try
            {
              localObject5 = paramTableRequestOptions.getPropertyResolver().propertyResolver(str1, (String)localObject1, str4, str5);
              try
              {
                EntityProperty localEntityProperty = new com/microsoft/azure/storage/table/EntityProperty;
                if (isEncrypted((HashSet)localObject3, str4)) {
                  paramHashMap = EdmType.BINARY;
                } else {
                  paramHashMap = (HashMap<String, PropertyPair>)localObject5;
                }
              ...
              {
                throw new StorageException("InvalidType", String.format("Failed to parse property '%s' with value '%s' as type '%s'", new Object[] { str4, str5, localObject5 }), 306, null, parami);
              }
              localObject5 = parami;
            }
        ...
        if (paramClass != null)
        {
          ...
          if (parami != null)
          {
            if (isEncrypted((HashSet)localObject3, (String)localEntry.getKey())) {
    ...
    if ((paramTableRequestOptions.getEncryptionPolicy() != null) && (localObject4 != null)) {
      parami = paramTableRequestOptions.getEncryptionPolicy().decryptEntity(localHashMap, (HashSet)localObject3, str1, (String)localObject1, (Key)localObject4, localEncryptionData, localBoolean);
    } else {
      parami = localHashMap;
    }
...
/* Location:
 * Qualified Name:     com.microsoft.azure.storage.table.TableDeserializer
