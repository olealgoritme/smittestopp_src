...
public final class e
{
  ...
  public Gson a()
  {
    ...
    if ((i1 != 2) && (i2 != 2))
    {
      ...
      DefaultDateTypeAdapter localDefaultDateTypeAdapter2 = new DefaultDateTypeAdapter(Timestamp.class, i1, i2);
      localObject = new DefaultDateTypeAdapter(java.sql.Date.class, i1, i2);
      localArrayList.add(TypeAdapters.a(java.util.Date.class, localDefaultDateTypeAdapter1));
      localArrayList.add(new TypeAdapters.32(Timestamp.class, localDefaultDateTypeAdapter2));
      localArrayList.add(new TypeAdapters.32(java.sql.Date.class, (TypeAdapter)localObject));
    }
