  ...
  extends BlobOutputStream
{
  ...
  public BlobOutputStreamInternal(CloudBlob paramCloudBlob, AccessCondition paramAccessCondition, BlobRequestOptions paramBlobRequestOptions, OperationContext paramOperationContext)
  {
    ...
    if (i >= 1)
    {
      ...
      threadExecutor = new ThreadPoolExecutor(options.getConcurrentRequestCount().intValue(), options.getConcurrentRequestCount().intValue(), 10L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new BlobOutputStreamInternal.BlobOutputStreamThreadFactory());
  ...
  private void dispatchWrite()
  {
    try
    {
      ...
      if (streamType == BlobType.BLOCK_BLOB)
      {
        ...
        localObject1 = blockList;
        BlockEntry localBlockEntry = new com/microsoft/azure/storage/blob/BlockEntry;
        localBlockEntry.<init>(str, BlockSearchMode.LATEST);
        ((ArrayList)localObject1).add(localBlockEntry);
        localObject1 = new com/microsoft/azure/storage/blob/BlobOutputStreamInternal$1;
        ((BlobOutputStreamInternal.1)localObject1).<init>(this, localByteArrayInputStream, str, i);
      }
      else
      {
        long l;
        if (streamType == BlobType.PAGE_BLOB)
        {
          l = currentBlobOffset;
          currentBlobOffset += i;
          localObject1 = new BlobOutputStreamInternal.2(this, localByteArrayInputStream, l, i);
        }
        else if (streamType == BlobType.APPEND_BLOB)
        {
          ...
          localObject1 = new BlobOutputStreamInternal.3(this, localByteArrayInputStream, l, i);
        }
      }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.BlobOutputStreamInternal
