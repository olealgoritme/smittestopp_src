  ...
  implements IBrokerApplicationMetadataCache
{
  ...
  private Set<String> getAllFociClientIds(boolean paramBoolean)
  {
    ...
    Object localObject2 = e.a.a.a.a.a(new StringBuilder(), TAG, ":getAllFociClientIds");
    localObject1 = e.a.a.a.a.a("Found [");
    ((StringBuilder)localObject1).append(localHashSet.size());
    ((StringBuilder)localObject1).append("] client ids.");
  ...
  {
    return new SharedPreferencesBrokerApplicationMetadataCache.1(this).getType();
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.cache.SharedPreferencesBrokerApplicationMetadataCache
