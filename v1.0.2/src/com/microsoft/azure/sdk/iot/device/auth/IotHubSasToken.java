...
public final class IotHubSasToken
{
  ...
  public static Map<String, String> extractFieldValues(String paramString)
  {
    ...
    if ((arrayOfString1.length == 2) && (bool))
    {
      ...
      for (arrayOfString1 : arrayOfString1[1].trim().split("&")) {
        if (!arrayOfString1.equals(""))
        {
          String[] arrayOfString3 = arrayOfString1.split("=");
          if (arrayOfString3.length == 2) {
            paramString.put(arrayOfString3[0], arrayOfString3[1]);
          } else {
            throw new IllegalArgumentException(a.b("SasToken format is invalid: missing a key or value tied to your field: ", arrayOfString1));
          }
        }
      }
      return paramString;
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.auth.IotHubSasToken
