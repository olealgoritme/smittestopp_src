  ...
  extends AuthorizationStrategy<GenericOAuth2Strategy, GenericAuthorizationRequest>
{
  ...
  public void completeAuthorization(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1001)
    {
      ...
      {
        localObject = TAG;
        paramIntent = a.a("SDK Cancel triggering before request is sent out. Potentially due to an stale activity state, oAuth2Strategy null ? [");
        OAuth2Strategy localOAuth2Strategy = mOAuth2Strategy;
        boolean bool1 = true;
        boolean bool2;
        if (localOAuth2Strategy == null) {
          bool2 = true;
        } else {
          bool2 = false;
        }
        paramIntent.append(bool2);
        paramIntent.append("]mAuthorizationResultFuture ? [");
        ...
        paramIntent.append(bool2);
        paramIntent.append("]");
        Logger.warn((String)localObject, paramIntent.toString());
      }
    }
    else
    {
...
/* Location:
 * Qualified Name:     base.com.microsoft.identity.common.internal.ui.webview.EmbeddedWebViewAuthorizationStrategy
