  ...
  public String encryptMessage(byte[] paramArrayOfByte)
  {
    ...
    if (keyWrapper != null)
    {
      ...
      try
      {
        ...
        localObject = (b)keyWrapper.wrapKeyAsync(((SecretKey)localObject).getEncoded(), null).get();
        WrappedContentKey localWrappedContentKey = new com/microsoft/azure/storage/core/WrappedContentKey;
        localWrappedContentKey.<init>(keyWrapper.getKid(), (byte[])((b)localObject).getKey(), (String)((b)localObject).getValue());
        localEncryptionData.setWrappedContentKey(localWrappedContentKey);
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.queue.QueueEncryptionPolicy
