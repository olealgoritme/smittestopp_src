  ...
  extends InternalClient
{
  ...
  public static ModuleClient createFromEnvironment(IotHubClientProtocol paramIotHubClientProtocol)
  {
    ...
    String str3 = (String)((Map)localObject1).get("IOTEDGE_DEVICEID");
    String str4 = (String)((Map)localObject1).get("IOTEDGE_MODULEID");
    Object localObject2 = (String)((Map)localObject1).get("IOTEDGE_IOTHUBHOSTNAME");
              ...
              if (localObject1 != null)
              {
                if (((String)localObject3).equalsIgnoreCase("sasToken"))
                {
                  try
                  {
                    ...
                    try
                    {
                      localObject2 = IotHubSasTokenHsmAuthenticationProvider.create((SignatureProvider)localObject3, str3, str4, (String)localObject2, str1, (String)localObject1, DEFAULT_SAS_TOKEN_TIME_TO_LIVE_SECONDS, DEFAULT_SAS_TOKEN_BUFFER_PERCENTAGE);
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.sdk.iot.device.ModuleClient
