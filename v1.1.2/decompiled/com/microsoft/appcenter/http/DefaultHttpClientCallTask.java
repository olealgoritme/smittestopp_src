  ...
  extends AsyncTask<Void, Void, Object>
{
  ...
  public DefaultHttpClientCallTask(String paramString1, String paramString2, Map<String, String> paramMap, HttpClient.CallTemplate paramCallTemplate, ServiceCallback paramServiceCallback, Tracker paramTracker, boolean paramBoolean)
  {
    mUrl = paramString1;
  ...
  private HttpResponse doHttpCall()
  {
    ...
    //   36	719	4	i	int
    //   39	343	5	j	int
    //   61	711	6	localObject1	Object
    //   70	608	7	localObject2	Object
  ...
  {
    public abstract void onFinish(DefaultHttpClientCallTask paramDefaultHttpClientCallTask);
    
    public abstract void onStart(DefaultHttpClientCallTask paramDefaultHttpClientCallTask);
  }
}

/* Location:
 * Qualified Name:     com.microsoft.appcenter.http.DefaultHttpClientCallTask
