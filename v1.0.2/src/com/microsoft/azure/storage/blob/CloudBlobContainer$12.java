...
public class CloudBlobContainer$12
  extends StorageRequest<CloudBlobClient, CloudBlobContainer, Void>
{
  public CloudBlobContainer$12(CloudBlobContainer paramCloudBlobContainer, RequestOptions paramRequestOptions, StorageUri paramStorageUri, BlobRequestOptions paramBlobRequestOptions, AccessCondition paramAccessCondition)
  {
  ...
  {
    return BlobRequest.leaseContainer(CloudBlobContainer.access$000(paramCloudBlobContainer).getUri(getCurrentLocation()), val$options, paramOperationContext, val$accessCondition, LeaseAction.RELEASE, null, null, null);
  }
...
/* Location:
 * Qualified Name:     base.com.microsoft.azure.storage.blob.CloudBlobContainer.12
