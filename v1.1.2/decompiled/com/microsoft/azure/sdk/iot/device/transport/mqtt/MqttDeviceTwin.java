...
public class MqttDeviceTwin
  extends Mqtt
{
  public static final l.f.b log = c.a(MqttDeviceTwin.class);
  ...
  public IotHubTransportMessage receive()
  {
    ...
    try
    {
      ...
      {
        String str = (String)((l.a.a.b.e.b)localObject4).getKey();
        ...
        if (str != null)
        {
          ...
          if (str.length() > 0)
          {
            ...
            if (str.length() > 12)
            {
              ...
              {
                localObject4 = (byte[])((l.a.a.b.e.b)localObject4).getValue();
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.transport.mqtt.MqttDeviceTwin
