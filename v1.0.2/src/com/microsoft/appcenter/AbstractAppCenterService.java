  ...
  implements AppCenterService
{
  ...
  public AppCenterFuture<Boolean> isInstanceEnabledAsync()
  {
    try
    {
      ...
      AbstractAppCenterService.1 local1 = new com/microsoft/appcenter/AbstractAppCenterService$1;
  ...
  public boolean post(Runnable paramRunnable1, Runnable paramRunnable2, Runnable paramRunnable3)
  {
    try
    {
      ...
      AbstractAppCenterService.4 local4 = new com/microsoft/appcenter/AbstractAppCenterService$4;
  ...
  public <T> void postAsyncGetter(Runnable paramRunnable, DefaultAppCenterFuture<T> paramDefaultAppCenterFuture, T paramT)
  {
    try
    {
      AbstractAppCenterService.5 local5 = new com/microsoft/appcenter/AbstractAppCenterService$5;
  ...
  public void postOnUiThread(Runnable paramRunnable)
  {
    try
    {
      AbstractAppCenterService.7 local7 = new com/microsoft/appcenter/AbstractAppCenterService$7;
  ...
  public void setInstanceEnabled(boolean paramBoolean)
  {
    try
    {
      ...
      String str2 = getLoggerTag();
      String str1 = getServiceName();
      if (paramBoolean) {
        str3 = "enabled";
      } else {
        str3 = "disabled";
      }
      AppCenterLog.info(str2, String.format("%s service has been %s.", new Object[] { str1, str3 }));
      if (mChannel != null) {
        applyEnabledState(paramBoolean);
      }
      return;
  ...
  public final AppCenterFuture<Void> setInstanceEnabledAsync(boolean paramBoolean)
  {
    try
    {
      DefaultAppCenterFuture localDefaultAppCenterFuture = new com/microsoft/appcenter/utils/async/DefaultAppCenterFuture;
      localDefaultAppCenterFuture.<init>();
      AbstractAppCenterService.2 local2 = new com/microsoft/appcenter/AbstractAppCenterService$2;
      local2.<init>(this, localDefaultAppCenterFuture);
      AbstractAppCenterService.3 local3 = new com/microsoft/appcenter/AbstractAppCenterService$3;
...
/* Location:
 * Qualified Name:     base.com.microsoft.appcenter.AbstractAppCenterService
