  ...
  extends ExpandableTransformationBehavior
{
  ...
  public AnimatorSet b(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    float f3 = localRectF1.width();
    float f4 = localRectF1.height();
    boolean bool2 = localObject2 instanceof e.c.a.b.g.c;
    if (bool2) {
      if ((paramView1 instanceof ImageView))
      {
        localObject6 = (e.c.a.b.g.c)localObject2;
        localObject5 = ((ImageView)paramView1).getDrawable();
        if (localObject5 == null) {}
      }
      else
      {
        ((Drawable)localObject5).mutate();
        if (paramBoolean1)
        {
          if (!paramBoolean2) {
            ((Drawable)localObject5).setAlpha(255);
          }
          localObject4 = ObjectAnimator.ofInt(localObject5, e.c.a.b.a.d.b, new int[] { 0 });
        }
        else
        {
          localObject4 = ObjectAnimator.ofInt(localObject5, e.c.a.b.a.d.b, new int[] { 255 });
        }
        ...
        localArrayList.add(localObject4);
        ((ArrayList)localObject3).add(new e.c.a.b.o.b(this, (e.c.a.b.g.c)localObject6, (Drawable)localObject5));
      }
    }
    ...
    else
    {
      ...
      float f5 = ((RectF)localObject6).centerX() - left;
      localObject5 = d;
      localObject6 = e;
      ...
      float f6 = ((RectF)localObject5).centerY() - top;
      ...
      {
        if (!paramBoolean2) {
          ((e.c.a.b.g.c)localObject3).setRevealInfo(new c.e(f5, f6, f2));
        }
        if (paramBoolean2) {
          f2 = getRevealInfoc;
        }
        float f7 = e.c.a.a.b.l.c.a(f5, f6, 0.0F, 0.0F);
        f1 = e.c.a.a.b.l.c.a(f5, f6, f3, 0.0F);
        f3 = e.c.a.a.b.l.c.a(f5, f6, f3, f4);
        f4 = e.c.a.a.b.l.c.a(f5, f6, 0.0F, f4);
        if ((f7 > f1) && (f7 > f3) && (f7 > f4))
        {
          f1 = f7;
        }
        else if ((f1 <= f3) || (f1 <= f4))
        ...
        localObject5 = e.c.a.a.b.l.c.a((e.c.a.b.g.c)localObject3, f5, f6, f1);
      ...
      {
        f1 = getRevealInfoc;
        localObject5 = e.c.a.a.b.l.c.a((e.c.a.b.g.c)localObject3, f5, f6, f2);
        l1 = a;
        int m = (int)f5;
        int n = (int)f6;
        if (l1 > 0L)
    ...
    paramView2.addListener(new FabTransformationBehavior.a(this, paramBoolean1, (View)localObject1, paramView1));
...
/* Location:
 * Qualified Name:     base.com.google.android.material.transformation.FabTransformationBehavior
