...
public class Message
{
  ...
  public void setExpiryTime(long paramLong)
  {
    ...
    log.a("The message with messageid {} has expiry time in {} milliseconds and the message will expire on {}", new Object[] { getMessageId(), Long.valueOf(paramLong), new Date(expiryTime) });
  }
  ...
  public void setProperty(String paramString1, String paramString2)
  {
    if (paramString1 != null)
    {
      if (paramString2 != null)
      {
        ...
        log.d("Setting message property");
...
/* Location:
 * Qualified Name:     com.microsoft.azure.sdk.iot.device.Message
