  ...
  public void onServicesDiscovered(BluetoothGatt paramBluetoothGatt, int paramInt)
  {
    if (paramBluetoothGatt != null)
    {
      ...
      if (paramInt == 0) {
        try
        {
          paramBluetoothGatt.readCharacteristic(paramBluetoothGatt.getService(a0.a).getCharacteristic(a0.b)); // REF: til uuid.b (statisk uuid string)
        }
