    ...
    if ((paramInt1 >= 55296) && (paramInt1 <= 57343))
    {
      if ((paramInt2 < paramInt3) && (paramArrayOfChar != null))
      {
        ...
        if ((paramInt3 >= 56320) && (paramInt3 <= 57343))
        {
          ...
          paramInt3 = i + 1;
          J = paramInt3;
          paramArrayOfChar[i] = ((byte)(byte)(paramInt1 >> 18 | 0xF0));
          i = paramInt3 + 1;
          J = i;
          paramArrayOfChar[paramInt3] = ((byte)(byte)(paramInt1 >> 12 & 0x3F | 0x80));
          paramInt3 = i + 1;
          J = paramInt3;
          paramArrayOfChar[i] = ((byte)(byte)(paramInt1 >> 6 & 0x3F | 0x80));
          J = (paramInt3 + 1);
    ...
    if ((!y) && (((!Double.isNaN(paramDouble)) && (!Double.isInfinite(paramDouble))) || (!f.a.QUOTE_NON_NUMERIC_NUMBERS.enabledIn(x))))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            int n = Math.min(m, i);
            str.getChars(j, j + n, arrayOfChar, 0);
            if (J + m * 3 > K) {
              d();
            }
            int i1 = n;
              ...
              do
              {
                ...
                if (n > 127)
                {
                  ...
                  if (i2 < 2048)
                  {
                    ...
                    k = i3 + 1;
                    J = k;
                    arrayOfByte[i3] = ((byte)(byte)(i2 >> 6 | 0xC0));
                    J = (k + 1);
                    arrayOfByte[k] = ((byte)(byte)(i2 & 0x3F | 0x80));
                    k = n;
                    break;
                  }
                  k = a(i2, arrayOfChar, n, i1);
                  break;
                }
                byte[] arrayOfByte = I;
                i2 = J;
      ...
      if (C == 0)
      {
        ...
        while (paramInt2 < i)
        {
          ...
          if (k <= 127)
          {
            if (localObject2[k] == 0)
            {
              localObject1[paramInt1] = ((byte)(byte)k);
              paramInt2 = j;
              paramInt1++;
              continue;
            }
            paramInt2 = localObject2[k];
            if (paramInt2 > 0)
            {
              k = paramInt1 + 1;
              localObject1[paramInt1] = ((byte)92);
              paramInt1 = k + 1;
              localObject1[k] = ((byte)(byte)paramInt2);
            }
            else
            {
              paramInt1 = b(k, paramInt1);
            }
          }
          else if (k <= 2047)
          {
            paramInt2 = paramInt1 + 1;
            localObject1[paramInt1] = ((byte)(byte)(k >> 6 | 0xC0));
            paramInt1 = paramInt2 + 1;
            localObject1[paramInt2] = ((byte)(byte)(k & 0x3F | 0x80));
          }
          else
          {
            paramInt1 = a(k, paramInt1);
          }
          paramInt2 = j;
        }
        J = paramInt1;
      ...
      else
      {
        ...
        while (paramInt2 < i)
        {
          ...
          if (paramInt2 <= 127)
          {
            ...
            m = localObject1[paramInt2];
            if (m > 0)
            {
              paramInt2 = paramInt1 + 1;
              localObject2[paramInt1] = ((byte)92);
              paramInt1 = paramInt2 + 1;
              localObject2[paramInt2] = ((byte)(byte)m);
              break label518;
            }
          ...
          for (paramInt1 = b(paramInt2, paramInt1);; paramInt1 = a(paramInt2, paramInt1))
          {
            ...
            if (paramInt2 <= 2047)
            {
              ...
              paramInt1 = m + 1;
              localObject2[m] = ((byte)(byte)(paramInt2 & 0x3F | 0x80));
              break;
            }
          }
          label518:
      ...
      do
      {
        ...
        if (paramInt2 > 127)
        {
          ...
          if (i < 2048)
          {
            ...
            paramInt1 = j + 1;
            J = paramInt1;
            arrayOfByte[j] = ((byte)(byte)(i >> 6 | 0xC0));
            J = (paramInt1 + 1);
            arrayOfByte[paramInt1] = ((byte)(byte)(i & 0x3F | 0x80));
            paramInt1 = paramInt2;
            break;
          }
...
/* Location:
 * Qualified Name:     base.e.b.a.a.q.g
