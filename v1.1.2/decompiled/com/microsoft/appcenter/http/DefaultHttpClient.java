  ...
  implements HttpClient, DefaultHttpClientCallTask.Tracker
{
  ...
  public ServiceCall callAsync(final String paramString1, final String paramString2, Map<String, String> paramMap, HttpClient.CallTemplate paramCallTemplate, final ServiceCallback paramServiceCallback)
  {
    ...
    catch (RejectedExecutionException paramString2)
    {
      HandlerUtils.runOnUiThread(new Runnable()
      {
        public void run()
        {
          paramServiceCallback.onCallFailed(paramString2);
        }
      });
    }
    new ServiceCall()
...
/* Location:
 * Qualified Name:     com.microsoft.appcenter.http.DefaultHttpClient
