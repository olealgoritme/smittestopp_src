  ...
  extends n
{
  ...
  public l(SSLSocketFactory paramSSLSocketFactory, String paramString1, int paramInt, String paramString2)
  {
    ...
    paramSSLSocketFactory = c.a("org.eclipse.paho.client.mqttv3.internal.nls.logcat", "l.c.a.a.a.s.l");
    ...
    if ((b != null) && (h != null))
    {
      if (g.a(5))
      {
        ...
        for (int n = 0;; n++)
        {
          if (n >= h.length)
          {
            g.b("l.c.a.a.a.s.l", "setEnabledCiphers", "260", new Object[] { paramArrayOfString });
            break;
          }
