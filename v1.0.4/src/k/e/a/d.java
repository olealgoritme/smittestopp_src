...
public class d
{
    ...
    if (i1 != 0)
    {
      ...
      for (paramInt = e(i - 2); paramInt > 0; paramInt--)
      {
        ...
        if ("BootstrapMethods".equals(localObject))
        {
          ...
          i += 2;
          for (paramInt = m; paramInt < i1; paramInt++)
          {
  ...
  public final void a(s params, i parami, int paramInt)
  {
    ...
    while (i5 > 0)
    {
      localObject4 = e(k, arrayOfChar);
      i9 = b(k + 2);
      i6 = k + 6;
      if ("LocalVariableTable".equals(localObject4))
      {
      ...
      do
      {
        ...
        break;
        if ("LocalVariableTypeTable".equals(localObject4))
        {
          i3 = i6;
          localObject8 = localObject2;
          break label2225;
        }
        if (!"LineNumberTable".equals(localObject4)) {
          break label2028;
        }
        localObject4 = localObject7;
        localObject5 = localObject2;
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          {
            localObject4 = new int[localObject8.length + 4];
            System.arraycopy(localObject8, 0, localObject4, 0, localObject8.length);
            c = ((int[])localObject4);
          }
          c[i12] = k;
        }
      ...
      for (localObject2 = localObject3;; localObject2 = b(params, parami, i6, false))
      {
        ...
        localObject5 = localObject2;
        k = i1;
        if ("RuntimeVisibleTypeAnnotations".equals(localObject4))
        {
          localObject7 = b(params, parami, i6, true);
          break;
        }
        if (!"RuntimeInvisibleTypeAnnotations".equals(localObject4)) {
          break label2086;
        }
      }
      label2086:
      if ("StackMapTable".equals(localObject4))
      {
      ...
      {
        if (!"StackMap".equals(localObject4)) {
          break label2232;
        }
        localObject2 = localObject3;
        localObject4 = localObject7;
      ...
      localObject2 = localObject5;
      i1 = k;
      localObject5 = a((b[])localObject8, (String)localObject4, i6, i9, arrayOfChar, paramInt, (q[])localObject2);
      c = ((b)localObject6);
        ...
        for (i5 = paramInt;; i5 = i1)
        {
          ...
          if (i11 != 70)
          {
            if (i11 != 76)
            {
              if ((i11 != 83) && (i11 != 73))
              {
                ...
                case 68: 
                  ...
                  paramInt = i1 + 1;
                  localObject4[i5] = ((String)localObject5).substring(i10, paramInt);
                  i1 = i5 + 1;
                  break label2739;
                  paramInt = i5 + 1;
                  localObject4[i5] = v.e;
            ...
            else
            {
              ...
              localObject4[i5] = ((String)localObject5).substring(i1, paramInt);
              i1 = i5 + 1;
              paramInt++;
              break label2739;
            }
    ...
    while (paramInt < i14)
    {
      ...
      if (localObject4 != null)
      {
        ...
        params.a((q)localObject4);
        if (i6 != 0)
        {
          i6 = b;
          if (i6 != 0)
          {
            params.b(i6 & 0xFFFF, (q)localObject4);
            if (c != null)
            {
              i14 = 1;
              for (;;)
              {
                ...
                i6 = paramInt;
                paramInt = i6;
                if (i14 > localObject6[0]) {
                  break;
                }
                params.b(localObject6[i14], (q)localObject4);
                i14++;
                paramInt = i6;
              }
            }
      ...
      while (paramInt != 0)
      {
        ...
        if (paramInt < i12)
        {
          ...
          else
          {
            ...
            {
              paramInt -= 64;
              i14 = a(i6, s, 0, (char[])localObject6, (q[])localObject8);
              n = 4;
              r = 1;
              i6 = paramInt;
              paramInt = i14;
            ...
            for (;;)
            {
              ...
              paramInt = a(i14, s, 0, (char[])localObject6, (q[])localObject4);
              n = 4;
              r = 1;
              i6 = i18;
            }
            ...
            for (;;)
            {
              ...
              while (i6 > 0)
              {
                paramInt = a(paramInt, q, j, (char[])localObject6, (q[])localObject4);
                i6--;
                j++;
              }
              n = 1;
            ...
            o = j;
            for (i6 = 0; i6 < j; i6++) {
              paramInt = a(paramInt, q, i6, (char[])localObject6, (q[])localObject4);
            }
            j = e(paramInt);
            i6 = paramInt + 2;
            r = j;
            for (i14 = 0;; i14++)
            {
              ...
              i6 = a(i6, s, i14, (char[])localObject6, (q[])localObject4);
            }
          }
          label3725:
      ...
      case 186: 
        for (;;)
        {
          ...
          localObject6 = localObject5[(e(i3 + 1) + i17)];
          if ((i6 != 167) && (i6 != 168))
          {
            if (i6 < 167) {
              i1 = (i6 + 1 ^ 0x1) - 1;
            ...
            params.a(200, (q)localObject6);
            i1 = 1;
          }
          else
          {
            params.a(i6 + 33, (q)localObject6);
          }
          i6 = i3 + 3;
          i3 = i1;
          i1 = i6;
          break label5529;
          params.a(i6 - i9, localObject5[(b(i3 + 1) + i17)]);
          i3 += 5;
          break label5187;
          localObject4 = a(i3 + 1, arrayOfChar);
          i6 = localObject1[(i3 + 3)] & 0xFF;
          localObject6 = (t)params;
          Z = k.b;
          localObject8 = c.a(7, (String)localObject4);
          localObject4 = k;
          ((c)localObject4).b(197, a);
          ((c)localObject4).b(i6);
          if (Q != null)
          {
            i14 = N;
          ...
          else
          {
            ...
            i3 += 4;
            break label5187;
            params.a(i6, a(i3 + 1, arrayOfChar));
            i3 += 3;
          }
          break label5517;
          i14 = b[e(i3 + 1)];
          i6 = b[e(i14 + 2)];
          localObject9 = e(i6, arrayOfChar);
          String str = e(i6 + 2, arrayOfChar);
          i14 = e[e(i14)];
          localObject8 = (o)b(e(i14), arrayOfChar);
          i6 = e(i14 + 2);
          localObject10 = new Object[i6];
          j = i14 + 4;
          for (i14 = 0; i14 < i6; i14++)
          {
            localObject10[i14] = b(e(j), arrayOfChar);
            j += 2;
          }
          localObject6 = (t)params;
          Z = k.b;
          localObject4 = c;
          localObject4 = ((x)localObject4).a(18, (String)localObject9, str, aa);
          k.b(186, a);
          k.d(0);
          if (Q != null)
          {
      ...
      case 185: 
        j = b[e(i3 + 1)];
        i14 = b[e(j + 2)];
        localObject6 = a(j, arrayOfChar);
        localObject4 = e(i14, arrayOfChar);
        localObject8 = e(i14 + 2, arrayOfChar);
        if (i6 < 182)
        {
          params.a(i6, (String)localObject6, (String)localObject4, (String)localObject8);
        }
        else
        {
          boolean bool;
          if (localObject1[(j - 1)] == 11) {
            bool = true;
          } else {
            bool = false;
          }
          params.a(i6, (String)localObject6, (String)localObject4, (String)localObject8, bool);
        }
        if (i6 == 185) {
          i3 += 5;
        } else {
      ...
      case 171: 
        ...
        i14 = b(i3 + 4);
        localObject8 = new int[i14];
        localObject9 = new q[i14];
        i3 += 8;
        for (i6 = 0; i6 < i14; i6++)
        {
          localObject8[i6] = b(i3);
        ...
        localObject4 = k;
        Z = b;
        ((c)localObject4).b(171);
        ((c)localObject4).a(null, 0, (4 - k.b % 4) % 4);
      ...
      case 170: 
        i3 = 4 - (i17 & 0x3) + i3;
        localObject4 = localObject5[(b(i3) + i17)];
        i14 = b(i3 + 4);
        j = b(i3 + 8);
        i3 += 12;
        i13 = j - i14 + 1;
        localObject6 = new q[i13];
        for (i6 = 0; i6 < i13; i6++)
        {
          localObject6[i6] = localObject5[(b(i3) + i17)];
          i3 += 4;
        }
        params.a(i14, j, (q)localObject4, (q[])localObject6);
        break;
      case 153: 
      case 154: 
      case 155: 
      ...
      case 198: 
      case 199: 
        params.a(i6, localObject5[(d(i3 + 1) + i17)]);
        break;
      case 132: 
      ...
      case 58: 
      case 169: 
        params.d(i6, localObject1[(i3 + 1)] & 0xFF);
        i3 += 2;
        break;
      case 19: 
      case 20: 
      ...
      for (;;)
      {
        ...
        if (i3 == i17)
        {
          ...
          localObject6 = e(i3, arrayOfChar);
          a(params.a(h, i, (String)localObject6, true), i3 + 2, true, arrayOfChar);
        }
        i4++;
      ...
      while ((localObject3 != null) && (i5 < localObject3.length) && (i8 <= i6))
      {
        if (i8 == i6)
        {
          ...
          localObject6 = e(i8, arrayOfChar);
          a(params.a(h, i, (String)localObject6, false), i8 + 2, true, arrayOfChar);
        }
        i5++;
    ...
    if ((i10 != 0) && ((b & 0x2) == 0))
    {
      ...
      {
        i1 = e(i15) * 3;
        localObject6 = new int[i1];
        for (paramInt = i15 + 2; i1 > 0; paramInt += 10)
        {
          i1--;
          localObject6[i1] = (paramInt + 6);
          i1--;
          localObject6[i1] = e(paramInt + 8);
          i1--;
          localObject6[i1] = e(paramInt);
        }
      }
      else
      {
      ...
      for (paramInt = i10 + 2; i1 > 0; paramInt += 10)
      {
        ...
        n = e(paramInt + 8);
        if (localObject6 != null) {
          for (i3 = 0; i3 < localObject6.length; i3 += 3) {
            if ((localObject6[i3] == i2) && (localObject6[(i3 + 1)] == n))
            {
              localObject4 = e(localObject6[(i3 + 2)], arrayOfChar);
              break label6794;
            }
          }
        }
        localObject4 = null;
        label6794:
        params.a((String)localObject8, (String)localObject1, (String)localObject4, localObject5[i2], localObject5[(i2 + i4)], n);
        i1--;
      }
    }
    localObject5 = localObject2;
    ...
    default: 
      ...
      case 17: 
        ...
        else
        {
          ...
          localObject2 = e(i, paramArrayOfChar);
          String str = e(i + 2, paramArrayOfChar);
          i = e[e(j)];
          o localo = (o)b(e(i), paramArrayOfChar);
          j = e(i + 2);
          ...
          localObject1 = d;
          paramArrayOfChar = new h((String)localObject2, str, localo, arrayOfObject);
          localObject1[paramInt] = paramArrayOfChar;
        }
      ...
      i = b[e(i + 1)];
      k = b[e(i + 2)];
      Object localObject2 = a(i, paramArrayOfChar);
      localObject1 = e(k, paramArrayOfChar);
      paramArrayOfChar = e(k + 2, paramArrayOfChar);
      boolean bool;
      if (a[(i - 1)] == 11) {
        bool = true;
      } else {
